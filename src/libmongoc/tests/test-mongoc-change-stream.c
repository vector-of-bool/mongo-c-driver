...
static void _setup_for_resume(mongoc_change_stream_t *stream) {
    bool ret;
    bson_error_t error;
...
static int test_framework_skip_if_not_single_version_5(void) {
...
static mongoc_collection_t *drop_and_get_coll(mongoc_client_t *client, const char *db_name, const char *coll_name) {
 ...
 * to the server" */
static void test_change_stream_pipeline(void) {
 ...
 */
static void test_change_stream_live_single_server(void *test_ctx) {
...
static void test_resume_token_command_start(const mongoc_apm_command_started_t *event) {
 ...
 */
static void test_change_stream_live_track_resume_token(void *test_ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
    bson_error_t error;
...
static void test_batch_size_command_succeeded(const mongoc_apm_command_succeeded_t *event) {
 ...
 */
static void test_change_stream_live_batch_size(void *test_ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
 ...
 */
static void _test_resume_token_error(const char *id_projection) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    const bson_t *next_doc = NULL;
    mongoc_change_stream_t *stream;
...
static void test_change_stream_live_missing_resume_token(void *test_ctx) {
    BSON_UNUSED(test_ctx);

    _test_resume_token_error("0");
}

static void test_change_stream_live_invalid_resume_token(void *test_ctx) {
    BSON_UNUSED(test_ctx);
...
static void _test_getmore_error(const char *server_reply, bool should_resume, bool resume_kills_cursor) {
    mock_server_t *server;
    request_t *request;
    future_t *future;
    mongoc_client_t *client;
 ...
 * from a getMore. */
static void test_getmore_errors(void) {
    ...
    _test_getmore_error("{'ok': 0, 'code': 11601, 'errmsg': 'interrupted'}",
                        false /* should_resume */,
                        false /* ignored */);
    _test_getmore_error("{'ok': 0, 'code': 136, 'errmsg': 'capped position lost'}",
                        false /* should_resume */,
                        false /* ignored */);
 ...
 */
static void test_change_stream_resumable_error(void) {
    mock_server_t *server;
    request_t *request;
    future_t *future;
    mongoc_client_t *client;
 ...
 */
static void test_change_stream_options(void) {
    mock_server_t *server;
    request_t *request;
    future_t *future;
    mongoc_client_t *client;
...
static void test_change_stream_live_watch(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
    ...
    /* Test updating a doc */
    ASSERT_OR_PRINT(
        mongoc_collection_update(coll, MONGOC_UPDATE_NONE, tmp_bson("{}"), tmp_bson("{'$set': {'x': 'z'} }"), wc, &err),
        err);
 ...
 */
static void test_change_stream_live_read_prefs(void *test_ctx) {
    /*
...
static void test_change_stream_server_selection_fails(void) {
    const bson_t *bson;
    bson_error_t err;
...
static void test_change_stream_next_after_error(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
    const bson_t *bson;
...
static void _accepts_array_started(const mongoc_apm_command_started_t *event) {
    const bson_t *cmd = mongoc_apm_command_started_get_command(event);
    const char *cmd_name = mongoc_apm_command_started_get_command_name(event);
...
static void test_change_stream_accepts_array(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
...
void test_change_stream_start_at_operation_time(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
    const bson_t *doc;
...
static void _resume_at_optime_started(const mongoc_apm_command_started_t *event) {
    resume_ctx_t *ctx;
...
static void _resume_at_optime_succeeded(const mongoc_apm_command_succeeded_t *event) {
    resume_ctx_t *ctx;
...
static void test_change_stream_resume_at_optime(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
    const bson_t *doc;
...
static void _resume_with_post_batch_resume_token_started(const mongoc_apm_command_started_t *event) {
    resume_ctx_t *ctx;
...
static void _resume_with_post_batch_resume_token_succeeded(const mongoc_apm_command_succeeded_t *event) {
    resume_ctx_t *ctx;
...
static void test_change_stream_resume_with_post_batch_resume_token(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
    const bson_t *doc;
...
void test_change_stream_database_watch(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
...
void test_change_stream_client_watch(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
    const bson_t *doc;
...
static int _skip_if_rs_version_less_than(const char *version) {
    if (!TestSuite_CheckLive()) {
        return 0;
    }
...
static int _skip_if_no_client_watch(void) {
    return _skip_if_rs_version_less_than("3.8.0");
}

static int _skip_if_no_db_watch(void) {
    return _skip_if_rs_version_less_than("3.8.0");
}

static int _skip_if_no_start_at_optime(void) {
    return _skip_if_rs_version_less_than("3.8.0");
}
...
static bool change_stream_spec_operation_cb(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
    bson_t reply;
    bool res;

    mongoc_collection_t *coll = mongoc_client_get_collection(ctx->client,
...
static void change_stream_spec_before_test_cb(json_test_ctx_t *test_ctx, const bson_t *test) {
 ...
 */
static bool _iterate_until_error_or_event(mongoc_change_stream_t *stream,
                                          const bson_t **event,
                                          bson_error_t *error,
...
static void change_stream_spec_after_test_cb(json_test_ctx_t *test_ctx, const bson_t *test) {
    change_stream_spec_ctx_t *ctx = (change_stream_spec_ctx_t *)test_ctx->config->ctx;
    bson_error_t error;
    const bson_t *reply;
    const bson_t *doc;
...
static void test_change_stream_spec_cb(bson_t *scenario) {
...
static void _test_resume(const char *opts,
...
static void test_resume_cases(void) {
...
static void test_resume_cases_with_post_batch_resume_token(void) {
...
void test_error_null_doc(void *ctx) {
    mongoc_client_t *client;
    mongoc_change_stream_t *stream;
    bson_error_t err;
...
void _check_doc_resume_token(const bson_t *doc, const bson_t *resume_token) {
...
static void _save_operation_time_from_agg(const mongoc_apm_command_succeeded_t *event) {
...
void prose_test_14(void *test_ctx) {
    mongoc_client_t *client = test_framework_new_default_client();
    mongoc_collection_t *coll;
    mongoc_change_stream_t *stream;
    bson_t opts;
...
void test_change_stream_install(TestSuite *suite) {
