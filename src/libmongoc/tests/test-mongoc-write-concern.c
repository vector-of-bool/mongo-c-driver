...
static void test_write_concern_append(void) {
...
static void test_write_concern_basic(void) {
...
static void test_write_concern_bson_omits_defaults(void) {
    mongoc_write_concern_t *write_concern;
    const bson_t *bson;
    bson_iter_t iter;
...
static void test_write_concern_bson_includes_false_fsync_and_journal(void) {
    mongoc_write_concern_t *write_concern;
    const bson_t *bson;
    bson_iter_t iter;
...
static void test_write_concern_fsync_and_journal_w1_and_validity(void) {
...
static void test_write_concern_wtimeout_validity(void) {
    mongoc_write_concern_t *write_concern = mongoc_write_concern_new();
...
static void _test_write_concern_from_iterator(const char *swc, bool ok, bool is_default) {
...
static void test_write_concern_from_iterator(void) {
...
static void test_write_concern_always_mutable(void) {
    mongoc_write_concern_t *write_concern;
...
static void _test_wc_request(future_t *future, mock_server_t *server, bson_error_t *error) {
    request_t *request;
...
static void test_write_concern(void) {
    bson_t *opts;
...
static void test_write_concern_unacknowledged(void) {
    mongoc_client_t *client;
    mongoc_write_concern_t *wc;
 ...
 * preserved. */
static void test_write_concern_wtimeout_preserved(void) {
    mongoc_write_concern_t *write_concern = mongoc_write_concern_new();
    bson_t *cmd = tmp_bson("{}");
    bson_iter_t iter;
    bson_iter_t child;
...
static void write_concern_count(const mongoc_apm_command_started_t *event) {
...
static void test_write_concern_inheritance_fam_txn(bool in_session, bool in_txn) {
...
static void test_fam_no_session_no_txn(void *unused) {
    BSON_UNUSED(unused);
    test_write_concern_inheritance_fam_txn(false, false);
}

static void test_fam_session_no_txn(void *unused) {
    BSON_UNUSED(unused);
    test_write_concern_inheritance_fam_txn(true, false);
}

static void test_fam_session_txn(void *unused) {
    BSON_UNUSED(unused);
    test_write_concern_inheritance_fam_txn(true, true);
}

void test_write_concern_install(TestSuite *suite) {
