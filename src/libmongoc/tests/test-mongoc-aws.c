...
void test_obtain_credentials(void *unused) {
    mongoc_uri_t *uri;
...
void test_obtain_credentials_from_env(void *unused) {
    mongoc_uri_t *uri;
    _mongoc_aws_credentials_t creds;
    bool ret;
    bson_error_t error;
...
static void test_derive_region(void *unused) {
    bson_error_t error;
    char *region;
    bool ret;
    char *large;
...
static void test_aws_cache(void *unused) {
    BSON_UNUSED(unused);
...
void test_aws_install(TestSuite *suite) {
