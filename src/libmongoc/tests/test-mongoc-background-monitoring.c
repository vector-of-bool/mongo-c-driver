...
void tf_dump(test_fixture_t *tf) {
    printf("== Begin dump ==\n");
...
static void _heartbeat_started(const mongoc_apm_server_heartbeat_started_t *event) {
    test_fixture_t *tf;
...
static void _heartbeat_succeeded(const mongoc_apm_server_heartbeat_succeeded_t *event) {
    test_fixture_t *tf;
...
static void _heartbeat_failed(const mongoc_apm_server_heartbeat_failed_t *event) {
    test_fixture_t *tf;
...
bool auto_respond_polling_hello(request_t *request, void *ctx) {
    BSON_UNUSED(ctx);
...
test_fixture_t *tf_new(tf_flags_t flags) {
...
void tf_destroy(test_fixture_t *tf) {
...
static void _signal_shutdown(test_fixture_t *tf) {
...
static void _add_server_monitor(test_fixture_t *tf) {
    uint32_t id;
...
static void _request_scan(test_fixture_t *tf) {
...
static void _request_cancel(test_fixture_t *tf) {
    bson_mutex_lock(&tf->client->topology->tpld_modification_mtx);
...
void test_connect_badreply(void) {
    test_fixture_t *tf;
    request_t *request;
...
void test_connect_shutdown(void) {
    test_fixture_t *tf;
    request_t *request;
...
void test_connect_requestscan(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_flip_flop(void) {
    test_fixture_t *tf;
    request_t *request;
    int i;
...
static void test_repeated_requestscan(void) {
    test_fixture_t *tf;
    request_t *request;
    int i;
...
static void test_sleep_after_scan(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_streaming_succeeds(void) {
    test_fixture_t *tf;
    request_t *request;

    tf = tf_new(TF_AUTO_RESPOND_POLLING_HELLO);
    request = mock_server_receives_msg(tf->server,
...
static void test_streaming_hangup(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_streaming_badreply(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_streaming_shutdown(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_streaming_cancel(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_moretocome_succeeds(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_moretocome_hangup(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_moretocome_badreply(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_moretocome_shutdown(void) {
    test_fixture_t *tf;
    request_t *request;
...
static void test_moretocome_cancel(void) {
    test_fixture_t *tf;
    request_t *request;
...
void test_monitoring_install(TestSuite *suite) {
