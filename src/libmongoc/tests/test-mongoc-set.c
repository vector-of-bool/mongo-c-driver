...
static void test_set_dtor(void *item_, void *ctx_) {
...
static bool test_set_visit_cb(void *item_, void *ctx_) {
...
static bool test_set_stop_after_cb(void *item_, void *ctx_) {
...
void test_set_install(TestSuite *suite) {
