...
static mongoc_client_t *_client_new_disable_ss(bool use_compression) {
...
mongoc_collection_t *_drop_and_populate_coll(mongoc_client_t *client) {
    /* insert thrice. */
...
void _ping(mongoc_client_t *client) {
    bool ret;
    bson_error_t err;
...
static void test_counters_op_msg(void *ctx) {
    mongoc_collection_t *coll;
...
static void test_counters_op_compressed(void *ctx) {
    mongoc_collection_t *coll;
    mongoc_client_t *client;
...
static void test_counters_cursors(void) {
    mongoc_collection_t *coll;
    mongoc_cursor_t *cursor;
    const bson_t *bson;
    mongoc_client_t *client;
...
static void test_counters_clients(void) {
...
static void test_counters_streams(void *ctx) {
...
static void test_counters_auth(void *ctx) {
...
static void test_counters_dns(void) {
    mongoc_client_t *client;
    mongoc_server_description_t *sd;
    bson_error_t err;
    reset_all_counters();
...
static void test_counters_streams_timeout(void) {
...
void test_counters_install(TestSuite *suite) {
#ifdef MONGOC_ENABLE_SHM_COUNTERS
