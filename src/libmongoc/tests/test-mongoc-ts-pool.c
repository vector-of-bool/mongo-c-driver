...
static void test_ts_pool_empty(void) {
...
static void test_ts_pool_simple(void) {
    mongoc_ts_pool *pool = mongoc_ts_pool_new((mongoc_ts_pool_params){.element_size = sizeof(int)});
    int *item;
    int *item2;
...
static int _is_int_42(int *v, void *unused) {
    (void)unused;
    return *v == 42;
}

static void _set_int_to_7(int *v, void *unused, bson_error_t *unused2) {
    (void)unused;
    (void)unused2;
    *v = 7;
}
...
static void test_ts_pool_special(void) {
...
void test_ts_pool_install(TestSuite *suite) {
