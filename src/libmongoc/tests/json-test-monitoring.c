...
static void assert_host_in_uri(const mongoc_host_list_t *host, const mongoc_uri_t *uri) {
...
static void started_cb(const mongoc_apm_command_started_t *event) {
...
static void succeeded_cb(const mongoc_apm_command_succeeded_t *event) {
...
static void failed_cb(const mongoc_apm_command_failed_t *event) {
...
static void server_changed_cb(const mongoc_apm_server_changed_t *event) {
    json_test_ctx_t *ctx;
...
void set_apm_callbacks(json_test_ctx_t *ctx, mongoc_client_t *client) {
...
void set_apm_callbacks_pooled(json_test_ctx_t *ctx, mongoc_client_pool_t *pool) {
    mongoc_apm_callbacks_t *callbacks;
...
static bool lsids_match(const bson_t *a, const bson_t *b) {
...
void apm_match_visitor_ctx_reset(apm_match_visitor_ctx_t *ctx) {
    bson_free(ctx->command_name);
    ctx->command_name = NULL;
}

static match_action_t apm_match_visitor(match_ctx_t *ctx, bson_iter_t *pattern_iter, bson_iter_t *doc_iter) {
 ...
 *-----------------------------------------------------------------------
 */
void check_json_apm_events(json_test_ctx_t *ctx, const bson_t *expectations) {
...
void test_apm_install(TestSuite *suite) {
