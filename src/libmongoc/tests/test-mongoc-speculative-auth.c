 ...
 * sent */
static future_t *_force_hello_with_ping(mongoc_client_t *client) {
    future_t *future;
...
static void _respond_to_ping(future_t *future, mock_server_t *server, bool expect_ping) {
    request_t *request;
...
static bool _auto_hello_without_speculative_auth(request_t *request, void *data) {
...
static void _test_mongoc_speculative_auth(bool pooled,
                                          bool use_ssl,
...
static void _setup_speculative_auth_scram(mongoc_uri_t *uri) {
    mongoc_uri_set_username(uri, "sasl");
    mongoc_uri_set_password(uri, "sasl");
}

static void _compare_auth_cmd_scram(bson_t *auth_cmd) {
    bson_iter_t iter;
...
static void _post_hello_scram_invalid_auth_response(mock_server_t *srv) {
    request_t *request;
    const bson_t *request_doc;
...
static void test_mongoc_speculative_auth_request_none(void) {
    _test_mongoc_speculative_auth(false, false, NULL, false, NULL, NULL, NULL, true);
}

static void test_mongoc_speculative_auth_request_none_pool(void) {
...
static void _setup_speculative_auth_x_509(mongoc_uri_t *uri) {
...
static void _compare_auth_cmd_x509(bson_t *auth_cmd) {
...
static void test_mongoc_speculative_auth_request_x509(void) {
...
static void test_mongoc_speculative_auth_request_x509_pool(void) {
    bson_t *response = BCON_NEW("dbname",
                                BCON_UTF8("$external"),
                                "user",
                                BCON_UTF8("CN=myName,OU=myOrgUnit,O=myOrg,L=myLocality,ST="
...
static void test_mongoc_speculative_auth_request_scram(void) {
...
static void test_mongoc_speculative_auth_request_scram_pool(void) {
    bson_t *response = BCON_NEW("conversationId",
                                BCON_INT32(15081984),
                                "payload",
                                BCON_BIN(BSON_SUBTYPE_BINARY, (const uint8_t *)"deadbeef", 8));
...
void test_speculative_auth_install(TestSuite *suite) {
#ifdef MONGOC_ENABLE_CRYPTO
