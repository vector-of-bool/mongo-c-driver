...
static int _mongoc_stream_debug_close(mongoc_stream_t *stream) {
    return mongoc_stream_close(((mongoc_stream_debug_t *)stream)->wrapped);
}

static void _mongoc_stream_debug_destroy(mongoc_stream_t *stream) {
...
static void _mongoc_stream_debug_failed(mongoc_stream_t *stream) {
    mongoc_stream_debug_t *debug_stream = (mongoc_stream_debug_t *)stream;
...
static int _mongoc_stream_debug_setsockopt(mongoc_stream_t *stream,
                                           int level,
                                           int optname,
                                           void *optval,
...
static int _mongoc_stream_debug_flush(mongoc_stream_t *stream) {
    return mongoc_stream_flush(((mongoc_stream_debug_t *)stream)->wrapped);
}

static ssize_t _mongoc_stream_debug_readv(mongoc_stream_t *stream,
                                          mongoc_iovec_t *iov,
                                          size_t iovcnt,
                                          size_t min_bytes,
...
static bool _mongoc_stream_debug_check_closed(mongoc_stream_t *stream) {
    return mongoc_stream_check_closed(((mongoc_stream_debug_t *)stream)->wrapped);
}

static bool _mongoc_stream_debug_timed_out(mongoc_stream_t *stream) {
    return mongoc_stream_timed_out(((mongoc_stream_debug_t *)stream)->wrapped);
}

static bool _mongoc_stream_debug_should_retry(mongoc_stream_t *stream) {
    return mongoc_stream_should_retry(((mongoc_stream_debug_t *)stream)->wrapped);
}

static mongoc_stream_t *_mongoc_stream_debug_get_base_stream(mongoc_stream_t *stream) {
...
mongoc_stream_t *debug_stream_new(mongoc_stream_t *stream, debug_stream_stats_t *stats) {
