...
static bool _run_operation(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
    bson_t reply;
    bool res;
...
static void test_client_side_encryption_cb(bson_t *scenario) {
...
static void _check_bypass(mongoc_auto_encryption_opts_t *opts) {
...
static bson_t *_make_aws_kms_provider(bson_t *kms_providers) {
...
static bson_t *_make_azure_kms_provider(bson_t *kms_providers) {
...
static bson_t *_make_gcp_kms_provider(bson_t *kms_providers) {
    char *gcp_email;
    char *gcp_privatekey;
...
static bson_t *_make_kmip_kms_provider(bson_t *kms_providers) {
    if (!kms_providers) {
        kms_providers = bson_new();
    }
...
static bson_t *_make_tls_opts(void) {
...
static bson_t *_make_kms_masterkey(const char *provider) {
...
static void test_bson_size_limits_and_batch_splitting(void *unused) {
...
static void test_datakey_and_double_encryption_creating_and_using(mongoc_client_encryption_t *client_encryption,
                                                                  mongoc_client_t *client,
    ...
    assert_match_bson(test_ctx->last_cmd,
    ...
    BSON_ASSERT(0
                == memcmp(encrypted_via_altname.value.v_binary.data,
...
static void test_create_datakey_with_custom_key_material(void *unused) {
     ...
     * the following custom key material: */
    {
        ...
        ASSERT_OR_PRINT(
            mongoc_client_encryption_create_datakey(client_encryption, "local", datakey_opts, &keyid, &error),
            error);
     ...
     * assert the resulting value is equal to the following (given as base64): */
    {
        ...
        mongoc_client_encryption_encrypt_opts_set_algorithm(encrypt_opts,
                                                            MONGOC_AEAD_AES_256_CBC_HMAC_SHA_512_DETERMINISTIC);
        ASSERT_OR_PRINT(
            mongoc_client_encryption_encrypt(client_encryption, &to_encrypt, encrypt_opts, &ciphertext, &error),
            error);
...
static void test_datakey_and_double_encryption(void *unused) {
    mongoc_client_t *client;
    mongoc_client_t *client_encrypted;
...
static void _test_key_vault(bool with_external_key_vault) {
    mongoc_client_t *client;
    mongoc_client_t *client_encrypted;
...
static void test_external_key_vault(void *unused) {
    BSON_UNUSED(unused);
...
static void test_views_are_prohibited(void *unused) {
    mongoc_client_t *client;
    mongoc_client_t *client_encrypted;
    mongoc_collection_t *coll;
    bool res;
...
static void _endpoint_setup(mongoc_client_t *keyvault_client,
                            mongoc_client_encryption_t **client_encryption,
...
static void test_custom_endpoint(void *unused) {
...
static corpus_field_t *_corpus_field_new(bson_iter_t *top_iter) {
    bson_iter_t iter;
...
static void _corpus_field_destroy(corpus_field_t *field) {
    if (!field) {
        return;
    }
...
static void _corpus_check_encrypted(mongoc_client_encryption_t *client_encryption,
...
static void _insert_from_file(mongoc_collection_t *coll, char *path) {
    bson_t *datakey;
    bool res;
    bson_error_t error;
...
static void _test_corpus(bool local_schema) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bson_t *schema;
    bson_t *create_cmd;
...
static void test_corpus(void *unused) {
    BSON_UNUSED(unused);
...
static void _reset(mongoc_client_pool_t **pool,
...
static void _perform_op(mongoc_client_t *client_encrypted) {
    bool ret;
    bson_error_t error;
    mongoc_collection_t *coll;
...
static void _perform_op_pooled(mongoc_client_pool_t *client_pool_encrypted) {
    mongoc_client_t *client_encrypted;
...
static void test_invalid_single_and_pool_mismatches(void *unused) {
...
static void _test_multi_threaded(bool external_key_vault) {
...
static void test_multi_threaded(void *ctx_unused) {
...
static void test_malformed_explicit(void *unused) {
    mongoc_client_t *client;
    bson_t *kms_providers;
    mongoc_client_encryption_t *client_encryption;
    mongoc_client_encryption_opts_t *client_encryption_opts;
...
static void _check_mongocryptd_not_spawned(void) {
    mongoc_client_t *client;
    bson_t *cmd;
    bson_error_t error;
    bool ret;
...
static void test_bypass_spawning_via_mongocryptdBypassSpawn(void *unused) {
    mongoc_client_t *client_encrypted;
    mongoc_auto_encryption_opts_t *auto_encryption_opts;
    bson_t *kms_providers;
...
static void test_bypass_spawning_via_helper(const char *auto_encryption_opt) {
    mongoc_client_t *client_encrypted;
    mongoc_auto_encryption_opts_t *auto_encryption_opts;
    bson_t *kms_providers;
    bson_t *doc_to_insert;
...
static void test_bypass_spawning_via_bypassAutoEncryption(void *unused) {
    BSON_UNUSED(unused);
...
static void test_bypass_spawning_via_bypassQueryAnalysis(void *unused) {
    BSON_UNUSED(unused);
...
static void test_bypass_spawning_via_cryptSharedLibLoaded(void *unused) {
    BSON_UNUSED(unused);
    test_bypass_spawning_via_helper("cryptSharedLibRequired");
}

static int _skip_if_no_crypt_shared(void) {
...
static mongoc_client_encryption_t *_make_kms_certificate_client_encryption(mongoc_client_t *client,
                                                                           bson_error_t *error) {
    mongoc_client_encryption_t *client_encryption;
...
static void test_kms_tls_cert_valid(void *unused) {
...
static void test_kms_tls_cert_expired(void *unused) {
    bool ret;
...
static void test_kms_tls_cert_wrong_host(void *unused) {
    bool ret;
...
static mongoc_client_encryption_t *_tls_test_make_client_encryption(mongoc_client_t *keyvault_client,
...
static void test_kms_tls_options(void *unused) {
    mongoc_client_t *keyvault_client;
    ...
    mongoc_client_encryption_datakey_opts_set_masterkey(
        dkopts,
        tmp_bson("{ 'keyVaultEndpoint': 'doesnotexist.local', 'keyName': 'foo' }"));
...
static void test_kms_tls_options_extra_rejected(void *unused) {
    ...
    mongoc_client_encryption_opts_set_tls_opts(
        ce_opts,
        tmp_bson("{'aws': {'tlsCAFile': 'foo.pem'}, 'aws': {'tlsCAFile': 'foo.pem'}}"));
    ce = mongoc_client_encryption_new(ce_opts, &error);
    ASSERT_ERROR_CONTAINS(error,
                          MONGOC_ERROR_CLIENT_SIDE_ENCRYPTION,
                          MONGOC_ERROR_CLIENT_INVALID_ENCRYPTION_ARG,
    ...
    mongoc_client_encryption_opts_set_tls_opts(
        ce_opts,
        tmp_bson("{'aws': {'%s': true}}", MONGOC_URI_TLSDISABLEOCSPENDPOINTCHECK));
    ce = mongoc_client_encryption_new(ce_opts, &error);
...
static ee_fixture *explicit_encryption_setup(void) {
...
static void explicit_encryption_destroy(ee_fixture *eef) {
    if (!eef) {
        return;
    }
...
static ree_fixture *range_explicit_encryption_setup(const char *typeStr) {
...
static void range_explicit_encryption_destroy(ree_fixture *reef) {
    if (!reef) {
        return;
    }
...
// NULL terminated.
static void range_explicit_encryption_assert_cursor_results(ree_fixture *reef, mongoc_cursor_t *cursor, ...) {
    const bson_t *got;
    va_list args;
    bson_error_t error;
...
static void test_range_explicit_encryption_case1(void *ctx) {
...
static void test_range_explicit_encryption_case2(void *ctx) {
    ...
    // Query and check results.
    {
        ...
        range_explicit_encryption_assert_cursor_results(reef,
                                                        cursor,
                                                        &reef->six,
                                                        &reef->thirty,
                                                        &reef->twoHundred,
...
static void test_range_explicit_encryption_case3(void *ctx) {
...
static void test_range_explicit_encryption_case4(void *ctx) {
...
static void test_range_explicit_encryption_case5(void *ctx) {
...
static void test_range_explicit_encryption_case6(void *ctx) {
...
static void test_range_explicit_encryption_case7(void *ctx) {
...
static void test_range_explicit_encryption_case8(void *ctx) {
...
static void test_explicit_encryption_case1(void *unused) {
...
static void test_explicit_encryption_case2(void *unused) {
...
static void test_explicit_encryption_case3(void *unused) {
...
static void test_explicit_encryption_case4(void *unused) {
...
static void test_explicit_encryption_case5(void *unused) {
...
static void _test_unique_index_on_keyaltnames_setup(void (*test_case)(mongoc_client_encryption_t *,
                                                                      const bson_value_t *keyid)) {
    mongoc_client_t *client = NULL;
     ...
     * and the keyAltName "def" (referred to as "the existing key"). */
    {
        ...
        ASSERT_OR_PRINT(
            mongoc_client_encryption_create_datakey(client_encryption, "local", opts, &existing_key, &error),
            error);
...
static void _test_unique_index_on_keyaltnames_case_1(mongoc_client_encryption_t *client_encryption,
...
static void _test_unique_index_on_keyaltnames_case_2(mongoc_client_encryption_t *client_encryption,
                                                     const bson_value_t *existing_key) {
     ...
     * document contains the keyAltName "def" added during Setup. */
    {
        bson_t key_doc;
        ASSERT_OR_PRINT(
            mongoc_client_encryption_add_key_alt_name(client_encryption, existing_key, "def", &key_doc, &error),
            error);
...
static void test_unique_index_on_keyaltnames(void *unused) {
    BSON_UNUSED(unused);
...
static void decryption_events_succeeded_cb(const mongoc_apm_command_succeeded_t *event) {
...
static void decryption_events_failed_cb(const mongoc_apm_command_failed_t *event) {
...
decryption_events_fixture *decryption_events_setup(void) {
...
static void decryption_events_fixture_destroy(decryption_events_fixture *def) {
...
static void test_decryption_events_case1(void *unused) {
    bool got;
    bson_error_t error;
 ...
 * Expect an error returned and a CommandFailed event to be emitted. */
static void test_decryption_events_case2(void *unused)
 ...
 * ciphertext. */
static void test_decryption_events_case3(void *unused) {
    bool got;
    bson_error_t error;
    decryption_events_fixture *def = decryption_events_setup();
    bson_t to_insert = BSON_INITIALIZER;
 ...
 * ciphertext. */
static void test_decryption_events_case4(void *unused) {
    bool got;
    bson_error_t error;
    decryption_events_fixture *def = decryption_events_setup();
    bson_t to_insert = BSON_INITIALIZER;
...
static void _test_rewrap_with_separate_client_encryption(const char *src_provider, const char *dst_provider) {
    ...
    // options: (see below).
    {
        ...
        ASSERT_OR_PRINT(
            mongoc_client_encryption_create_datakey(clientEncryption1, src_provider, dk_opts, &keyid, &error),
            error);
    ...
    {
        {
            ...
            ASSERT_OR_PRINT(mongoc_client_encryption_rewrap_many_datakey(clientEncryption2,
                                                                         NULL,
                                                                         dst_provider,
                                                                         dst_masterkey,
                                                                         result,
...
static void test_rewrap_with_separate_client_encryption(void *unused) {
    BSON_UNUSED(unused);
 ...
 * CDRIVER-4379. */
static void test_qe_docs_example(void *unused) {
    bson_error_t error;
   ...
   encryptedFieldsMap = BCON_NEW (
    ...
    /* Auto encrypt an insert and find. */
    {
        ...
        ASSERT_OR_PRINT(
            mongoc_collection_insert_one(encryptedColl, to_insert, NULL /* opts */, NULL /* reply */, &error),
            error);
...
static bool _kms_callback(void *userdata, const bson_t *params, bson_t *out, bson_error_t *error) {
...
static void test_kms_callback(void *unused) {
...
static void _test_auto_aws(bool should_succeed) {
...
static void test_auto_aws_fail(void *unused) {
    BSON_UNUSED(unused);
    _test_auto_aws(false);
}

static void test_auto_aws_succeed(void *unused) {
    BSON_UNUSED(unused);
    _test_auto_aws(true);
}

static int _have_aws_creds_env(void *unused) {
    BSON_UNUSED(unused);
...
static int _not_have_aws_creds_env(void *unused) {
...
static void test_drop_qe_null_error(void *unused) {
    bson_error_t error;
    mongoc_client_t *const client = test_framework_new_default_client();
    bson_t *const kmsProviders = _make_kms_providers(false /* with aws */, true /* with local */);
    bson_t *encryptedFieldsMap;
...
static bool _auto_datakeys(struct auto_datakey_context *ctx) {
    ctx->out_keyid->value.v_int32 = 42;
    ctx->out_keyid->value_type = BSON_TYPE_INT32;
    return true;
}

static bool _auto_datakeys_error(struct auto_datakey_context *ctx) {
    bson_set_error(ctx->out_error, 42, 1729, "I am an error");
    return false;
}

static bool _auto_datakeys_error_noset(struct auto_datakey_context *ctx) {
    // Do not set an error code, but indicate error anyway
    BSON_UNUSED(ctx);
    return false;
}

static void test_auto_datakeys(void *unused) {
    BSON_UNUSED(unused);
...
static void _do_cec_test(void (*test)(const char *kmsProvider)) {
    test("local");
    test("aws");
}
...
CEC_TEST(test_create_encrypted_collection_simple, const char *kmsProvider) {
    ...
    mongoc_collection_t *const coll = mongoc_client_encryption_create_encrypted_collection(ce,
                                                                                           db,
                                                                                           "test-coll",
                                                                                           &ccOpts,
                                                                                           NULL,
...
static void test_create_encrypted_collection_no_encryptedFields_helper(mongoc_client_t *client,
                                                                       const char *dbName,
                                                                       const char *collName,
 ...
 * loaded */
static void test_bypass_mongocryptd_shared_library(void *unused) {
    BSON_UNUSED(unused);
    mongoc_client_t *client_encrypted;
    mongoc_auto_encryption_opts_t *auto_encryption_opts;
    bson_t *kms_providers;
...
void test_client_side_encryption_install(TestSuite *suite) {
