...
static char *test_diagnostics_error_string(bson_error_t *error) {
    msg_t *msg_iter = NULL;
...
void test_diagnostics_init(void) {
    test_diagnostics_t *td = &diagnostics;
...
void test_diagnostics_reset(void) {
    test_diagnostics_t *td = &diagnostics;
    msg_t *iter, *iter_tmp;
...
void test_diagnostics_cleanup(void) {
    test_diagnostics_t *td = &diagnostics;
...
void _test_diagnostics_add(bool fail, const char *fmt, ...) {
    test_diagnostics_t *td = &diagnostics;
    va_list args;
    msg_t *msg = NULL;
    char *msg_string;
...
void test_diagnostics_abort(bson_error_t *error) {
    signal(SIGABRT, SIG_DFL);
