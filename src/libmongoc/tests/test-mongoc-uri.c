...
static void test_mongoc_uri_new(void) {
    ...
    BSON_ASSERT(bson_iter_init_find_case(&iter, &properties, "CANONICALIZE_HOST_NAME") && BSON_ITER_HOLDS_UTF8(&iter)
...
static void test_mongoc_uri_authmechanismproperties(void) {
    mongoc_uri_t *uri;
    bson_t props;
    const bson_t *options;
...
static void test_mongoc_uri_functions(void) {
    ...
    uri = mongoc_uri_new("mongodb://localhost/?" MONGOC_URI_SOCKETTIMEOUTMS "=1&" MONGOC_URI_SOCKETCHECKINTERVALMS
                         "=200");
...
static void test_mongoc_uri_new_with_error(void) {
...
static void test_mongoc_uri_compound_setters(void) {
    mongoc_uri_t *uri;
...
static void test_mongoc_uri_new_for_host_port(void) {
    mongoc_uri_t *uri;
...
static void test_mongoc_uri_compressors(void) {
    mongoc_uri_t *uri;
...
static void test_mongoc_uri_unescape(void) {
...
static void test_mongoc_uri_read_prefs(void) {
...
static void test_mongoc_uri_write_concern(void) {
...
static void test_mongoc_uri_read_concern(void) {
...
static void test_mongoc_uri_long_hostname(void) {
    char *host;
    char *host_and_port;
...
static void test_mongoc_uri_tls_ssl(const char *tls,
...
static void test_mongoc_uri_tls(void) {
    bson_error_t err = {0};
    mongoc_uri_t *uri;
...
static void test_mongoc_uri_ssl(void) {
    mongoc_uri_t *uri;
...
static void test_mongoc_uri_local_threshold_ms(void) {
    mongoc_uri_t *uri;
...
static void test_mongoc_uri_srv(void) {
    mongoc_uri_t *uri;
    bson_error_t error;
...
static void test_mongoc_uri_dns_options(void) {
    mongoc_uri_t *uri;
    bson_error_t error;
...
static void test_mongoc_uri_utf8(void) {
    bson_error_t err;
...
static void test_mongoc_uri_duplicates(void) {
...
static void test_mongoc_uri_int_options(void) {
    mongoc_uri_t *uri;
...
static void test_one_tls_option_enables_tls(void) {
...
static void test_casing_options(void) {
    mongoc_uri_t *uri;
    bson_error_t error;
...
void test_uri_install(TestSuite *suite) {
