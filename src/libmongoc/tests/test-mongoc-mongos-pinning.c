...
static void add_multiple_mongoses(mongoc_uri_t *uri) {
    bson_error_t error;
...
static void test_new_transaction_unpins(void *ctx) {
    mongoc_uri_t *uri;
...
static void test_non_transaction_unpins(void *ctx) {
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bson_error_t error;
...
void test_mongos_pinning_install(TestSuite *suite) {
