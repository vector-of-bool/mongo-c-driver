...
static OCSP_CERTID *create_cert_id(long serial) {
    OCSP_CERTID *id;
...
static void test_mongoc_cache_insert(void) {
...
static void test_mongoc_cache_update(void) {
    OCSP_CERTID *id;
...
static void test_mongoc_cache_remove_expired_cert(void) {
    ASN1_GENERALIZEDTIME *this_update_in, *next_update_in;
...
void test_ocsp_cache_install(TestSuite *suite) {
