...
static void test_set_error_api_single(void) {
...
static void test_set_error_api_pooled(void) {
...
static void _test_command_error(int32_t error_api_version) {
...
static void test_command_error_default(void) {
    _test_command_error(0);
}

static void test_command_error_v1(void) {
    _test_command_error(1);
}

static void test_command_error_v2(void) {
    _test_command_error(2);
}

static void test_has_label(void) {
...
static void test_state_change_helper(uint32_t domain, bool expect_error) {
    bson_error_t error;
    mongoc_server_err_t not_primary_codes[] = {MONGOC_SERVER_ERR_NOTPRIMARY,
...
static void test_state_change(void) {
...
void test_error_install(TestSuite *suite) {
