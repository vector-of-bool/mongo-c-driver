 ...
 * 120 characters. */
static void test_fixture_init(test_fixture_t *test_fixture, uint32_t db_len, uint32_t coll_len) {
    bool ret;
    bson_error_t error;
...
static void test_fixture_cleanup(test_fixture_t *test_fixture) {
...
static void crud(test_fixture_t *test_fixture) {
    bson_error_t error;
    bool ret;
 ...
 */
static void getmore(test_fixture_t *test_fixture) {
    bson_error_t error;
    bool ret;
    mongoc_cursor_t *cursor;
    const bson_t *found;
...
static void change_stream(test_fixture_t *test_fixture) {
 ...
 * MONGOC_NAMESPACE_MAX */
static void client_command(test_fixture_t *test_fixture) {
    const bson_t *found;
    mongoc_cursor_t *cursor;
    bool ret;
    bson_error_t error;
 ...
 * MONGOC_NAMESPACE_MAX. */
static void database_command(test_fixture_t *test_fixture) {
    const bson_t *found;
    mongoc_cursor_t *cursor;
    bool ret;
    bson_error_t error;
 ...
 * MONGOC_NAMESPACE_MAX. */
static void collection_command(test_fixture_t *test_fixture) {
    const bson_t *found;
    mongoc_cursor_t *cursor;
    bool ret;
    bson_error_t error;
...
static void _check_existence(mongoc_client_t *client, char *ns_db, char *ns_coll, bool should_exist) {
    mongoc_database_t *db;
    char **db_names;
    char **coll_names;
...
static void collection_rename(test_fixture_t *test_fixture) {
    bool ret;
    bson_error_t error;
    char *new_db;
    char *new_coll;
...
static void unsupported_long_coll(void *unused) {
    bson_error_t error;
    bool ret;
    char *long_coll;
    mongoc_client_t *client;
 ...
 * versions. */
static void unsupported_long_db(void) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bson_error_t error;
    bool ret;
...
void test_long_namespace_install(TestSuite *suite) {
