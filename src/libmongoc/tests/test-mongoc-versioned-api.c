...
static void _test_mongoc_server_api_copy(void) {
...
static void _test_mongoc_server_api_setters(void) {
...
static void _test_mongoc_server_api_client(void) {
...
static void _test_mongoc_server_api_client_pool(void) {
    mongoc_uri_t *uri;
...
static void _test_mongoc_server_api_client_pool_once(void) {
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_server_api_t *api;
...
static void _test_mongoc_client_uses_server_api(void) {
...
void test_client_versioned_api_install(TestSuite *suite) {
