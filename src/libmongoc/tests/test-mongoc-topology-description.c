...
static void _test_has_readable_writable_server(bool pooled) {
...
static void test_has_readable_writable_server_single(void) {
    _test_has_readable_writable_server(false);
}

static void test_has_readable_writable_server_pooled(void) {
    _test_has_readable_writable_server(true);
}

static const mongoc_server_description_t *_sd_for_host(mongoc_topology_description_t *td, const char *host) {
...
static void test_get_servers(void) {
    mongoc_uri_t *uri;
    mongoc_topology_t *topology;
...
void _topology_changed(const mongoc_apm_topology_changed_t *event) {
    int *num_calls;
...
static void test_topology_version_equal(void) {
    mongoc_uri_t *uri;
    mongoc_topology_t *topology;
    const mongoc_server_description_t *sd;
...
static void test_topology_description_new_copy(void) {
    mongoc_uri_t *uri;
    mongoc_topology_t *topology;
...
void test_topology_description_install(TestSuite *suite) {
