...
static mongoc_uri_t *_get_test_uri(void) {
    mongoc_uri_t *uri;
...
static void _setup_test_with_client(mongoc_client_t *client) {
...
static int _connection_count(mongoc_client_t *client, uint32_t server_id) {
    bson_error_t error;
    bson_iter_t iter;
    bson_iter_t child;
...
static void _run_test_single_and_pooled(_test_fn_t test) {
    mongoc_uri_t *uri;
...
static void test_getmore_iteration(mongoc_client_t *client) {
    mongoc_write_concern_t *wc;
    mongoc_database_t *db;
    mongoc_collection_t *coll;
...
static void test_getmore_iteration_runner(void *ctx) {
    BSON_UNUSED(ctx);
...
static void test_not_primary_keep_pool(mongoc_client_t *client) {
    mongoc_database_t *db;
    mongoc_collection_t *coll;
    bson_error_t error;
    bool res;
...
static void test_not_primary_keep_pool_runner(void *ctx) {
    BSON_UNUSED(ctx);
...
static void test_not_primary_reset_pool(mongoc_client_t *client) {
    mongoc_database_t *db;
    mongoc_collection_t *coll;
...
static void test_not_primary_reset_pool_runner(void *ctx) {
...
static void test_shutdown_reset_pool(mongoc_client_t *client) {
    mongoc_database_t *db;
    mongoc_collection_t *coll;
    mongoc_read_prefs_t *read_prefs;
    bson_error_t error;
...
static void test_shutdown_reset_pool_runner(void *ctx) {
    BSON_UNUSED(ctx);
...
static void test_interrupted_shutdown_reset_pool(mongoc_client_t *client) {
    mongoc_database_t *db;
    mongoc_collection_t *coll;
    mongoc_read_prefs_t *read_prefs;
    bson_error_t error;
...
static void test_interrupted_shutdown_reset_pool_runner(void *ctx) {
    BSON_UNUSED(ctx);
...
void test_primary_stepdown_install(TestSuite *suite) {
