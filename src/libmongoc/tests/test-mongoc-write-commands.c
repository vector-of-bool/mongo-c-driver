...
static void test_split_insert(void) {
...
static void test_invalid_write_concern(void) {
    mongoc_bulk_write_flags_t write_flags = MONGOC_BULK_WRITE_FLAGS_INIT;
    mongoc_write_command_t command;
    mongoc_write_result_t result;
    mongoc_collection_t *collection;
...
static void test_bypass_validation(void *context) {
...
static void test_bypass_command_started(const mongoc_apm_command_started_t *event) {
    ASSERT_HAS_NOT_FIELD(mongoc_apm_command_started_get_command(event), "bypassDocumentValidation");
}

static void test_bypass_not_sent(void) {
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
...
static void test_disconnect_mid_batch(void) {
...
static void _configure_failpoint(mongoc_client_t *client, const char *mode, const char *data) {
    bool ret;
    bson_error_t error;
...
static void _test_invalid_wc_server_error(void *unused) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bool ret;
    bson_t reply;
...
void test_write_command_install(TestSuite *suite) {
