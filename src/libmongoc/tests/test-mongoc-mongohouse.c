...
static bool mongohouse_test_operation_cb(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
    bson_t reply;
    bool res;
...
static void test_mongohouse_cb(bson_t *scenario) {
...
static bool cursor_in_killed_array(bson_t *cursors_killed, int64_t cursor_id) {
    bson_iter_t iter;
 ...
 * ADL. */
static void test_mongohouse_kill_cursors(void *ctx_unused) {
...
static void _run_ping_test(const char *connection_string) {
    mongoc_client_t *client;
    mongoc_uri_t *uri;
    bson_error_t error;
    bool res;
...
static void test_mongohouse_auth(void *ctx_unused) {
    BSON_UNUSED(ctx_unused);
...
static void test_mongohouse_no_auth(void *ctx_unused) {
    BSON_UNUSED(ctx_unused);

    _run_ping_test("mongodb://localhost:27017");
}

void test_mongohouse_install(TestSuite *suite) {
