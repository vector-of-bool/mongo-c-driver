...
static void test_client_cmd_w_server_id(void) {
    mock_rs_t *rs;
...
static void test_client_cmd_w_server_id_sharded(void) {
...
static void test_server_id_option(void *ctx) {
    mongoc_client_t *client;
    bson_error_t error;
    bson_t *cmd;
    bool r;
...
static void test_client_cmd_w_write_concern(void *ctx) {
...
static void test_client_cmd_write_concern(void) {
    mongoc_client_t *client;
    bson_t reply;
    bson_error_t error;
    future_t *future;
...
static void test_client_cmd_write_concern_fam(void) {
    mongoc_client_t *client;
...
static char *gen_test_user(void) {
    return bson_strdup_printf("testuser_%u_%u", (unsigned)time(NULL), (unsigned)gettestpid());
}

static char *gen_good_uri(const char *username, const char *dbname) {
...
static void test_mongoc_client_authenticate(void *context) {
...
static void test_mongoc_client_speculative_auth_failure(bool pooled) {
    mongoc_client_t *admin_client;
    char *username;
    bson_t roles;
    mongoc_database_t *database;
...
static void test_mongoc_client_single_speculative_auth_failure(void *context) {
    BSON_UNUSED(context);

    test_mongoc_client_speculative_auth_failure(false);
}

static void test_mongoc_client_pooled_speculative_auth_failure(void *context) {
    BSON_UNUSED(context);

    test_mongoc_client_speculative_auth_failure(true);
}

static void test_mongoc_client_authenticate_cached(bool pooled) {
...
static void test_mongoc_client_authenticate_cached_pooled(void *context) {
    BSON_UNUSED(context);

    test_mongoc_client_authenticate_cached(true);
}

static void test_mongoc_client_authenticate_cached_single(void *context) {
    BSON_UNUSED(context);

    test_mongoc_client_authenticate_cached(false);
}

static void test_mongoc_client_authenticate_failure(void *context) {
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
    mongoc_client_t *client;
    const bson_t *doc;
...
static void test_mongoc_client_authenticate_timeout(void *context) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    bson_t reply;
 ...
 * checks. */
static void test_wire_version(void) {
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    mock_server_t *server;
    bson_error_t error;
...
static void test_mongoc_client_command(void) {
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
    const bson_t *doc;
    bool r;
...
static void test_mongoc_client_command_defaults(void) {
    mongoc_client_t *client;
...
static void test_mongoc_client_command_secondary(void) {
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
    mongoc_read_prefs_t *read_prefs;
    bson_t cmd = BSON_INITIALIZER;
...
static void _test_command_read_prefs(bool simple, bool pooled) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool = NULL;
    mongoc_client_t *client;
...
static void test_command_simple_read_prefs_single(void) {
    _test_command_read_prefs(true, false);
}

static void test_command_simple_read_prefs_pooled(void) {
    _test_command_read_prefs(true, true);
}

static void test_command_read_prefs_single(void) {
    _test_command_read_prefs(false, false);
}

static void test_command_read_prefs_pooled(void) {
    _test_command_read_prefs(false, true);
}

static void test_command_not_found(void) {
    mongoc_client_t *client;
    const bson_t *doc;
    bson_error_t error;
    mongoc_cursor_t *cursor;
...
static void test_command_not_found_simple(void) {
    mongoc_client_t *client;
    bson_t reply;
    bson_error_t error;
...
static void test_command_with_opts_read_prefs(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_read_prefs_t *read_prefs;
    bson_t *cmd;
...
static void test_read_write_cmd_with_opts(void) {
    mock_rs_t *rs;
    mongoc_client_t *client;
     ...
     * CDRIVER-2224
     */
    future = future_client_read_write_command_with_opts(client,
                                                        "db",
                                                        tmp_bson("{'ping': 1}"),
                                                        secondary,
                                                        NULL,
...
static void test_read_command_with_opts(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    bson_t *cmd;
    bson_t *opts;
    ...
    request = mock_server_receives_msg(server,
                                       MONGOC_MSG_NONE,
                                       tmp_bson("{'$db': 'admin', 'create': 'db', 'collation': {'locale': 'en_US'}}"));
...
static void test_command_with_opts(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    bson_t *cmd;
    mongoc_write_concern_t *wc;
...
static void test_command_with_opts_op_msg(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    bson_t *cmd;
    mongoc_write_concern_t *wc;
...
static void test_command_empty(void) {
    mongoc_client_t *client;
    mongoc_write_concern_t *wc;
    bson_error_t error;
    bool r;
...
static void test_command_no_errmsg(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    bson_t *cmd;
    bson_error_t error;
...
static void test_unavailable_seeds(void) {
    ...
    *(uri_str++) = bson_strdup_printf("mongodb://u:p@%s,%s",
                                      mock_server_get_host_and_port(servers[0]),
                                      mock_server_get_host_and_port(servers[1]));
...
static bool responder(request_t *request, void *data) {
    BSON_UNUSED(data);
...
static bool host_equals(const void *item, void *ctx) {
...
static void test_seed_list(bool rs, connection_option_t connection_option, bool pooled) {
    ...
    if (connection_option == CONNECT || connection_option == RECONNECT) {
        ...
        ASSERT_OR_PRINT(
            mongoc_client_command_simple(client, "test", tmp_bson("{'foo': 1}"), primary_pref, &reply, &error),
            error);
...
static void test_rs_seeds_no_connect_single(void) {
    test_seed_list(true, NO_CONNECT, false);
}

static void test_rs_seeds_no_connect_pooled(void) {
    test_seed_list(true, NO_CONNECT, true);
}

static void test_rs_seeds_connect_single(void) {
    test_seed_list(true, CONNECT, false);
}

static void test_rs_seeds_connect_pooled(void) {
    test_seed_list(true, CONNECT, true);
}

static void test_rs_seeds_reconnect_single(void) {
    test_seed_list(true, RECONNECT, false);
}

static void test_rs_seeds_reconnect_pooled(void) {
    test_seed_list(true, RECONNECT, true);
}

static void test_mongos_seeds_no_connect_single(void) {
    test_seed_list(false, NO_CONNECT, false);
}

static void test_mongos_seeds_no_connect_pooled(void) {
    test_seed_list(false, NO_CONNECT, true);
}

static void test_mongos_seeds_connect_single(void) {
    test_seed_list(false, CONNECT, false);
}

static void test_mongos_seeds_connect_pooled(void) {
    test_seed_list(false, CONNECT, true);
}

static void test_mongos_seeds_reconnect_single(void) {
    test_seed_list(false, RECONNECT, false);
}

static void test_mongos_seeds_reconnect_pooled(void) {
    test_seed_list(false, RECONNECT, true);
}

static void test_recovering(void *ctx) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
...
static void test_server_status(void) {
    mongoc_client_t *client;
    bson_error_t error;
    bson_iter_t iter;
    bson_t reply;
...
static void test_get_database_names(void) {
...
static void _test_mongoc_client_ipv6(bool pooled) {
    char *uri_str;
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool = NULL;
    mongoc_client_t *client;
...
static void test_mongoc_client_ipv6_single(void) {
    _test_mongoc_client_ipv6(false);
}

static void test_mongoc_client_ipv6_pooled(void) {
    _test_mongoc_client_ipv6(true);
}

static void test_mongoc_client_unix_domain_socket(void *context) {
    mongoc_client_t *client;
    bson_error_t error;
    char *uri_str;
...
static void test_mongoc_client_mismatched_me(void) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    mongoc_read_prefs_t *prefs;
...
#ifdef MONGOC_ENABLE_SSL
static void _test_mongoc_client_ssl_opts(bool pooled) {
    char *host_and_port;
    char *uri_str;
    char *uri_str_auth;
...
static void test_ssl_single(void) {
    _test_mongoc_client_ssl_opts(false);
}

static void test_ssl_pooled(void) {
    _test_mongoc_client_ssl_opts(true);
}

static void test_client_buildinfo_hang(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_database_t *database;
    bson_error_t error;
...
static void test_mongoc_client_ssl_disabled(void) {
    capture_logs(true);
...
static void _test_mongoc_client_get_description(bool pooled) {
    mongoc_client_t *client;
    mongoc_client_pool_t *pool = NULL;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
...
static void test_mongoc_client_get_description_single(void) {
    _test_mongoc_client_get_description(false);
}

static void test_mongoc_client_get_description_pooled(void) {
    _test_mongoc_client_get_description(true);
}

static void test_mongoc_client_descriptions_single(void) {
    mongoc_client_t *client;
...
static void test_mongoc_client_descriptions_pooled(void *unused) {
    mongoc_client_t *client;
    mongoc_client_pool_t *pool;
    mongoc_server_description_t **sds;
    size_t n, expected_n;
...
static bool is_standalone_or_rs_primary_or_mongos(const char *server_type) {
...
static bool is_standalone_or_rs_secondary_or_mongos(const char *server_type) {
    BSON_ASSERT_PARAM(server_type);
    // Avoid -Woverlength-strings in ASSERT macros.
...
static bool is_standalone_or_mongos(const char *server_type) {
    BSON_ASSERT_PARAM(server_type);
    // Avoid -Woverlength-strings in ASSERT macros.
    return strcmp(server_type, "Standalone") == 0 || strcmp(server_type, "Mongos") == 0;
}

static void _test_mongoc_client_select_server(bool pooled) {
    mongoc_client_t *client;
    mongoc_client_pool_t *pool = NULL;
    mongoc_server_description_t *sd;
...
static void test_mongoc_client_select_server_single(void) {
    _test_mongoc_client_select_server(false);
}

static void test_mongoc_client_select_server_pooled(void) {
    _test_mongoc_client_select_server(true);
}

static void _test_mongoc_client_select_server_error(bool pooled) {
...
static void test_mongoc_client_select_server_error_single(void) {
    _test_mongoc_client_select_server_error(false);
}

static void test_mongoc_client_select_server_error_pooled(void) {
 ...
 */
static void _test_mongoc_client_select_server_retry(bool retry_succeeds) {
    char *hello;
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
...
static void test_mongoc_client_select_server_retry_succeed(void) {
    _test_mongoc_client_select_server_retry(true);
}

static void test_mongoc_client_select_server_retry_fail(void) {
 ...
 * idle for socketCheckIntervalMS, check it with ping. If it fails, retry once.
 */
static void _test_mongoc_client_fetch_stream_retry(bool retry_succeeds) {
    char *hello;
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
...
static void test_mongoc_client_fetch_stream_retry_succeed(void) {
    _test_mongoc_client_fetch_stream_retry(true);
}

static void test_mongoc_client_fetch_stream_retry_fail(void) {
...
static bool _cmd(mock_server_t *server, mongoc_client_t *client, bool server_replies, bson_error_t *error) {
    future_t *future;
    request_t *request;
    bool r;
...
static void test_ssl_client_single_copies_args(void) {
    test_client_set_ssl_copies_args(false);
}

static void test_ssl_client_pooled_copies_args(void) {
    test_client_set_ssl_copies_args(true);
}

static void _test_ssl_reconnect(bool pooled) {
    mongoc_uri_t *uri;
    mock_server_t *server;
    mongoc_ssl_opt_t client_opts = {0};
    mongoc_ssl_opt_t server_opts = {0};
...
static void test_ssl_reconnect_single(void) {
    _test_ssl_reconnect(false);
}

static void test_ssl_reconnect_pooled(void) {
    _test_ssl_reconnect(true);
}
#endif /* OpenSSL or Secure Transport */

static void test_mongoc_client_application_handshake(void) {
...
static void _assert_hello_valid(request_t *request, bool needs_meta) {
...
static future_t *_force_hello_with_ping(mongoc_client_t *client, int heartbeat_ms) {
    future_t *future;
...
static void _respond_to_ping(future_t *future, mock_server_t *server) {
    request_t *request;
...
static void test_mongoc_handshake_pool(void) {
    mock_server_t *server;
    request_t *request1;
    request_t *request2;
    mongoc_uri_t *uri;
...
static void _test_client_sends_handshake(bool pooled) {
    mock_server_t *server;
    request_t *request;
    mongoc_uri_t *uri;
    future_t *future;
...
static void test_client_sends_handshake_single(void *ctx) {
    BSON_UNUSED(ctx);

    _test_client_sends_handshake(false);
}

static void test_client_sends_handshake_pooled(void) {
    _test_client_sends_handshake(true);
}

static void test_client_appname(bool pooled, bool use_uri) {
    mock_server_t *server;
    request_t *request;
    mongoc_uri_t *uri;
    future_t *future;
...
static void test_client_appname_single_uri(void) {
    test_client_appname(false, true);
}

static void test_client_appname_single_no_uri(void) {
    test_client_appname(false, false);
}

static void test_client_appname_pooled_uri(void) {
    test_client_appname(true, true);
}

static void test_client_appname_pooled_no_uri(void) {
    test_client_appname(true, false);
}

/* test a disconnect with a NULL bson_error_t * passed to command_simple() */
static void _test_null_error_pointer(bool pooled) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool = NULL;
    mongoc_client_t *client;
...
static void test_null_error_pointer_single(void *ctx) {
    BSON_UNUSED(ctx);

    _test_null_error_pointer(false);
}

static void test_null_error_pointer_pooled(void *ctx) {
    BSON_UNUSED(ctx);
...
#ifdef MONGOC_ENABLE_SSL
static void test_set_ssl_opts(void) {
...
static void test_client_reset_sessions(void) {
    bson_error_t error;
    mock_server_t *server;
    mongoc_client_t *client;
...
static void test_client_reset_cursors(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
    mongoc_database_t *database;
...
static bool mongoc_topology_scanner_is_connected(mongoc_topology_scanner_t *scanner) {
...
static void test_client_reset_connections(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_database_t *database;
    mongoc_uri_t *uri;
...
static void test_get_database(void) {
    mongoc_client_t *client;
    mongoc_database_t *database;
    mongoc_write_concern_t *wc;
...
static void test_invalid_server_id(void) {
    mongoc_client_t *client;
    bson_error_t error;
    bool ret;
...
#ifdef MONGOC_ENABLE_SSL
static void test_ssl_opts_override(void) {
...
static void test_ssl_opts_padding_not_null(void) {
    mongoc_client_t *client;
...
static void test_mongoc_client_recv_network_error(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    future_t *future;
    request_t *request;
...
void test_mongoc_client_get_handshake_establishes_connection_single(void) {
    mongoc_client_t *client;
    mongoc_server_description_t *handshake_sd;
    bson_error_t error = {0};
...
void test_mongoc_client_get_handshake_establishes_connection_pooled(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_server_description_t *handshake_sd;
    bson_error_t error = {0};
...
void test_mongoc_client_resends_handshake_on_network_error(void) {
    mongoc_client_t *client;
    mock_server_t *server;
    future_t *future;
    request_t *request;
    ...
    mock_server_replies_simple(
        request,
        tmp_str("{'ok': 1, 'minWireVersion': %d, 'maxWireVersion': %d}", WIRE_VERSION_MIN, WIRE_VERSION_5_1));
    request_destroy(request);
...
void test_client_install(TestSuite *suite) {
