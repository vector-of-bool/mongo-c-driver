...
void reset_basic_sd(mongoc_server_description_t *sd) {
    bson_error_t error;
    bson_t *hello;
 ...
 * addressed. */
static void _test_hostlist(mongoc_server_description_t *sd1,
                           bson_t *sd1_hostlist,
...
void test_server_description_equal(void) {
 ...
 * server type mongos */
void test_server_description_msg_without_isdbgrid(void) {
...
static void test_server_description_ignores_rtt(void) {
    mongoc_server_description_t sd;
    bson_error_t error;
    bson_t hello;
...
static void test_server_description_hello(void) {
    mongoc_server_description_t sd;
    bson_error_t error;
...
static void test_server_description_hello_cmd_not_found(void) {
    mongoc_server_description_t sd;
    bson_error_t error;
    const char *response = "{"
                           "  'ok' : 0,"
...
static void test_server_description_legacy_hello(void) {
    mongoc_server_description_t sd;
    bson_error_t error;
    bson_t hello_response;
...
static void test_server_description_legacy_hello_ok(void) {
    mongoc_server_description_t sd;
    bson_error_t error;
    bson_t hello_response;
...
static void test_server_description_connection_id(void) {
    mongoc_server_description_t sd;
    bson_t *hello;
    bson_error_t error;
...
static void test_server_description_hello_type_error(void) {
    mongoc_server_description_t sd;
    bson_error_t error;
    const char *hello = "{"
                        "  'ok' : { '$numberInt' : '1' },"
...
void test_server_description_install(TestSuite *suite) {
