...
static void compare_write_concern(const mongoc_write_concern_t *wc_correct, const mongoc_write_concern_t *wc) {
...
static void compare_read_concern(const mongoc_read_concern_t *rc_correct, const mongoc_read_concern_t *rc) {
    ASSERT_CMPSTR(rc_correct->level, rc->level);
}

mongoc_write_concern_t *convert_write_concern(const bson_t *wc_doc) {
...
mongoc_read_concern_t *convert_read_concern(const bson_t *rc_doc) {
...
static void test_rw_concern_uri(bson_t *scenario) {
...
static void test_rw_concern_document(bson_t *scenario) {
    bson_iter_t scenario_iter;
    bson_iter_t test_iter;
    bson_t test;
    bool valid;
...
void test_read_write_concern_install(TestSuite *suite) {
