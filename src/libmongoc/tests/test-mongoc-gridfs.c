...
static mongoc_gridfs_t *get_test_gridfs(mongoc_client_t *client, const char *name, bson_error_t *error) {
    char *gen;
    char n[48];
...
bool drop_collections(mongoc_gridfs_t *gridfs, bson_error_t *error) {
...
static void _check_index(mongoc_collection_t *collection, const char *index_json) {
...
static mongoc_gridfs_t *_get_gridfs(mock_server_t *server, mongoc_client_t *client, mongoc_query_flags_t flags) {
    future_t *future;
    bson_error_t error;
    request_t *request;
...
static void _test_create(bson_t *create_index_cmd) {
    mongoc_gridfs_t *gridfs;
...
static void prep_files(mongoc_gridfs_t *gridfs) {
    mongoc_gridfs_file_t *file;
...
static void test_find_with_opts(void) {
    mongoc_gridfs_t *gridfs;
    mongoc_gridfs_file_t *file;
    mongoc_client_t *client;
    bson_error_t error;
    ...
    list = mongoc_gridfs_find_with_opts(gridfs,
...
static void test_find_one_with_opts_limit(void) {
...
static void test_create_from_stream(void) {
    int64_t start;
    int64_t now;
    mongoc_gridfs_t *gridfs;
    mongoc_gridfs_file_t *file;
...
static void _check_chunk_count(mongoc_gridfs_t *gridfs, int64_t len, int64_t chunk_size) {
...
static void _test_write(bool at_boundary) {
...
static void test_write_at_boundary(void) {
...
static void test_long_seek(void *ctx) {
...
static void test_remove_by_filename(void) {
    mongoc_gridfs_t *gridfs;
    mongoc_gridfs_file_t *file;
    mongoc_gridfs_file_opt_t opt = {0};
    mongoc_client_t *client;
...
static void test_missing_chunk(void *ctx) {
    mongoc_client_t *client;
    bson_error_t error;
    mongoc_gridfs_t *gridfs;
    mongoc_gridfs_file_t *file;
...
static void test_inherit_client_config(void) {
    mock_server_t *server;
    mongoc_client_t *client;
...
static void test_find_one_empty(void) {
    mongoc_gridfs_t *gridfs;
    mongoc_client_t *client;
...
void test_gridfs_install(TestSuite *suite) {
