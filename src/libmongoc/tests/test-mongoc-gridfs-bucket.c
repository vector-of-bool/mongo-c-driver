...
static int _get_index_count(mongoc_collection_t *collection) {
...
static void _upload_file_from_str(mongoc_gridfs_bucket_t *bucket,
                                  const char *filename,
                                  const char *content,
                                  const bson_t *opts,
...
void _test_upload_and_download(bson_t *create_index_cmd) {
    mongoc_gridfs_bucket_t *gridfs;
    bson_value_t file_id;
    mongoc_database_t *db;
    mongoc_client_t *client;
...
bool hex_to_bytes(const char *hex_str, size_t *size /* OUT */, uint8_t **bytes /* OUT */) {
    size_t len;
    uint8_t *result;
    size_t i;
...
bson_t *convert_hex_to_binary(bson_t *doc) {
...
void gridfs_spec_run_commands(mongoc_database_t *db, bson_t *commands) {
    bson_iter_t iter;
    bson_t *data;
    bson_t *command;
    bson_t *hex_command;
...
bson_t *gridfs_replace_result(bson_t *doc, bson_value_t *replacement) {
    bson_iter_t iter;
    bson_t *result;
    const char *key;
    bson_t *sub_doc;
...
void gridfs_compare_collections(mongoc_database_t *db) {
    mongoc_collection_t *files;
    mongoc_collection_t *chunks;
    mongoc_collection_t *expected_files;
    mongoc_collection_t *expected_chunks;
...
void gridfs_spec_delete_operation(mongoc_database_t *db, mongoc_gridfs_bucket_t *bucket, bson_t *act, bson_t *assert) {
    bson_iter_t iter;
    bson_t *arguments;
    const bson_value_t *value;
    bool r;
...
void gridfs_spec_download_operation(mongoc_database_t *db,
...
void gridfs_spec_download_by_name_operation(mongoc_database_t *db,
                                            mongoc_gridfs_bucket_t *bucket,
                                            bson_t *act,
                                            bson_t *assert) {
    BSON_UNUSED(db);
...
void gridfs_spec_upload_operation(mongoc_database_t *db, mongoc_gridfs_bucket_t *bucket, bson_t *act, bson_t *assert) {
    bson_iter_t iter;
    bson_t *arguments;
    const char *filename;
    mongoc_stream_t *stream;
...
void run_gridfs_spec_test(mongoc_database_t *db, mongoc_gridfs_bucket_t *bucket, bson_t *test) {
    bson_iter_t iter;
    bson_iter_t inner;
    bson_t *act;
    bson_t *assert;
...
static void test_gridfs_cb(bson_t *scenario) {
    mongoc_gridfs_bucket_t *gridfs;
    mongoc_database_t *db;
    mongoc_client_t *client;
    bson_iter_t iter;
...
static void test_upload_error(void *ctx) {
    mongoc_client_t *client;
    mongoc_uri_t *uri;
    mongoc_database_t *db;
    mongoc_gridfs_bucket_t *gridfs;
...
static void test_find_w_session(void *ctx) {
    mongoc_client_t *client;
    mongoc_database_t *db;
    mongoc_gridfs_bucket_t *gridfs;
    mongoc_cursor_t *cursor;
...
static void test_find(void *ctx) {
...
void test_gridfs_bucket_opts(void) {
    mongoc_client_t *client;
    mongoc_database_t *db;
    mongoc_gridfs_bucket_t *gridfs;
    bson_error_t error;
...
void test_gridfs_bucket_install(TestSuite *suite) {
