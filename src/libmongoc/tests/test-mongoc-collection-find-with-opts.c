...
static void _test_collection_find_command(test_collection_find_with_opts_t *test_data) {
...
static void _test_collection_find_with_opts(test_collection_find_with_opts_t *test_data) {
 ...
 * alongside '$or'
 */
static void test_snapshot_dollar_or(void) {
    test_collection_find_with_opts_t test_data = {0};
...
static void test_op_query_subdoc_named_filter(void) {
    test_collection_find_with_opts_t test_data = {0};
 ...
 * alongside 'filter'
 */
static void test_find_cmd_subdoc_named_filter_with_option(void) {
    test_collection_find_with_opts_t test_data = {0};
...
static void test_int_modifiers(void) {
...
static void test_index_spec_modifiers(void) {
    const char *modifiers[] = {
        "hint",
        "min",
        "max",
...
static void test_singlebatch(void) {
    test_collection_find_with_opts_t test_data = {0};
...
static void test_singlebatch_no_limit(void) {
    test_collection_find_with_opts_t test_data = {0};
...
static void test_getmore_cmd_await(void) {
    bson_t *opts;
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
...
static void test_find_w_server_id(void) {
    mock_rs_t *rs;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *opts;
...
static void test_find_cmd_w_server_id(void) {
    mock_rs_t *rs;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *opts;
...
static void test_find_w_server_id_sharded(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *opts;
...
static void test_find_cmd_w_server_id_sharded(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *opts;
...
static void test_server_id_option(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *q;
    bson_error_t error;
...
void test_collection_find_with_opts_install(TestSuite *suite) {
