...
static void test_aggregate_inherit_database(void) {
...
static void test_create_with_write_concern(void *ctx) {
    mongoc_database_t *database;
...
static void test_has_collection(void) {
    mongoc_collection_t *collection;
    mongoc_database_t *database;
    mongoc_client_t *client;
    bson_error_t error;
...
static void _test_db_command_read_prefs(bool simple, bool pooled) {
    mock_server_t *server;
...
static void test_db_command_simple_read_prefs_single(void) {
    _test_db_command_read_prefs(true, false);
}

static void test_db_command_simple_read_prefs_pooled(void) {
    _test_db_command_read_prefs(true, true);
}

static void test_db_command_read_prefs_single(void) {
    _test_db_command_read_prefs(false, false);
}

static void test_db_command_read_prefs_pooled(void) {
...
static void test_create_collection(void) {
    mongoc_database_t *database;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error = {0};
...
static void test_get_collection_info(void) {
    mongoc_database_t *database;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
...
static void test_get_collection_info_regex(void) {
    mongoc_database_t *database;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
...
static void test_get_collection_info_with_opts_regex(void) {
    mongoc_database_t *database;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
...
static void _test_get_collection_info_getmore(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_database_t *database;
    future_t *future;
...
static void test_get_collection_info_getmore_cmd(void) {
    _test_get_collection_info_getmore();
}

static void test_get_collection(void) {
    mongoc_client_t *client;
    mongoc_database_t *database;
    mongoc_write_concern_t *wc;
    mongoc_read_concern_t *rc;
...
static void test_get_collection_names(void) {
    mongoc_database_t *database;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error = {0};
...
static void test_get_collection_names_error(void) {
    mongoc_database_t *database;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    mock_server_t *server;
...
static void test_get_default_database(void) {
...
void test_database_install(TestSuite *suite) {
