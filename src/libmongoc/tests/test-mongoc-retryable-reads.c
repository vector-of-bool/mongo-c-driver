...
static bool retryable_reads_test_run_operation(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
...
static void test_retryable_reads_cb(bson_t *scenario) {
...
static void _set_failpoint(mongoc_client_t *client) {
    bson_error_t error;
...
static void test_cmd_helpers(void *ctx) {
    mongoc_uri_t *uri;
...
static void test_retry_reads_off(void *ctx) {
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    uint32_t server_id;
...
void test_retryable_reads_install(TestSuite *suite) {
