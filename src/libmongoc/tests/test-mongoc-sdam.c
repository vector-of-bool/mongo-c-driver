 ...
 *-----------------------------------------------------------------------
 */
static void test_sdam_cb(bson_t *test) {
...
static bool sdam_integration_operation_cb(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
    bson_t reply;
    bool res;
 ...
 */
static void deactivate_failpoints_on_all_servers(mongoc_client_t *client) {
    uint32_t server_id;
...
static void run_one_integration_test(json_test_config_t *config, bson_t *test) {
    json_test_ctx_t ctx;
    ...
    if (bson_has_field(test, "outcome.collection")) {
        ...
        outcome_coll = mongoc_client_get_collection(setup_client,
...
static void test_sdam_integration_cb(bson_t *scenario) {
...
static void test_topology_discovery(void *ctx) {
    char *host_and_port;
    char *replset_name;
    char *uri_str;
    char *uri_str_auth;
...
static void test_direct_connection(void *ctx) {
    char *host_and_port;
    char *replset_name;
    char *uri_str;
    char *uri_str_auth;
...
static void test_existing_behavior(void *ctx) {
    char *host_and_port;
    char *replset_name;
    char *uri_str;
    char *uri_str_auth;
...
static void test_prose_rtt(void *unused) {
...
void test_sdam_install(TestSuite *suite) {
