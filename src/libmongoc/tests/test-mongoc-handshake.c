 ...
 */
static void _reset_handshake(void) {
    _mongoc_handshake_cleanup();
    _mongoc_handshake_init();
}

static void test_mongoc_handshake_appname_in_uri(void) {
...
static void test_mongoc_handshake_appname_frozen_single(void) {
...
static void test_mongoc_handshake_appname_frozen_pooled(void) {
...
static void _check_arch_string_valid(const char *arch) {
#ifdef _POSIX_VERSION
...
static void _check_os_version_valid(const char *os_version) {
...
static void test_mongoc_handshake_data_append_success(void) {
...
static void test_mongoc_handshake_data_append_null_args(void) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    mongoc_client_pool_t *pool;
...
static void _test_platform(bool platform_oversized) {
...
static void test_mongoc_handshake_data_append_after_cmd(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
 ...
 */
static void test_mongoc_handshake_too_big(void) {
    mongoc_client_t *client;
    mock_server_t *server;
    mongoc_uri_t *uri;
    future_t *future;
 ...
 */
static void test_mongoc_platform_truncate(int drop) {
    mongoc_handshake_t *md;
    bson_t doc = BSON_INITIALIZER;
    bson_iter_t iter;
    ...
    size_t handshake_remaining_space =
        ...
        - (strlen(md->os_type) + strlen(md->os_name) + strlen(md->os_version) + strlen(md->os_architecture)
           + strlen(md->driver_name) + strlen(md->driver_version) + strlen(md->compiler_info) + strlen(md->flags)
           + handshake_bson_size);
 ...
 * both
 */
static void test_mongoc_oversized_flags(void) {
...
static void test_mongoc_handshake_cannot_send(void) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    mongoc_client_pool_t *pool;
...
extern char *_mongoc_handshake_get_config_hex_string(void);

static bool _get_bit(char *config_str, uint32_t bit) {
...
void test_handshake_platform_config(void) {
...
static void test_mongoc_handshake_race_condition(void) {
    unsigned i, j;
...
void test_handshake_install(TestSuite *suite) {
