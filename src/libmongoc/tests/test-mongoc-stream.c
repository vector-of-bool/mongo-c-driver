...
static void test_buffered_oversized(void) {
    mongoc_stream_t *stream;
    mongoc_stream_t *buffered;
    mongoc_iovec_t iov;
    ssize_t r;
...
void failing_stream_destroy(mongoc_stream_t *stream) {
    bson_free(stream);
}

static mongoc_stream_t *failing_stream_new(ssize_t rval) {
...
static void test_stream_writev_full(void) {
...
void test_stream_install(TestSuite *suite) {
