...
static bool crud_test_operation_cb(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
    bson_t reply;
    bool res;
...
static void prose_test_1(void *ctx) {
...
static void prose_test_2_command_succeeded(const mongoc_apm_command_succeeded_t *event) {
...
static void prose_test_2(void *ctx) {
    mongoc_client_t *client;
    ...
    coll_created = mongoc_database_create_collection(db,
...
void test_crud_install(TestSuite *suite) {
