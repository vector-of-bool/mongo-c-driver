...
static void test_command_name(void) {
    bson_t *commands[] = {
        tmp_bson("{'foo': 1}"),
...
static void test_rand_simple(void) {
    int i;
    unsigned int seed = 0;
...
static void test_lowercase_utf8(void) {
...
static void test_wire_server_versions(void) {
...
void test_util_install(TestSuite *suite) {
