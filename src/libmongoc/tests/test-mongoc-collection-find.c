...
static void _insert_test_docs(mongoc_collection_t *collection, const bson_t *docs) {
    bson_iter_t iter;
    uint32_t len;
    const uint8_t *data;
    bson_t doc;
...
static void _check_cursor(mongoc_cursor_t *cursor, test_collection_find_t *test_data) {
    const bson_t *doc;
...
static void _test_collection_find_live(test_collection_find_t *test_data)
...
static request_t *_check_find_command(mock_server_t *server, test_collection_find_t *test_data) {
    return mock_server_receives_msg(server, MONGOC_MSG_NONE, tmp_bson(test_data->expected_find_command));
}

static void _reply_to_find_command(request_t *request, test_collection_find_t *test_data) {
...
static void _test_collection_find_command(test_collection_find_t *test_data) {
...
static void _test_collection_find(test_collection_find_t *test_data) {
...
static void test_dollar_query(void) {
...
static void test_dollar_or(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void test_mixed_dollar_nondollar(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void test_key_named_filter(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void test_key_named_filter_with_dollar_query(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
    test_data.docs = "[{'_id': 1, 'filter': 1}, {'_id': 2, 'filter': 2}]";
...
/* test 'filter': {'i': 2} */
static void test_subdoc_named_filter(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void test_subdoc_named_filter_with_dollar_query(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
    test_data.docs = "[{'_id': 1, 'filter': {'i': 1}}, {'_id': 2, 'filter': {'i': 2}}]";
...
static void test_newoption(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void _test_int_modifier(const char *mod) {
    char *query;
    char *find_command;
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void test_maxscan(void *ctx) {
    BSON_UNUSED(ctx);

    _test_int_modifier("maxScan");
}

static void test_maxtimems(void) {
...
static void test_returnkey(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
    test_data.docs = "[{'_id': 1}]";
...
static void test_unrecognized_dollar_option(void) {
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void test_query_flags(void) {
    int i;
    char *find_cmd;
    test_collection_find_t test_data = TEST_COLLECTION_FIND_INIT;
...
static void test_getmore_batch_size(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
...
static void test_getmore_invalid_reply(void *ctx) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
...
static void test_getmore_await(void) {
    typedef struct {
        mongoc_query_flags_t flags;
        bool expect_await;
    } await_test_t;
...
static void _test_tailable_timeout(bool pooled) {
...
static void test_tailable_timeout_single(void) {
    _test_tailable_timeout(false);
}

#ifndef MONGOC_ENABLE_SSL_SECURE_TRANSPORT
#ifndef MONGOC_ENABLE_SSL_SECURE_CHANNEL
static void test_tailable_timeout_pooled(void) {
    _test_tailable_timeout(true);
}
#endif
#endif

void test_collection_find_install(TestSuite *suite) {
