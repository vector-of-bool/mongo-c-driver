 ...
 * a distinct command. */
static void _reset_server(json_test_ctx_t *ctx, const char *host_str) {
...
static void _disable_failpoints(json_test_ctx_t *ctx, const char *host_str) {
    mongoc_client_t *client;
    bson_error_t error;
    int i;
    mongoc_uri_t *uri = _mongoc_uri_copy_and_replace_host_list(ctx->test_framework_uri, host_str);
...
static void transactions_test_before_test(json_test_ctx_t *ctx, const bson_t *test) {
...
static void transactions_test_after_test(json_test_ctx_t *ctx, const bson_t *test) {
    bson_iter_t test_iter;
    bool is_multi_mongos;
...
static bool transactions_test_run_operation(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
    ...
    if (bson_has_field(operation, "arguments.callback")) {
        ...
        res = mongoc_client_session_with_transaction(session,
...
static void test_transactions_cb(bson_t *scenario) {
...
static void test_transactions_supported(void *ctx) {
    mongoc_client_t *client;
...
static void test_in_transaction(void *ctx) {
    mongoc_client_t *client;
    mongoc_client_session_t *session;
    mongoc_database_t *db;
    mongoc_collection_t *collection;
...
static bool hangup_except_hello(request_t *request, void *data) {
    BSON_UNUSED(data);
...
static void _test_transient_txn_err(bool hangup) {
...
static void test_server_selection_error(void) {
    _test_transient_txn_err(false /* hangup */);
}

static void test_network_error(void) {
 ...
 */
static void test_unknown_commit_result(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_client_session_t *session;
    mongoc_collection_t *collection;
...
static void test_cursor_primary_read_pref(void *ctx) {
    mongoc_client_t *client;
    mongoc_client_session_t *session;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
...
void test_inherit_from_client(void *ctx) {
    mongoc_client_t *client;
    mongoc_client_session_t *session;
    bson_error_t error;
    mongoc_uri_t *uri;
...
void test_transaction_fails_on_unsupported_version_or_sharded_cluster(void *ctx) {
    bson_error_t error;
    mongoc_client_session_t *session;
    mongoc_client_t *client;
    bool r;
...
static void test_transaction_recovery_token_cleared(void *ctx) {
    bson_error_t error;
    mongoc_client_session_t *session;
    mongoc_client_t *client;
...
static void test_selected_server_is_pinned_to_mongos(void *ctx) {
...
static void test_get_transaction_opts(void) {
    mongoc_uri_t *uri = NULL;
    mongoc_client_t *client = NULL;
    mongoc_client_session_t *session = NULL;
    ...
    BSON_ASSERT(0
                == bson_compare(_mongoc_read_concern_get_bson(actual_txn_opts->read_concern),
                                _mongoc_read_concern_get_bson(expected_txn_opts->read_concern)));

    BSON_ASSERT(0
                == bson_compare(_mongoc_write_concern_get_bson(actual_txn_opts->write_concern),
...
static void test_max_commit_time_ms_is_reset(void *ctx) {
    mock_rs_t *rs;
    mongoc_uri_t *uri = NULL;
    mongoc_client_t *client = NULL;
    mongoc_transaction_opt_t *txn_opts = NULL;
...
void test_transactions_install(TestSuite *suite) {
