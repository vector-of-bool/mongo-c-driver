...
void _test_mongoc_timeout_new_success(int64_t expected) {
...
void _test_mongoc_timeout_new_failure(int64_t try, const char *err_msg) {
    capture_logs(true);
...
void test_mongoc_timeout_new(void) {
...
void _test_mongoc_timeout_set_failure(mongoc_timeout_t *timeout, int64_t try, const char *err_msg) {
    capture_logs(true);
...
void _test_mongoc_timeout_set_success(mongoc_timeout_t *timeout, int64_t expected) {
    BSON_ASSERT(mongoc_timeout_set_timeout_ms(timeout, expected));
    BSON_ASSERT(mongoc_timeout_is_set(timeout));
    BSON_ASSERT(expected == mongoc_timeout_get_timeout_ms(timeout));
}

void test_mongoc_timeout_set(void) {
    mongoc_timeout_t *timeout = NULL;
...
void test_mongoc_timeout_get(void) {
    mongoc_timeout_t *timeout = NULL;
    int64_t expected;
...
void _test_mongoc_timeout_copy(mongoc_timeout_t *expected) {
...
void test_mongoc_timeout_copy(void) {
    mongoc_timeout_t *timeout = NULL;
...
void test_mongoc_timeout_destroy(void) {
    mongoc_timeout_destroy(NULL);
}

void test_timeout_install(TestSuite *suite) {
