...
static mongoc_topology_scanner_node_t *get_node(mongoc_topology_t *topology, const char *host_and_port) {
...
static bool has_server_description(const mongoc_topology_t *topology, const char *host_and_port) {
...
bool selects_server(mongoc_client_t *client, mongoc_read_prefs_t *read_prefs, mock_server_t *server) {
    bson_error_t error;
...
static void _test_topology_reconcile_rs(bool pooled) {
...
static void test_topology_reconcile_rs_single(void) {
    _test_topology_reconcile_rs(false);
}

static void test_topology_reconcile_rs_pooled(void) {
    _test_topology_reconcile_rs(true);
}

static void _test_topology_reconcile_sharded(bool pooled) {
...
static void test_topology_reconcile_sharded_single(void) {
    _test_topology_reconcile_sharded(false);
}

static void test_topology_reconcile_sharded_pooled(void) {
...
static void test_topology_reconcile_from_handshake(void *ctx) {
 ...
 */
static void test_topology_reconcile_retire_single(void) {
    mock_server_t *secondary;
 ...
 */
static void test_topology_reconcile_add_single(void) {
    mock_server_t *secondary;
    mock_server_t *primary;
    char *uri_str;
    mongoc_uri_t *uri;
...
void test_topology_reconcile_install(TestSuite *suite) {
