...
static void server_selection_error_dns(const char *uri_str, const char *errmsg, bool expect_success, bool pooled) {
    mongoc_uri_t *uri;
...
static void test_server_selection_error_dns_direct_single(void) {
...
static void test_server_selection_error_dns_direct_pooled(void *ctx) {
    BSON_UNUSED(ctx);
...
static void test_server_selection_error_dns_multi_fail_single(void) {
...
static void test_server_selection_error_dns_multi_fail_pooled(void *ctx) {
    BSON_UNUSED(ctx);
...
static void _test_server_selection_error_dns_multi_success(bool pooled) {
    char *host;
    char *uri_str;
...
static void test_server_selection_error_dns_multi_success_single(void *context) {
    BSON_UNUSED(context);

    _test_server_selection_error_dns_multi_success(false);
}

static void test_server_selection_error_dns_multi_success_pooled(void *context) {
    BSON_UNUSED(context);

    _test_server_selection_error_dns_multi_success(true);
}

static void _test_server_selection_uds_auth_failure(bool pooled) {
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool = NULL;
    mongoc_client_t *client;
    bson_error_t error;
...
static void test_server_selection_uds_auth_failure_single(void *context) {
    BSON_UNUSED(context);

    _test_server_selection_uds_auth_failure(false);
}

static void test_server_selection_uds_auth_failure_pooled(void *context) {
    BSON_UNUSED(context);

    _test_server_selection_uds_auth_failure(true);
}

static void _test_server_selection_uds_not_found(bool pooled) {
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool = NULL;
    mongoc_client_t *client;
    bson_error_t error;
...
static void test_server_selection_uds_not_found_single(void *context) {
    BSON_UNUSED(context);

    _test_server_selection_uds_not_found(false);
}

static void test_server_selection_uds_not_found_pooled(void *context) {
    BSON_UNUSED(context);

    _test_server_selection_uds_not_found(true);
}

void test_server_selection_errors_install(TestSuite *suite) {
