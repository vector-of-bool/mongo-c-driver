...
static void test_mongoc_client_pool_basic(void) {
...
static void test_mongoc_client_pool_try_pop(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
...
static void test_mongoc_client_pool_pop_timeout(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
    int64_t start;
...
static void test_mongoc_client_pool_min_size_zero(void) {
    mongoc_client_pool_t *pool;
...
static void test_mongoc_client_pool_min_size_dispose(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
...
static void test_mongoc_client_pool_set_max_size(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
...
static void test_mongoc_client_pool_set_min_size(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
    mongoc_array_t conns;
...
static void test_mongoc_client_pool_ssl_disabled(void) {
...
static void test_mongoc_client_pool_handshake(void) {
    mongoc_client_pool_t *pool;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
...
static void test_client_pool_destroy_without_pushing(void) {
    mongoc_client_pool_t *pool;
...
static void command_started_cb(const mongoc_apm_command_started_t *event) {
...
static void test_client_pool_create_unused_session(void *context) {
    mongoc_client_t *client;
    mongoc_client_pool_t *pool;
...
static void test_client_pool_max_pool_size_exceeded(void) {
    mongoc_client_pool_t *pool;
    mongoc_uri_t *uri;
...
void test_client_pool_install(TestSuite *suite) {
