...
static void test_sasl_properties(void) {
    mongoc_uri_t *uri;
    mongoc_cyrus_t sasl;
...
static void test_sasl_canonicalize_hostname(void *ctx) {
    ...
    ss = mongoc_cluster_stream_for_reads(&client->cluster, NULL, NULL, NULL, &error);
...
void test_cyrus_install(TestSuite *suite) {
