...
static void test_loadbalanced_sessions_supported(void *unused) {
...
static void test_loadbalanced_sessions_do_not_expire(void *unused) {
    mongoc_client_t *client;
 ...
 * construction. */
static void test_loadbalanced_client_uri_validation(void *unused) {
    mongoc_client_t *client;
    mongoc_uri_t *uri;
    bson_error_t error;
...
static void test_loadbalanced_connect_single(void *unused) {
    mongoc_client_t *client;
    bson_error_t error;
    bool ok;
...
static void test_loadbalanced_connect_pooled(void *unused) {
...
static void test_loadbalanced_server_selection_establishes_connection_single(void *unused) {
    mongoc_client_t *client;
    bson_error_t error;
    mongoc_server_description_t *monitor_sd;
...
static void test_loadbalanced_cooldown_is_bypassed_single(void *unused) {
    mongoc_client_t *client;
    bson_error_t error;
    bool ok;
    stats_t *stats;
...
static void test_loadbalanced_handshake_sends_loadbalanced(void) {
...
static void test_loadbalanced_handshake_rejects_non_loadbalanced(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_uri_t *uri;
    request_t *request;
...
static void test_pre_handshake_error_does_not_clear_pool(void) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool;
 ...
 * unknown. */
static void test_post_handshake_error_clears_pool(void) {
    mock_server_t *server;
    mongoc_uri_t *uri;
    mongoc_client_pool_t *pool;
...
static int skip_if_not_loadbalanced(void) {
    return test_framework_is_loadbalanced() ? 1 : 0;
}

void test_loadbalanced_install(TestSuite *suite) {
