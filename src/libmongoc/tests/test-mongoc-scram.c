...
static void test_mongoc_scram_step_username_not_set(void) {
...
static void test_iteration_count(int count, bool should_succeed) {
    mongoc_scram_t scram;
    uint8_t buf[4096] = {0};
    uint32_t buflen = 0;
    bson_error_t error;
...
static void test_mongoc_scram_iteration_count(void) {
...
static void test_mongoc_scram_sasl_prep(void) {
...
static void _clear_scram_users(void) {
...
static void _create_scram_users(void) {
...
static void _drop_scram_users(void) {
    mongoc_client_t *client;
...
static void _try_auth_from_uri(bool pooled, mongoc_uri_t *uri, test_error_t expected_error) {
    mongoc_client_pool_t *client_pool = NULL;
    mongoc_client_t *client = NULL;
...
static void _test_mongoc_scram_auth(bool pooled) {
...
static void test_mongoc_scram_auth(void *ctx) {
    BSON_UNUSED(ctx);
...
static int _skip_if_no_sha256(void) {
    mongoc_client_t *client;
    bool res;
    bson_error_t error;
...
static int skip_if_no_icu(void) {
#ifdef MONGOC_ENABLE_ICU
    return true;
#else
    return false;
...
static int skip_if_icu(void) {
    return !skip_if_no_icu();
}

static void _clear_saslprep_users(void) {
    mongoc_client_t *const client = test_framework_new_default_client();
    ASSERT(client);
    mongoc_database_t *const db = mongoc_client_get_database(client, "admin");
    ASSERT(db);
...
static void _create_saslprep_users(void) {
    mongoc_client_t *client;
    bool res;
    bson_error_t error;
    client = test_framework_new_default_client();
...
static void _drop_saslprep_users(void) {
    mongoc_client_t *client;
    mongoc_database_t *db;
    bool res;
    bson_error_t error;
...
static void _make_uri(const char *username, const char *password, mongoc_uri_t **out) {
    char *uri_str;
    char *tmp;
...
static void _test_mongoc_scram_saslprep_auth(bool pooled) {
...
static void test_mongoc_saslprep_auth(void *ctx) {
    BSON_UNUSED(ctx);
...
static void _test_mongoc_scram_saslprep_auth_no_icu(bool pooled) {
    _try_auth(pooled, "IX", "IX", NULL, MONGOC_TEST_NO_ERROR);
...
static void test_mongoc_saslprep_auth_no_icu(void *ctx) {
    BSON_UNUSED(ctx);
...
void test_scram_install(TestSuite *suite) {
#ifdef MONGOC_ENABLE_SSL
