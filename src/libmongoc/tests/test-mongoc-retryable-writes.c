...
static bool retryable_writes_test_run_operation(json_test_ctx_t *ctx, const bson_t *test, const bson_t *operation) {
...
static void test_retryable_writes_cb(bson_t *scenario) {
...
static void test_rs_failover(void) {
    mock_rs_t *rs;
    mongoc_uri_t *uri;
...
static void test_command_with_opts(void *ctx) {
    mongoc_uri_t *uri;
    mongoc_client_t *client;
    uint32_t server_id;
    mongoc_collection_t *collection;
...
static void test_insert_one_unacknowledged(void) {
    mongoc_uri_t *uri;
...
static void test_update_one_unacknowledged(void) {
    mongoc_uri_t *uri;
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_delete_one_unacknowledged(void) {
    mongoc_uri_t *uri;
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_bulk_operation_execute_unacknowledged(void) {
    mongoc_uri_t *uri;
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_remove_unacknowledged(void) {
    mongoc_uri_t *uri;
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_retry_no_crypto(void *ctx) {
    mongoc_uri_t *uri;
    mongoc_client_t *client;
...
static void test_unsupported_storage_engine_error(void) {
    mock_rs_t *rs;
    mongoc_uri_t *uri;
    mongoc_client_t *client;
     ...
     */
    future = future_client_write_command_with_opts(client,
                                                   "test",
...
static void prose_test_3_on_command_success(const mongoc_apm_command_succeeded_t *event) {
    bson_iter_t iter;
    bson_error_t error;
...
static uint32_t set_up_original_error_test(mongoc_apm_callbacks_t *callbacks,
...
static void cleanup_original_error_test(mongoc_client_t *client,
                                        uint32_t server_id,
                                        bson_t *reply,
                                        mongoc_collection_t *coll,
...
static void retryable_writes_prose_test_3(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bson_t reply;
...
static void retryable_writes_original_error_find_modify(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bson_t reply;
    bson_error_t error = {0};
...
static void retryable_writes_original_error_general_command(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bson_t reply;
    bson_error_t error = {0};
...
static void _tracks_new_server_cb(const mongoc_apm_command_started_t *event) {
    const char *cmd_name;
 ...
 * secondary.
 */
static void test_bulk_retry_tracks_new_server(void *unused) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t error;
...
void test_retryable_writes_install(TestSuite *suite) {
