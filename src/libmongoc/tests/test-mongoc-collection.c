...
static void test_aggregate_w_write_concern(void *ctx) {
...
static void test_aggregate_inherit_collection(void) {
...
static void _batch_size_test(bson_t *pipeline, bson_t *batch_size, bool use_batch_size, int size) {
...
static void test_aggregate_with_batch_size(void) {
...
static void test_read_prefs_is_valid(void *ctx) {
    mongoc_collection_t *collection;
    ...
    ASSERT(
        mongoc_collection_count_with_opts(collection, MONGOC_QUERY_NONE, tmp_bson("{}"), 0, 0, NULL, read_prefs, &error)
        == -1);
...
static void test_insert_null(void) {
    mongoc_collection_t *collection;
...
static void test_insert_oversize(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
...
static void test_insert_bulk_empty(void) {
    mongoc_collection_t *collection;
    mongoc_database_t *database;
    mongoc_client_t *client;
    bson_error_t error;
...
bson_t *make_document(size_t bytes) {
    bson_t *bson;
    bson_oid_t oid;
    char *s;
    size_t string_len;
...
void make_bulk_insert(bson_t **bsons, int n, size_t bytes) {
    int i;
...
static void test_insert_command_keys(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
...
static void test_decimal128(void *ctx) {
    mongoc_collection_t *collection;
    mongoc_database_t *database;
    mongoc_write_concern_t *wr;
    bson_t opts = BSON_INITIALIZER;
...
static void test_update_pipeline(void *ctx) {
    mongoc_collection_t *collection;
    mongoc_database_t *database;
    mongoc_client_t *client;
    bson_error_t error;
...
static void test_update_oversize(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
...
static void test_insert_w0(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_write_concern_t *wc;
    bson_t opts = BSON_INITIALIZER;
...
static void test_update_w0(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_write_concern_t *wc;
    bson_error_t error;
...
static void test_remove_w0(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_write_concern_t *wc;
    bson_t opts = BSON_INITIALIZER;
...
static void test_insert_twice_w0(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_write_concern_t *wc;
    bson_t opts = BSON_INITIALIZER;
...
static void test_index_w_write_concern(void) {
    mongoc_collection_t *collection;
    mongoc_database_t *database;
    mongoc_client_t *client;
    mongoc_index_opt_t opt;
...
static void test_index_compound(void) {
    mongoc_collection_t *collection;
    mongoc_database_t *database;
    mongoc_client_t *client;
    mongoc_index_opt_t opt;
...
static void test_index_geo(void *unused) {
...
static char *storage_engine(mongoc_client_t *client) {
    bson_iter_t iter;
    bson_error_t error;
...
static void test_index_storage(void) {
...
static void test_count_read_pref(void) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_count_read_concern(void) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mongoc_read_concern_t *rc;
    mock_server_t *server;
...
static void test_count_read_concern_live(void *unused) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mongoc_read_concern_t *rc;
    bson_error_t error;
...
int skip_unless_server_has_decimal128(void) {
...
int mongod_supports_majority_read_concern(void) {
    if (!TestSuite_CheckLive()) {
        return 0;
    }
...
static void test_count_with_opts(void) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    future_t *future;
...
static void test_count_with_collation(void) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    future_t *future;
...
static void test_count_documents(void) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    future_t *future;
...
static void test_count_documents_live(void) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
    int64_t count;
...
static void test_estimated_document_count(void) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    future_t *future;
    ...
    future = future_collection_estimated_document_count(collection,
                                                        tmp_bson("{'limit': 2, 'skip': 1}"),
                                                        NULL,
                                                        &reply,
                                                        &error);
...
static void test_estimated_document_count_live(void) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
    int64_t count;
...
static void test_aggregate_bypass(void *context) {
...
static void test_aggregate_large(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_iter_t iter;
...
static const char *options_json(test_aggregate_context_t *c) {
...
static void test_aggregate_modern(void *data) {
...
static void test_aggregate_w_server_id(void) {
    mock_rs_t *rs;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *opts;
...
static void test_aggregate_w_server_id_sharded(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
...
static void test_aggregate_server_id_option(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *q;
    bson_error_t error;
...
static void test_validate(void *ctx) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_iter_t iter;
    bson_error_t error;
...
static void test_stats_read_pref(void) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mongoc_read_prefs_t *prefs;
...
static void test_find_and_modify_write_concern(void) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mock_server_t *server;
    request_t *request;
...
static void test_find_and_modify(void) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
    bson_iter_t iter;
...
static void test_large_return(void *ctx) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
    bson_error_t error;
...
static void test_many_return(void) {
    enum { N_BSONS = 5000 };
...
static bool insert_one(mongoc_collection_t *collection, const bson_t *doc, const bson_t *opts, bson_error_t *error) {
    return mongoc_collection_insert_one(collection, doc, opts, NULL, error);
}

static bool insert_many(mongoc_collection_t *collection, const bson_t *doc, const bson_t *opts, bson_error_t *error) {
...
static void _test_insert_validate(insert_fn_t insert_fn) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
...
static void test_insert_bulk_validate(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
...
static void test_insert_one_validate(void) {
    _test_insert_validate(insert_one);
}

static void test_insert_many_validate(void) {
    _test_insert_validate(insert_many);
}

/* use a mock server to test the "limit" parameter */
static void test_find_limit(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
...
static void test_find_batch_size(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
...
static void test_command_fq(void *context) {
    mongoc_client_t *client;
    mongoc_cursor_t *cursor;
    const bson_t *doc = NULL;
    bson_iter_t iter;
...
static void test_get_index_info(void) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_find_indexes_err(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    future_t *future;
...
static void test_aggregate_install(TestSuite *suite) {
...
static void test_find_read_concern(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_read_concern_t *rc;
    mongoc_collection_t *collection;
...
static void test_getmore_read_concern_live(void *ctx) {
    mongoc_client_t *client;
    mongoc_read_concern_t *rc;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
...
static void test_aggregate_secondary(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
...
static void test_aggregate_secondary_sharded(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_read_prefs_t *pref;
...
static void test_aggregate_read_concern(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_read_concern_t *rc;
...
static void test_aggregate_with_collation(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    future_t *future;
...
static void test_index_with_collation(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    request_t *request;
...
static void test_create_index_fail(void *context) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bool r;
    bson_t reply;
...
static void _test_no_docs_match(mongoc_collection_t *coll, const char *selector) {
    bson_error_t error;
    int64_t ret;
...
void _test_crud_command_start(const mongoc_apm_command_started_t *event) {
...
typedef bool (
    *update_fn_t)(mongoc_collection_t *, const bson_t *, const bson_t *, const bson_t *, bson_t *, bson_error_t *);

/* Tests `update_one`, `update_many`, and `replace_one` */
static void _test_update_and_replace(bool is_replace, bool is_multi) {
    update_fn_t fn = NULL;
    bson_t *update = NULL;
    bson_error_t err = {0};
    bson_t reply;
...
static void test_update_and_replace(void) {
...
static void test_array_filters_validate(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
    bool r;
...
static void _test_update_validate(update_fn_t update_fn) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *selector;
...
static void test_replace_one_validate(void) {
    _test_update_validate(mongoc_collection_replace_one);
}

static void test_update_one_validate(void) {
    _test_update_validate(mongoc_collection_update_one);
}

static void test_update_many_validate(void) {
...
static void _test_delete_one_or_many(bool is_multi) {
...
typedef future_t *(
    *future_delete_fn_t)(mongoc_collection_t *, const bson_t *, const bson_t *, bson_t *, bson_error_t *);

static void _test_delete_collation(bool is_multi) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    future_t *future;
...
static void test_delete_one_or_many(void) {
    _test_delete_one_or_many(true);
    _test_delete_one_or_many(false);
}

static void test_delete_collation(void) {
...
static void _test_update_or_replace_with_collation(bool is_replace, bool is_multi) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    future_t *future;
...
static void test_update_collation(void) {
...
static void _test_update_hint(bool is_replace, bool is_multi, const char *hint) {
    mock_server_t *server;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    future_t *future;
...
static void test_update_hint(void) {
...
static void test_update_multi(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
    unsigned i;
...
static void test_update_upsert(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
...
static void test_remove_multi(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
    unsigned i;
    ...
    ASSERT_OR_PRINT(
        mongoc_collection_delete(collection, MONGOC_DELETE_NONE, tmp_bson("{'_id': {'$lt': 2}}"), NULL, &error),
        error);
...
static void test_fam_no_error_on_retry(void *unused) {
    mongoc_client_t *client;
    mongoc_collection_t *coll;
    bson_error_t error = {0};
    bool ret;
...
void test_collection_install(TestSuite *suite) {
