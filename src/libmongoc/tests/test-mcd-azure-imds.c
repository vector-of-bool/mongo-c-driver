...
static void _test_oauth_parse(void) {
...
static void _test_http_req(void) {
...
static const char *_get_test_imds_host(void) {
...
void test_mcd_azure_imds_install(TestSuite *suite) {
