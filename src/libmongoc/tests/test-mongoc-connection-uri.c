 ...
 * embedded documents.
 */
static void bson_contains_iter(const bson_t *haystack, bson_iter_t *needle) {
    bson_iter_t iter;
    uint32_t bson_type;
...
static void test_connection_uri_cb(bson_t *scenario) {
    bson_iter_t iter;
...
void test_connection_uri_install(TestSuite *suite) {
