...
static void _assert_options_match(const bson_t *test, mongoc_uri_t *uri) {
    match_ctx_t ctx = {{0}};
    bson_iter_t iter;
...
static bool host_list_contains(const mongoc_host_list_t *hl, const char *host_and_port) {
    while (hl) {
...
static int64_t hosts_count(const bson_t *test) {
    bson_iter_t iter;
    bson_iter_t hosts;
    int64_t c = 0;
...
static bool _host_list_matches(const bson_t *test, context_t *ctx) {
    bson_iter_t iter;
    bson_iter_t hosts;
...
static bool is_test_skipped(const char *uri_str) {
...
static void _test_dns_maybe_pooled(bson_t *test, bool pooled) {
    context_t ctx;
    bool expect_ssl;
    bool expect_error;
    mongoc_uri_t *uri;
...
extern bool mongoc_topology_apply_scanned_srv_hosts(mongoc_uri_t *uri,
                                                    mongoc_topology_description_t *td,
                                                    mongoc_host_list_t *hosts,
                                                    bson_error_t *error);

static mongoc_host_list_t *make_hosts(char *first_host, ...) {
    va_list va;
...
static void dump_hosts(mongoc_host_list_t *hosts) {
    mongoc_host_list_t *host;
...
static void dump_topology_description(const mongoc_topology_description_t *td) {
...
static void check_topology_description(mongoc_topology_description_t *td, mongoc_host_list_t *hosts) {
    size_t nhosts = 0u;
    mongoc_host_list_t *host;
    const mongoc_set_t *servers = mc_tpld_servers_const(td);
...
static void test_srv_polling_mocked(void *unused) {
    mongoc_uri_t *uri;
    mongoc_topology_description_t td;
    bson_error_t error;
    mongoc_host_list_t *hosts;
...
static void test_small_initial_buffer(void *unused) {
...
bool _mock_rr_resolver_prose_test_9(const char *service,
...
static void _prose_test_ping(mongoc_client_t *client) {
    bson_error_t error;
...
static void *_prose_test_init_resource_single(const mongoc_uri_t *uri, _mongoc_rr_resolver_fn fn) {
    mongoc_client_t *client;
...
static void *_prose_test_init_resource_pooled(const mongoc_uri_t *uri, _mongoc_rr_resolver_fn fn) {
...
static void _prose_test_free_resource_single(void *resource) {
    mongoc_client_destroy((mongoc_client_t *)resource);
}

static void _prose_test_free_resource_pooled(void *resource) {
    mongoc_client_pool_destroy((mongoc_client_pool_t *)resource);
}

static mongoc_client_t *_prose_test_get_client_single(void *resource) {
    BSON_ASSERT_PARAM(resource);
    return (mongoc_client_t *)resource;
}

static mongoc_client_t *_prose_test_get_client_pooled(void *resource) {
    BSON_ASSERT_PARAM(resource);
    return mongoc_client_pool_pop(((mongoc_client_pool_t *)resource));
}

static void _prose_test_release_client_single(void *resource, mongoc_client_t *client) {
    BSON_ASSERT_PARAM(resource);
    BSON_ASSERT_PARAM(client);
    /* Nothing to do. */
}

static void _prose_test_release_client_pooled(void *resource, mongoc_client_t *client) {
    BSON_ASSERT_PARAM(resource);
    BSON_ASSERT_PARAM(client);
    mongoc_client_pool_push((mongoc_client_pool_t *)resource, client);
}

static void _prose_test_update_srv_single(void *resource) {
    mongoc_client_t *client;
...
static void _prose_test_update_srv_pooled(void *resource) {
    BSON_ASSERT_PARAM(resource);
...
static void _prose_test_9(const _prose_test_fns_t *fns) {
    void *resource;
...
static void prose_test_9_single(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_9(&_prose_test_single_fns);
}

static void prose_test_9_pooled(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_9(&_prose_test_pooled_fns);
}

static bool _mock_rr_resolver_prose_test_10(const char *service,
                                            mongoc_rr_type_t rr_type,
                                            mongoc_rr_data_t *rr_data,
                                            size_t initial_buffer_size,
                                            bson_error_t *error) {
...
static void _prose_test_10(const _prose_test_fns_t *fns) {
    void *resource;
...
static void prose_test_10_single(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_10(&_prose_test_single_fns);
}

static void prose_test_10_pooled(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_10(&_prose_test_pooled_fns);
}

static bool _mock_rr_resolver_prose_test_11(const char *service,
                                            mongoc_rr_type_t rr_type,
                                            mongoc_rr_data_t *rr_data,
                                            size_t initial_buffer_size,
                                            bson_error_t *error) {
...
static void _prose_test_11(const _prose_test_fns_t *fns) {
    void *resource;
...
static void prose_test_11_single(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_11(&_prose_test_single_fns);
}

static void prose_test_11_pooled(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_11(&_prose_test_pooled_fns);
}

static bool _mock_rr_resolver_prose_test_12(const char *service,
                                            mongoc_rr_type_t rr_type,
                                            mongoc_rr_data_t *rr_data,
                                            size_t initial_buffer_size,
                                            bson_error_t *error) {
...
static bool _prose_test_12_cb(const void *sd_void, void *ctx_void) {
    const mongoc_server_description_t *sd;
...
static void _prose_test_12(const _prose_test_fns_t *fns) {
    void *resource;
...
static void prose_test_12_single(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_12(&_prose_test_single_fns);
}

static void prose_test_12_pooled(void *unused) {
    BSON_UNUSED(unused);

    _prose_test_12(&_prose_test_pooled_fns);
}

void test_dns_install(TestSuite *suite) {
