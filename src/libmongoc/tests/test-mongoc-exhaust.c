...
static uint32_t get_generation(mongoc_client_t *client, mongoc_cursor_t *cursor) {
    uint32_t server_id;
    uint32_t generation;
...
static uint32_t get_connection_count(mongoc_client_t *client) {
    bson_error_t error;
...
static void test_exhaust_cursor(bool pooled) {
    ...
    /* bulk insert some records to work on */
    {
        ...
        ASSERT_OR_PRINT(
            mongoc_collection_insert_bulk(collection, MONGOC_INSERT_NONE, (const bson_t **)bptr, 10, wr, &error),
            error);
...
static void test_exhaust_cursor_single(void *context) {
    BSON_UNUSED(context);

    test_exhaust_cursor(false);
}

static void test_exhaust_cursor_pool(void *context) {
    BSON_UNUSED(context);

    test_exhaust_cursor(true);
}

static void test_exhaust_cursor_fallback(void *unused) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
    mongoc_cursor_t *cursor;
...
static void test_exhaust_cursor_multi_batch(void *context) {
    mongoc_client_t *client;
    bson_error_t error;
    mongoc_collection_t *collection;
...
static void test_cursor_set_max_await_time_ms(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_cursor_t *cursor;
    const bson_t *bson;
...
static void _request_error(request_t *request, exhaust_error_type_t error_type) {
...
static void _check_error(mongoc_client_t *client, mongoc_cursor_t *cursor, exhaust_error_type_t error_type) {
    uint32_t server_id;
    bson_error_t error;
...
static void _mock_test_exhaust(bool pooled, exhaust_error_when_t error_when, exhaust_error_type_t error_type) {
...
static void test_exhaust_network_err_1st_batch_single(void) {
    _mock_test_exhaust(false, FIRST_BATCH, NETWORK_ERROR);
}

static void test_exhaust_network_err_1st_batch_pooled(void) {
    _mock_test_exhaust(true, FIRST_BATCH, NETWORK_ERROR);
}

static void test_exhaust_server_err_1st_batch_single(void) {
    _mock_test_exhaust(false, FIRST_BATCH, SERVER_ERROR);
}

static void test_exhaust_server_err_1st_batch_pooled(void) {
    _mock_test_exhaust(true, FIRST_BATCH, SERVER_ERROR);
}

static void test_exhaust_network_err_2nd_batch_single(void) {
    _mock_test_exhaust(false, SECOND_BATCH, NETWORK_ERROR);
}

static void test_exhaust_network_err_2nd_batch_pooled(void) {
    _mock_test_exhaust(true, SECOND_BATCH, NETWORK_ERROR);
}

static void test_exhaust_server_err_2nd_batch_single(void) {
    _mock_test_exhaust(false, SECOND_BATCH, SERVER_ERROR);
}

static void test_exhaust_server_err_2nd_batch_pooled(void) {
 ...
 * exhaust. */
static void test_exhaust_in_child(void) {
    mongoc_client_t *client;
...
void test_exhaust_install(TestSuite *suite) {
