 ...
 * WIRE_VERSION_DELETE_HINT. */
static void run_delete_with_hint_and_wc0(bool expect_error, mongoc_client_t *client, mock_server_t *server) {
 ...
 * description). */
static void test_server_stream_ties_server_description_pooled(void *unused) {
 ...
 * checking wire version (instead of the server description from the topology
 * description). */
static void test_server_stream_ties_server_description_single(void *unused) {
...
void test_server_stream_install(TestSuite *suite) {
