...
static const char *parser_type_to_string(bson_parser_type_t ptype) {
    switch (ptype) {
    case BSON_PARSER_UTF8: return "UTF8";
    case BSON_PARSER_INT: return "INT";
    case BSON_PARSER_BOOL: return "BOOL";
    case BSON_PARSER_DOC: return "DOC";
    case BSON_PARSER_ARRAY: return "ARRAY";
    case BSON_PARSER_ARRAY_OR_DOC: return "ARRAY or DOC";
    case BSON_PARSER_ANY: return "ANY";
    case BSON_PARSER_WRITE_CONCERN: return "WRITE_CONCERN";
    case BSON_PARSER_READ_CONCERN: return "READ_CONCERN";
    case BSON_PARSER_READ_PREFS: return "READ_PREFS";
    default: return "INVALID";
    }
    return "INVALID";
}

static mongoc_write_concern_t *bson_to_write_concern(bson_t *bson, bson_error_t *error) {
...
static mongoc_read_concern_t *bson_to_read_concern(bson_t *bson, bson_error_t *error) {
    bson_parser_t *parser = NULL;
...
static mongoc_read_prefs_t *bson_to_read_prefs(bson_t *bson, bson_error_t *error) {
    bson_parser_t *parser = NULL;
...
bson_parser_t *bson_parser_new(void) {
    bson_parser_t *parser = NULL;
...
void bson_parser_allow_extra(bson_parser_t *parser, bool val) {
    BSON_ASSERT(parser);
    parser->allow_extra = val;
}

const bson_t *bson_parser_get_extra(const bson_parser_t *parser) {
    BSON_ASSERT(parser);
    return parser->extra;
}

static void bson_parser_entry_destroy(bson_parser_entry_t *entry, bool with_parsed_fields) {
...
static void bson_parser_destroy_helper(bson_parser_t *parser, bool with_parsed_fields) {
...
void bson_parser_destroy(bson_parser_t *parser) {
    bson_parser_destroy_helper(parser, false);
}

/* This additionally destroys the destination of each parsed field. */
void bson_parser_destroy_with_parsed_fields(bson_parser_t *parser) {
...
void bson_parser_utf8(bson_parser_t *parser, const char *key, char **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_UTF8, false);
}

void bson_parser_utf8_optional(bson_parser_t *parser, const char *key, char **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_UTF8, true);
}

void bson_parser_doc(bson_parser_t *parser, const char *key, bson_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_DOC, false);
}

void bson_parser_doc_optional(bson_parser_t *parser, const char *key, bson_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_DOC, true);
}

void bson_parser_array(bson_parser_t *parser, const char *key, bson_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_ARRAY, false);
}

void bson_parser_array_optional(bson_parser_t *parser, const char *key, bson_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_ARRAY, true);
}

void bson_parser_array_or_doc(bson_parser_t *parser, const char *key, bson_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_ARRAY_OR_DOC, false);
}

void bson_parser_array_or_doc_optional(bson_parser_t *parser, const char *key, bson_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_ARRAY_OR_DOC, true);
}

void bson_parser_bool(bson_parser_t *parser, const char *key, bool **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_BOOL, false);
}

void bson_parser_bool_optional(bson_parser_t *parser, const char *key, bool **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_BOOL, true);
}

void bson_parser_int(bson_parser_t *parser, const char *key, int64_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_INT, false);
}

void bson_parser_int_optional(bson_parser_t *parser, const char *key, int64_t **out) {
    *out = NULL;
    bson_parser_add_entry(parser, key, (void *)out, BSON_PARSER_INT, true);
}

void bson_parser_any(bson_parser_t *bp, const char *key, bson_val_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, key, (void *)out, BSON_PARSER_ANY, false);
}

void bson_parser_any_optional(bson_parser_t *bp, const char *key, bson_val_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, key, (void *)out, BSON_PARSER_ANY, true);
}

void bson_parser_write_concern(bson_parser_t *bp, mongoc_write_concern_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, "writeConcern", (void *)out, BSON_PARSER_WRITE_CONCERN, false);
}

void bson_parser_write_concern_optional(bson_parser_t *bp, mongoc_write_concern_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, "writeConcern", (void *)out, BSON_PARSER_WRITE_CONCERN, true);
}

void bson_parser_read_concern(bson_parser_t *bp, mongoc_read_concern_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, "readConcern", (void *)out, BSON_PARSER_READ_CONCERN, false);
}

void bson_parser_read_concern_optional(bson_parser_t *bp, mongoc_read_concern_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, "readConcern", (void *)out, BSON_PARSER_READ_CONCERN, true);
}

void bson_parser_read_prefs(bson_parser_t *bp, mongoc_read_prefs_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, "readPreference", (void *)out, BSON_PARSER_READ_PREFS, false);
}

void bson_parser_read_prefs_optional(bson_parser_t *bp, mongoc_read_prefs_t **out) {
    *out = NULL;
    bson_parser_add_entry(bp, "readPreference", (void *)out, BSON_PARSER_READ_PREFS, true);
}

void marshal_error(const char *key, bson_type_t btype, bson_parser_type_t ptype, bson_error_t *error) {
...
bool entry_marshal(bson_parser_entry_t *entry, bson_iter_t *iter, bson_error_t *error) {
    bool ret = false;
    const char *key;
    bson_type_t btype;
    bson_parser_type_t ptype;
...
bool bson_parser_parse(bson_parser_t *parser, bson_t *in, bson_error_t *error) {
    bson_iter_t iter;
...
void bson_parser_parse_or_assert(bson_parser_t *parser, bson_t *in) {
    bson_error_t error;
