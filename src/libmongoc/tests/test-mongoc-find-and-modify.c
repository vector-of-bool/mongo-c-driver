...
static void auto_hello(mock_server_t *server,
...
static void test_find_and_modify_bypass(bool bypass) {
...
static void test_find_and_modify_bypass_true(void) {
    test_find_and_modify_bypass(true);
}

static void test_find_and_modify_bypass_false(void) {
...
static void test_find_and_modify_write_concern_failure(void *context) {
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
    mongoc_find_and_modify_opts_t *opts;
...
static void test_find_and_modify_opts(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
...
static void test_find_and_modify_opts_write_concern(void) {
...
static void test_find_and_modify_collation(void) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_error_t error;
...
static void test_find_and_modify_hint(void) {
    mongoc_client_t *client;
...
void test_find_and_modify_install(TestSuite *suite) {
