...
static void _test_mongoc_socket_check_closed(int32_t server_sleep_ms) {
...
static void test_mongoc_socket_check_closed(void) {
    _test_mongoc_socket_check_closed(0);
}

static void test_mongoc_socket_timed_out(void *ctx) {
    BSON_UNUSED(ctx);

    _test_mongoc_socket_check_closed(1000);
}

static void test_mongoc_socket_sendv(void *ctx) {
    socket_test_data_t data = {0};
    bson_thread_t threads[2];
    int i, r;
...
static void test_mongoc_socket_poll_refusal(void *ctx) {
...
void test_socket_install(TestSuite *suite) {
