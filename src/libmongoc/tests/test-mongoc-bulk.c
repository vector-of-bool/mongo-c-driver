...
static void assert_write_error_count(int len, const bson_t *reply) {
    bson_iter_t iter;
...
static void assert_n_inserted(int n, const bson_t *reply) {
    bson_iter_t iter;
...
static bool oid_created_on_client(const bson_t *doc) {
    bson_oid_t new_oid;
...
static void create_unique_index(mongoc_collection_t *collection) {
...
static void _test_opt(const char *opts_json, const char *msg) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
...
static void test_bulk_error(void) {
    bson_t reply = {0};
    bson_error_t error;
    mongoc_bulk_operation_t *bulk;
...
static void test_bulk_error_unordered(void) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    ...
    for (i = 0; i <= 2048; i++) {
        mongoc_bulk_operation_update_many_with_opts(bulk,
...
static void test_insert(bool ordered) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
...
static void test_insert_ordered(void) {
    test_insert(true);
}

static void test_insert_unordered(void) {
    test_insert(false);
}

static void test_insert_check_keys(void) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_t reply;
...
static void test_upsert(bool ordered) {
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_upsert_ordered(void) {
    test_upsert(true);
}

static void test_upsert_unordered(void) {
    test_upsert(false);
}

static void test_upsert_unordered_oversized(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void test_upserted_index(bool ordered) {
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_upserted_index_ordered(void) {
    test_upserted_index(true);
}

static void test_upserted_index_unordered(void) {
    test_upserted_index(false);
}

static void test_update_one(bool ordered) {
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_update_one_ordered(void) {
    test_update_one(true);
}

static void test_update_one_unordered(void) {
    test_update_one(false);
}

static void test_update_with_opts_validate(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t error;
...
static void test_update_arrayfilters(void *ctx) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
    ...
    for (i = 1; i < 4; i++) {
        ret = mongoc_bulk_operation_insert_with_opts(bulk,
...
static void test_update_hint_validate(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t err;
...
static void test_delete_hint_validate(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t err;
...
static void test_replace_one(bool ordered) {
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void _test_replace_one_check_keys(bool with_opts) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_replace_one_check_keys(void) {
    _test_replace_one_check_keys(false);
}

static void test_replace_one_with_opts_check_keys(void) {
    _test_replace_one_check_keys(true);
}

static void test_replace_one_with_opts_validate(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t error;
    ...
    BSON_ASSERT(!mongoc_bulk_operation_replace_one_with_opts(bulk,
                                                             tmp_bson("{}"),
                                                             tmp_bson("{'a.a': 1}"),
                                                             tmp_bson("{'validate': %d}", BSON_VALIDATE_DOT_KEYS),
                                                             &error));
 ...
 * CDRIVER-1082
 */
static void test_upsert_large(void *ctx) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_upsert_huge(void *ctx) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_replace_one_ordered(void) {
    test_replace_one(true);
}

static void test_replace_one_unordered(void) {
    test_replace_one(false);
}

static void test_update(bool ordered) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
...
static void test_update_ordered(void) {
    test_update(true);
}

static void test_update_unordered(void) {
    test_update(false);
}

/* update document has key that doesn't start with "$" */
static void _test_update_check_keys(bool many, bool with_opts) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_t *q = tmp_bson("{}");
...
static void test_update_one_check_keys(void) {
    _test_update_check_keys(false, false);
}

static void test_update_check_keys(void) {
    _test_update_check_keys(true, false);
}

static void test_update_one_with_opts_check_keys(void) {
    _test_update_check_keys(false, true);
}

static void test_update_many_with_opts_check_keys(void) {
...
static void _test_update_validate(update_validate_test_t *test) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_t *q = tmp_bson("{}");
...
static void _test_update_one_invalid(bool first) {
...
static void _test_update_invalid(bool first) {
    update_validate_test_t test = {0};
    test.bad_update_json = "{'a': 1}";
    test.good_update_json = "{'$set': {'x': 1}}";
...
static void _test_update_one_with_opts_invalid(bool first) {
    update_validate_test_t test = {0};
    test.bad_update_json = "{'a': 1}";
    test.good_update_json = "{'$set': {'x': 1}}";
    test.update = NULL;
...
static void _test_update_many_with_opts_invalid(bool first) {
    update_validate_test_t test = {0};
    test.bad_update_json = "{'a': 1}";
    test.good_update_json = "{'$set': {'x': 1}}";
    test.update = NULL;
...
static void _test_replace_one_invalid(bool first) {
    update_validate_test_t test = {0};
...
static void _test_replace_one_with_opts_invalid(bool first) {
    update_validate_test_t test = {0};
    test.bad_update_json = "{'$set': {'x': 1}}";
    test.good_update_json = "{'a': 1}";
    test.update = NULL;
...
static void test_update_one_invalid_first(void) {
    _test_update_one_invalid(true /* invalid first */);
}

static void test_update_invalid_first(void) {
    _test_update_invalid(true /* invalid first */);
}

static void test_update_one_with_opts_invalid_first(void) {
    _test_update_one_with_opts_invalid(true /* invalid first */);
}

static void test_update_many_with_opts_invalid_first(void) {
    _test_update_many_with_opts_invalid(true /* invalid first */);
}

static void test_replace_one_invalid_first(void) {
    _test_replace_one_invalid(true /* invalid first */);
}

static void test_replace_one_with_opts_invalid_first(void) {
    _test_replace_one_with_opts_invalid(true /* invalid first */);
}

static void test_update_one_invalid_second(void) {
    _test_update_one_invalid(false /* invalid first */);
}

static void test_update_invalid_second(void) {
    _test_update_invalid(false /* invalid first */);
}

static void test_update_one_with_opts_invalid_second(void) {
    _test_update_one_with_opts_invalid(false /* invalid first */);
}

static void test_update_many_with_opts_invalid_second(void) {
    _test_update_many_with_opts_invalid(false /* invalid first */);
}

static void test_replace_one_invalid_second(void) {
    _test_replace_one_invalid(false /* invalid first */);
}

static void test_replace_one_with_opts_invalid_second(void) {
    _test_replace_one_with_opts_invalid(false /* invalid first */);
}

static void _test_insert_invalid(bool with_opts, bool invalid_first) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
...
static void test_insert_invalid_first(void) {
    _test_insert_invalid(true, false);
}

static void test_insert_invalid_second(void) {
    _test_insert_invalid(false, false);
}

static void test_insert_with_opts_invalid_first(void) {
    _test_insert_invalid(true, true);
}

static void test_insert_with_opts_invalid_second(void) {
    _test_insert_invalid(false, true);
}

static void test_insert_with_opts_validate(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t error;
    ...
    ASSERT_OR_PRINT(mongoc_bulk_operation_insert_with_opts(bulk,
                                                           tmp_bson("{'': 1}"),
                                                           tmp_bson("{'validate': %d}", BSON_VALIDATE_NONE),
                                                           &error),
                    error);
    ...
    bulk = mongoc_collection_create_bulk_operation_with_opts(collection, NULL);
    BSON_ASSERT(mongoc_bulk_operation_insert_with_opts(bulk,
                                                       tmp_bson("{'a': 1}"),
                                                       tmp_bson("{'validate': %d}", BSON_VALIDATE_DOT_KEYS),
                                                       &error));
    ASSERT_OR_PRINT(mongoc_bulk_operation_execute(bulk, NULL, &error), error);
...
static void _test_remove_validate(remove_validate_test_t *test) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_t reply;
...
static void test_remove_one_after_invalid(void) {
...
static void test_remove_after_invalid(void) {
    remove_validate_test_t test = {0};
...
static void test_remove_one_with_opts_after_invalid(void) {
    remove_validate_test_t test = {0};
...
static void test_remove_many_with_opts_after_invalid(void) {
    remove_validate_test_t test = {0};
...
static void test_index_offset(void) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
...
static void test_single_ordered_bulk(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_t reply;
...
static void test_insert_continue_on_error(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void test_update_continue_on_error(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
    ...
    ASSERT_CMPINT(1,
                  ==,
                  (int)mongoc_collection_count_documents(collection, tmp_bson("{'b': 2}"), NULL, NULL, NULL, NULL));
...
static void test_remove_continue_on_error(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void test_single_error_ordered_bulk(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_t reply;
...
static void test_multiple_error_ordered_bulk(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_t reply;
...
static void test_single_unordered_bulk(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void test_single_error_unordered_bulk(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void _test_oversized_bulk_op(bool ordered) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t *opts = NULL;
    mongoc_bulk_operation_t *bulk;
...
static void test_oversized_bulk_op_ordered(void *ctx) {
    BSON_UNUSED(ctx);

    _test_oversized_bulk_op(true);
}

static void test_oversized_bulk_op_unordered(void *ctx) {
    BSON_UNUSED(ctx);

    _test_oversized_bulk_op(false);
}

static void _test_write_concern(bool ordered, bool multi_err) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
...
static void test_write_concern_write_command_ordered(void) {
    _test_write_concern(true, false);
}

static void test_write_concern_write_command_ordered_multi_err(void) {
    _test_write_concern(true, true);
}

static void test_write_concern_write_command_unordered(void) {
    _test_write_concern(false, false);
}

static void test_write_concern_write_command_unordered_multi_err(void) {
    _test_write_concern(false, true);
}

/* Test for CDRIVER-3305 - Continue unordered bulk writes on error */
static void test_unordered_bulk_writes_with_error(void) {
...
static void _test_write_concern_err_api(int32_t error_api_version) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
...
static void test_write_concern_error_write_command_v1(void) {
    _test_write_concern_err_api(1);
}

static void test_write_concern_error_write_command_v2(void) {
    _test_write_concern_err_api(2);
}

static void test_multiple_error_unordered_bulk(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void _test_wtimeout_plus_duplicate_key_err(void) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
...
static void test_wtimeout_plus_duplicate_key_err_write_commands(void) {
    _test_wtimeout_plus_duplicate_key_err();
}

static void test_large_inserts_ordered(void *ctx) {
    mongoc_client_t *client;
    bson_t *huge_doc;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
...
static void test_large_inserts_unordered(void *ctx) {
    mongoc_client_t *client;
    bson_t *huge_doc;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
...
static void execute_numerous_bulk_op(mock_server_t *server, mongoc_bulk_operation_t *bulk, const char *doc_json) {
    bson_error_t error;
    future_t *future;
    request_t *request;
    const bson_t *docs[4];
...
static void _test_numerous(bool ordered) {
    mock_server_t *server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
...
static void test_numerous_ordered(void *ctx) {
    BSON_UNUSED(ctx);

    _test_numerous(true);
}

static void test_numerous_unordered(void *ctx) {
    BSON_UNUSED(ctx);

    _test_numerous(false);
}

static void test_bulk_split(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
...
static void test_bulk_edge_case_372(bool ordered) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void test_bulk_edge_case_372_ordered(void) {
    test_bulk_edge_case_372(true);
}

static void test_bulk_edge_case_372_unordered(void) {
...
static void test_bulk_max_msg_size(void) {
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
    mongoc_write_concern_t *wc;
...
static void test_bulk_max_batch_size(void) {
    int64_t max_batch;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
    mongoc_bulk_operation_t *bulk;
...
static void test_bulk_new(void) {
    mongoc_bulk_operation_t *bulk;
    mongoc_collection_t *collection;
    mongoc_client_t *client;
    bson_error_t error;
...
static void test_bulk_write_concern_split(void *unused) {
    mongoc_client_t *client;
    mongoc_bulk_operation_t *bulk;
...
static uint32_t server_id_for_read_mode(mongoc_client_t *client, mongoc_read_mode_t read_mode) {
...
static void _test_bulk_hint(bool pooled, bool use_primary) {
    mock_rs_t *rs;
...
static void test_hint_single_command_secondary(void) {
    _test_bulk_hint(false, false);
}

static void test_hint_single_command_primary(void) {
    _test_bulk_hint(false, true);
}

static void test_hint_pooled_command_secondary(void) {
    _test_bulk_hint(true, false);
}

static void test_hint_pooled_command_primary(void) {
...
static bool test_bulk_reply_w0_finished(mongoc_collection_t *coll) {
    bson_error_t error;
    int64_t count = mongoc_collection_count_documents(coll,
...
static void test_bulk_reply_w0(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_write_concern_t *wc;
    bson_t opts = BSON_INITIALIZER;
...
static void test_bulk_invalid_write_concern(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t error;
...
static void _test_bulk_collation(bool w, bulkop op) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    ...
    case BULK_REPLACE_ONE:
        r = mongoc_bulk_operation_replace_one_with_opts(bulk,
                                                        tmp_bson("{'_id': 3}"),
                                                        tmp_bson("{'_id': 4}"),
                                                        opts,
                                                        &error);
        ...
        break;
    case BULK_UPDATE:
        r = mongoc_bulk_operation_update_many_with_opts(bulk,
                                                        tmp_bson("{'_id': 5}"),
                                                        tmp_bson("{'$set': {'_id': 6}}"),
                                                        opts,
                                                        &error);
    ...
    case BULK_UPDATE_ONE:
        r = mongoc_bulk_operation_update_one_with_opts(bulk,
                                                       tmp_bson("{'_id': 7}"),
                                                       tmp_bson("{'$set': {'_id': 8}}"),
                                                       opts,
                                                       &error);
...
static void _test_bulk_collation_multi(bool w) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    ...
    mongoc_bulk_operation_remove_many_with_opts(bulk,
                                                tmp_bson("{'_id': 2}"),
...
void test_bulk_collation_multi_w1(void) {
    _test_bulk_collation_multi(true);
}

void test_bulk_collation_multi_w0(void) {
    _test_bulk_collation_multi(false);
}

void test_bulk_collation_w1(void) {
...
void test_bulk_collation_w0(void) {
...
static void test_bulk_update_one_error_message(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t error;
...
static void test_bulk_opts_parse(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
...
static void test_bulk_no_client(void) {
    mongoc_bulk_operation_t *bulk;
    bson_t reply;
    bson_error_t error;
...
static void test_bulk_bypass_document_validation(void) {
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    bson_error_t error;
    ...
    bulk = mongoc_collection_create_bulk_operation_with_opts(collection, NULL);
    r = mongoc_bulk_operation_insert_with_opts(bulk,
                                               tmp_bson("{}"),
...
static void _test_bulk_let(bulkop op) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    ...
    switch (op) {
    case BULK_REMOVE:
        r = mongoc_bulk_operation_remove_many_with_opts(bulk,
        ...
        break;
    case BULK_REMOVE_ONE:
        r = mongoc_bulk_operation_remove_one_with_opts(bulk,
                                                       tmp_bson("{'$expr': {'$eq': ['$_id', '$$id']}}"),
                                                       NULL,
                                                       &error);
        expect_msg = "{'$db': 'test',"
...
static void test_bulk_let(void) {
...
static void test_bulk_let_multi(void) {
    mock_server_t *mock_server;
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    mongoc_bulk_operation_t *bulk;
    ...
    mongoc_bulk_operation_replace_one_with_opts(bulk,
                                                tmp_bson("{'$expr': {'$eq': ['$_id', '$$id']}}"),
                                                tmp_bson("{'x': 'foo'}"),
                                                NULL,
                                                &error);
...
// commands.
static void test_bulk_write_multiple_errors(void *unused) {
    BSON_UNUSED(unused);
    mongoc_client_t *client;
    mongoc_collection_t *collection;
    bson_t opts = BSON_INITIALIZER;
...
void test_bulk_install(TestSuite *suite) {
