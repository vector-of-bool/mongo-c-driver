...
static void test_mongoc_matcher_basic(void) {
...
static void test_mongoc_matcher_array(void) {
    bson_t *query;
    bson_t *to_match;
    bson_t *should_fail;
    bson_error_t error;
...
static void test_mongoc_matcher_compare(void) {
    mongoc_matcher_t *matcher;
...
static void test_mongoc_matcher_logic_ops(void) {
...
static void test_mongoc_matcher_bad_spec(void) {
    bson_t *spec;
    bson_error_t error;
    mongoc_matcher_t *matcher;
...
static void test_mongoc_matcher_eq_utf8(void) {
    bson_t *doc;
    bson_t *spec;
    bson_error_t error;
    mongoc_matcher_t *matcher;
...
static void test_mongoc_matcher_eq_int32(void) {
    bson_t *spec;
    bson_t *doc;
    bson_error_t error;
    mongoc_matcher_t *matcher;
...
static void test_mongoc_matcher_eq_int64(void) {
    bson_t *spec;
    bson_t *doc;
    bson_error_t error;
    mongoc_matcher_t *matcher;
...
static void test_mongoc_matcher_eq_doc(void) {
    bson_t *spec;
    bson_t *doc;
    bson_error_t error;
    mongoc_matcher_t *matcher;
...
static void test_mongoc_matcher_in_basic(void) {
    mongoc_matcher_t *matcher;
    bson_error_t error;
    bool r;
    bson_t *spec;
...
void test_matcher_install(TestSuite *suite) {
