...
static void test_read_concern_append(void) {
...
static void test_read_concern_basic(void) {
...
static void test_read_concern_bson_omits_defaults(void) {
    mongoc_read_concern_t *read_concern;
    const bson_t *bson;
    bson_iter_t iter;
...
static void test_read_concern_always_mutable(void) {
    mongoc_read_concern_t *read_concern;
...
static void _test_read_concern_wire_version(bool explicit) {
    mongoc_read_concern_t *rc;
...
static void test_inherited_read_concern(void) {
    _test_read_concern_wire_version(false);
}

static void test_explicit_read_concern(void) {
    _test_read_concern_wire_version(true);
}

void test_read_concern_install(TestSuite *suite) {
