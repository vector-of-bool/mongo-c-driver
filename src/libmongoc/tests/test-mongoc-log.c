...
static void save_state(struct log_state *state) {
    _mongoc_log_get_handler(&state->handler, &state->data);
    state->trace_enabled = _mongoc_log_trace_is_enabled();
}

static void restore_state(const struct log_state *state) {
...
void log_func(mongoc_log_level_t log_level, const char *log_domain, const char *message, void *user_data) {
...
static void test_mongoc_log_handler(void) {
...
static void test_mongoc_log_null(void) {
    struct log_state old_state;
...
static void test_mongoc_log_trace_enabled(void *context) {
    struct log_state old_state;
    struct log_func_data data;
...
static void test_mongoc_log_trace_disabled(void *context) {
    struct log_state old_state;
...
void test_log_install(TestSuite *suite) {
