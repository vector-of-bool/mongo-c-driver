...
static bool mongoc_dump_mkdir_p(const char *path, int mode) {
    int r;
...
static int mongoc_dump_collection(mongoc_client_t *client, const char *database, const char *collection) {
...
static int mongoc_dump_database(mongoc_client_t *client, const char *database, const char *collection) {
...
static int mongoc_dump(mongoc_client_t *client, const char *database, const char *collection) {
    bson_error_t error;
    char **str;
    int i;
...
int main(int argc, char *argv[]) {
    ...
    uri_string = bson_strdup_printf("mongodb://%s:%hu/%s?appname=dump-example&ssl=%s",
                                    host,
                                    port,
                                    database ? database : "",
                                    ssl ? "true" : "false");
