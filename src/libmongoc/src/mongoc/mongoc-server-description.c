...
static bool _match_tag_set(const mongoc_server_description_t *sd, bson_iter_t *tag_set_iter);

/* Destroy allocated resources within @description, but don't free it */
void mongoc_server_description_cleanup(mongoc_server_description_t *sd) {
    BSON_ASSERT(sd);
...
void mongoc_server_description_reset(mongoc_server_description_t *sd) {
    BSON_ASSERT(sd);
 ...
 *--------------------------------------------------------------------------
 */
void mongoc_server_description_init(mongoc_server_description_t *sd, const char *address, uint32_t id) {
    ENTRY;
 ...
 *--------------------------------------------------------------------------
 */
bool mongoc_server_description_has_rs_member(const mongoc_server_description_t *server, const char *address) {
...
bool mongoc_server_description_has_set_version(const mongoc_server_description_t *description) {
...
bool mongoc_server_description_has_election_id(const mongoc_server_description_t *description) {
...
const char *mongoc_server_description_type(const mongoc_server_description_t *description) {
    ...
    case MONGOC_SERVER_UNKNOWN: return "Unknown";
    case MONGOC_SERVER_STANDALONE: return "Standalone";
    case MONGOC_SERVER_MONGOS: return "Mongos";
    case MONGOC_SERVER_POSSIBLE_PRIMARY: return "PossiblePrimary";
    case MONGOC_SERVER_RS_PRIMARY: return "RSPrimary";
    case MONGOC_SERVER_RS_SECONDARY: return "RSSecondary";
    case MONGOC_SERVER_RS_ARBITER: return "RSArbiter";
    case MONGOC_SERVER_RS_OTHER: return "RSOther";
    case MONGOC_SERVER_RS_GHOST: return "RSGhost";
    case MONGOC_SERVER_LOAD_BALANCER: return "LoadBalancer";
    case MONGOC_SERVER_DESCRIPTION_TYPES:
    default: MONGOC_ERROR("Invalid mongoc_server_description_t type"); return "Invalid";
    }
}
...
const bson_t *mongoc_server_description_hello_response(const mongoc_server_description_t *description) {
 ...
 *--------------------------------------------------------------------------
 */
void mongoc_server_description_set_state(mongoc_server_description_t *description,
 ...
 *--------------------------------------------------------------------------
 */
void mongoc_server_description_set_set_version(mongoc_server_description_t *description, int64_t set_version) {
 ...
 *--------------------------------------------------------------------------
 */
void mongoc_server_description_set_election_id(mongoc_server_description_t *description,
 ...
 *-------------------------------------------------------------------------
 */
void mongoc_server_description_update_rtt(mongoc_server_description_t *server, int64_t rtt_msec) {
...
static void _mongoc_server_description_set_error(mongoc_server_description_t *sd, const bson_error_t *error) {
    if (error && error->code) {
...
void mongoc_server_description_handle_hello(mongoc_server_description_t *sd,
...
void mongoc_server_description_filter_stale(const mongoc_server_description_t **sds,
                                            size_t sds_len,
...
void mongoc_server_description_filter_tags(const mongoc_server_description_t **descriptions,
...
int32_t mongoc_server_description_compressor_id(const mongoc_server_description_t *description) {
    int id;
    bson_iter_t iter;
...
static int _nullable_cmp(const char *a, const char *b, strcmp_fn cmp_fn) {
    if (!a && b) {
        return 1;
    }
...
static int _nullable_strcasecmp(const char *a, const char *b) {
    return _nullable_cmp(a, b, strcasecmp);
}

static int _nullable_strcmp(const char *a, const char *b) {
    return _nullable_cmp(a, b, strcmp);
}

bool _mongoc_server_description_equal(mongoc_server_description_t *sd1, mongoc_server_description_t *sd2) {
...
int mongoc_server_description_topology_version_cmp(const bson_t *tv1, const bson_t *tv2) {
...
void mongoc_server_description_set_topology_version(mongoc_server_description_t *sd, const bson_t *tv) {
    BSON_ASSERT(tv);
    bson_destroy(&sd->topology_version);
    bson_copy_to(tv, &sd->topology_version);
}

bool mongoc_server_description_has_service_id(const mongoc_server_description_t *description) {
