...
static void _mongoc_write_concern_freeze(mongoc_write_concern_t *write_concern);
...
void mongoc_write_concern_set_wtimeout_int64(mongoc_write_concern_t *write_concern, int64_t wtimeout_msec) {
    BSON_ASSERT(write_concern);
...
void mongoc_write_concern_set_wtag(mongoc_write_concern_t *write_concern, const char *wtag) {
    BSON_ASSERT(write_concern);
 ...
 *
 */
bool mongoc_write_concern_is_default(const mongoc_write_concern_t *write_concern) {
...
static bool _mongoc_write_concern_validate(const mongoc_write_concern_t *write_concern, bson_error_t *error) {
