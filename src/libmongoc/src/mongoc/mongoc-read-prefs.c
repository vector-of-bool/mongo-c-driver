...
mongoc_read_prefs_t *mongoc_read_prefs_new(mongoc_read_mode_t mode) {
...
const bson_t *mongoc_read_prefs_get_hedge(const mongoc_read_prefs_t *read_prefs) {
    BSON_ASSERT(read_prefs);

    return &read_prefs->hedge;
}

void mongoc_read_prefs_set_hedge(mongoc_read_prefs_t *read_prefs, const bson_t *hedge) {
    BSON_ASSERT(read_prefs);
...
const char *_mongoc_read_mode_as_str(mongoc_read_mode_t mode) {
    switch (mode) {
    case MONGOC_READ_PRIMARY: return "primary";
    case MONGOC_READ_PRIMARY_PREFERRED: return "primaryPreferred";
    case MONGOC_READ_SECONDARY: return "secondary";
    case MONGOC_READ_SECONDARY_PREFERRED: return "secondaryPreferred";
    case MONGOC_READ_NEAREST: return "nearest";
    default: return "";
    }
}
 ...
 */
static void _apply_read_preferences_mongos(const mongoc_read_prefs_t *read_prefs,
...
void assemble_query(const mongoc_read_prefs_t *read_prefs,
    ...
    case MONGOC_TOPOLOGY_LOAD_BALANCED: _apply_read_preferences_mongos(read_prefs, query_bson, result); break;
...
void assemble_query_result_cleanup(mongoc_assemble_query_result_t *result) {
    ENTRY;
