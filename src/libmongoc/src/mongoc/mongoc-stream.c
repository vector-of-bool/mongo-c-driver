...
mongoc_stream_t *mongoc_stream_get_base_stream(mongoc_stream_t *stream) /* IN */
{
    BSON_ASSERT_PARAM(stream);
...
mongoc_stream_t *mongoc_stream_get_root_stream(mongoc_stream_t *stream) {
    BSON_ASSERT_PARAM(stream);
...
mongoc_stream_t *mongoc_stream_get_tls_stream(mongoc_stream_t *stream) /* IN */
{
    BSON_ASSERT_PARAM(stream);
