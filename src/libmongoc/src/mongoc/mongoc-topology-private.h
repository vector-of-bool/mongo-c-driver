...
typedef union mc_shared_tpld {
    ...
    const mongoc_topology_description_t *ptr;
} mc_shared_tpld;
...
int64_t mongoc_topology_server_timestamp(mongoc_topology_t *topology, uint32_t id);
 ...
 */
static BSON_INLINE mc_shared_tpld mc_tpld_take_ref(const mongoc_topology_t *tpl) {
 ...
 */
static BSON_INLINE void mc_tpld_drop_ref(mc_shared_tpld *p) {
 ...
 * `mc_tpld_take_ref()`.
 */
static BSON_INLINE void mc_tpld_renew_ref(mc_shared_tpld *td, mongoc_topology_t *tpl) {
    mc_tpld_drop_ref(td);
 ...
 */
static BSON_INLINE mongoc_topology_description_t *mc_tpld_unsafe_get_mutable(mongoc_topology_t *tpl) {
 ...
 */
static BSON_INLINE const mongoc_topology_description_t *mc_tpld_unsafe_get_const(const mongoc_topology_t *tpl) {
    return tpl->_shared_descr_._sptr_.ptr;
}
 ...
 */
static BSON_INLINE void _mongoc_topology_invalidate_server(mongoc_topology_t *td, uint32_t server_id) {
    bson_error_t error;
