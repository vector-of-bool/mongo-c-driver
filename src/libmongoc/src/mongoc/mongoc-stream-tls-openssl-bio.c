...
BIO_METHOD *mongoc_stream_tls_openssl_bio_meth_new(void) {
...
void mongoc_stream_tls_openssl_bio_set_data(BIO *b, void *ptr) {
    BIO_set_data(b, ptr);
}
...
int mongoc_stream_tls_openssl_bio_create(BIO *b) {
    BSON_ASSERT(b);
...
int mongoc_stream_tls_openssl_bio_destroy(BIO *b) {
...
int mongoc_stream_tls_openssl_bio_read(BIO *b, char *buf, int len) {
    mongoc_stream_tls_t *tls;
...
int mongoc_stream_tls_openssl_bio_write(BIO *b, const char *buf, int len) {
    mongoc_stream_tls_t *tls;
    mongoc_stream_tls_openssl_t *openssl;
    mongoc_iovec_t iov;
    ENTRY;
...
long mongoc_stream_tls_openssl_bio_ctrl(BIO *b, int cmd, long num, void *ptr) {
    BSON_UNUSED(b);
    BSON_UNUSED(num);
    BSON_UNUSED(ptr);
...
int mongoc_stream_tls_openssl_bio_gets(BIO *b, char *buf, int len) {
    BSON_UNUSED(b);
    BSON_UNUSED(buf);
    BSON_UNUSED(len);
...
int mongoc_stream_tls_openssl_bio_puts(BIO *b, const char *str) {
