...
bool mongoc_find_and_modify_opts_set_flags(mongoc_find_and_modify_opts_t *opts,
...
void mongoc_find_and_modify_opts_get_extra(const mongoc_find_and_modify_opts_t *opts, bson_t *extra) {
    BSON_ASSERT(opts);
    BSON_ASSERT(extra);
