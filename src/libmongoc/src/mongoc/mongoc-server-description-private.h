...
static BSON_INLINE mongoc_generation_map_t *mc_tpl_sd_generation_map(mongoc_server_description_t *sd) {
 ...
 * service ID.
 */
static BSON_INLINE void mc_tpl_sd_increment_generation(mongoc_server_description_t *sd, const bson_oid_t *service_id) {
 ...
 */
static BSON_INLINE uint32_t mc_tpl_sd_get_generation(const mongoc_server_description_t *sd,
...
bool mongoc_server_description_has_rs_member(const mongoc_server_description_t *description, const char *address);
...
void mongoc_server_description_set_election_id(mongoc_server_description_t *description, const bson_oid_t *election_id);
