...
static bool _mongoc_gridfs_file_refresh_page(mongoc_gridfs_file_t *file);

static bool _mongoc_gridfs_file_flush_page(mongoc_gridfs_file_t *file);

static ssize_t _mongoc_gridfs_file_extend(mongoc_gridfs_file_t *file);
 ...
 * side object
 */
mongoc_gridfs_file_t *_mongoc_gridfs_file_new_from_bson(mongoc_gridfs_t *gridfs, const bson_t *data) {
 ...
 */
mongoc_gridfs_file_t *_mongoc_gridfs_file_new(mongoc_gridfs_t *gridfs, mongoc_gridfs_file_opt_t *opt) {
    mongoc_gridfs_file_t *file;
 ...
 *    None.
 */
static bool _mongoc_gridfs_file_keep_cursor(mongoc_gridfs_file_t *file) {
    uint32_t chunk_no;
...
static int64_t divide_round_up(int64_t num, int64_t denom) {
    return (num + denom - 1) / denom;
}

static void missing_chunk(mongoc_gridfs_file_t *file) {
