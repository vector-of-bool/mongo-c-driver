...
BSON_STATIC_ASSERT2(offsetof_rpc_header, offsetof(mongoc_rpc_header_t, opcode) == offsetof(mongoc_rpc_reply_t, opcode));
...
bool _mongoc_rpc_reply_get_first_msg(mongoc_rpc_msg_t *reply, bson_t *bson);
...
bool _mongoc_rpc_decompress_if_necessary(mongoc_rpc_t *rpc, mongoc_buffer_t *buffer, bson_error_t *error);
