...
mongoc_cursor_t *mongoc_database_aggregate(mongoc_database_t *db,                 /* IN */
...
bool mongoc_database_read_command_with_opts(mongoc_database_t *database,
                                            const bson_t *command,
                                            const mongoc_read_prefs_t *read_prefs,
                                            const bson_t *opts,
                                            bson_t *reply,
...
bool mongoc_database_command_with_opts(mongoc_database_t *database,
                                       const bson_t *command,
                                       const mongoc_read_prefs_t *read_prefs,
                                       const bson_t *opts,
                                       bson_t *reply,
...
const mongoc_read_prefs_t *mongoc_database_get_read_prefs(const mongoc_database_t *database) /* IN */
{
    BSON_ASSERT_PARAM(database);
...
char *_mongoc_get_encryptedField_state_collection(const bson_t *encryptedFields,
...
static bool create_encField_state_collection(mongoc_database_t *database,
...
static mongoc_collection_t *create_collection_with_encryptedFields(mongoc_database_t *database,
                                                                   const char *name,
                                                                   const bson_t *opts,
                                                                   const bson_t *encryptedFields,
                                                                   bson_error_t *error) {
    ...
    /* Create index on __safeContent__. */
    {
        ...
        ok =
            mongoc_database_write_command_with_opts(database, create_indexes, NULL /* opts */, NULL /* reply */, error);
...
bool _mongoc_get_encryptedFields_from_map(mongoc_client_t *client,
                                          const char *dbName,
                                          const char *collName,
...
bool _mongoc_get_encryptedFields_from_server(mongoc_client_t *client,
                                             const char *dbName,
                                             const char *collName,
                                             bson_t *encryptedFields,
                                             bson_error_t *error) {
...
bool _mongoc_get_collection_encryptedFields(mongoc_client_t *client,
                                            const char *dbName,
                                            const char *collName,
                                            const bson_t *opts,
...
mongoc_collection_t *mongoc_database_create_collection(mongoc_database_t *database,
    ...
    if (!bson_empty(&encryptedFields)) {
        ...
        mongoc_collection_t *ret = create_collection_with_encryptedFields(database,
                                                                          name,
...
mongoc_collection_t *mongoc_database_get_collection(mongoc_database_t *database, const char *collection) {
    BSON_ASSERT_PARAM(database);
