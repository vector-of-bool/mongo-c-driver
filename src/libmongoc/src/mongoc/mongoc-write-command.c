...
static mongoc_write_op_t gLegacyWriteOps[3] = {_mongoc_write_command_delete_legacy,
                                               _mongoc_write_command_insert_legacy,
                                               _mongoc_write_command_update_legacy};

const char *_mongoc_command_type_to_name(int command_type) {
    return gCommandNames[command_type];
}

const char *_mongoc_command_type_to_field_name(int command_type) {
    return gCommandFields[command_type];
}

void _mongoc_write_command_insert_append(mongoc_write_command_t *command, const bson_t *document) {
    bson_iter_t iter;
    bson_oid_t oid;
    bson_t tmp;
...
void _mongoc_write_command_delete_append(mongoc_write_command_t *command, const bson_t *selector, const bson_t *opts) {
    bson_t document;
...
void _mongoc_write_command_init_bulk(mongoc_write_command_t *command,
                                     int type,
...
void _mongoc_write_command_init_insert(mongoc_write_command_t *command, /* IN */
...
void _mongoc_write_command_init_insert_idl(mongoc_write_command_t *command,
...
void _mongoc_write_command_init_delete(mongoc_write_command_t *command, /* IN */
...
void _mongoc_write_command_init_delete_idl(mongoc_write_command_t *command,
                                           const bson_t *selector,
                                           const bson_t *cmd_opts,
                                           const bson_t *opts,
                                           int64_t operation_id) {
...
void _mongoc_write_command_init_update(mongoc_write_command_t *command, /* IN */
                                       const bson_t *selector,          /* IN */
...
void _mongoc_write_command_init_update_idl(mongoc_write_command_t *command,
                                           const bson_t *selector,
                                           const bson_t *update,
                                           const bson_t *cmd_opts,
                                           const bson_t *opts,
...
void _mongoc_write_command_init(bson_t *doc, mongoc_write_command_t *command, const char *collection) {
    ENTRY;
...
void _mongoc_write_command_too_large_error(bson_error_t *error, int32_t idx, int32_t len, int32_t max_bson_size) {
...
void _empty_error(mongoc_write_command_t *command, bson_error_t *error) {
...
bool _mongoc_write_command_will_overflow(uint32_t len_so_far,
    ...
    if (bson_cmp_greater_us(len_so_far + document_len, max_cmd_size)) {
        return true;
    } else if (max_write_batch_size > 0 && bson_cmp_greater_equal_us(n_documents_written, max_write_batch_size)) {
        return true;
    }
...
static void _mongoc_write_opmsg(mongoc_write_command_t *command,
                                mongoc_client_t *client,
                                mongoc_server_stream_t *server_stream,
                                const char *database,
                                const char *collection,
...
void _append_array_from_command(mongoc_write_command_t *command, bson_t *bson) {
    bson_t ar;
...
static bool _assemble_cmd(bson_t *cmd,
...
static void _mongoc_write_opquery(mongoc_write_command_t *command,
                                  mongoc_client_t *client,
                                  mongoc_server_stream_t *server_stream,
                                  const char *database,
                                  const char *collection,
...
void _mongoc_write_command_execute(mongoc_write_command_t *command,             /* IN */
...
void _mongoc_write_command_execute_idl(mongoc_write_command_t *command,
                                       mongoc_client_t *client,
                                       mongoc_server_stream_t *server_stream,
                                       const char *database,
                                       const char *collection,
...
void _mongoc_write_result_init(mongoc_write_result_t *result) /* IN */
{
    ENTRY;
...
void _mongoc_write_result_append_upsert(mongoc_write_result_t *result, int32_t idx, const bson_value_t *value) {
    bson_t child;
...
int32_t _mongoc_write_result_merge_arrays(uint32_t offset,
...
void _mongoc_write_result_merge(mongoc_write_result_t *result,   /* IN */
    ...
    switch (command->type) {
    case MONGOC_WRITE_COMMAND_INSERT: result->nInserted += affected; break;
    case MONGOC_WRITE_COMMAND_DELETE: result->nRemoved += affected; break;
 ...
 */
static void _set_error_from_response(bson_t *bson_array,
...
bool _mongoc_write_result_complete(mongoc_write_result_t *result,             /* IN */
 ...
 *--------------------------------------------------------------------------
 */
mongoc_write_err_type_t _mongoc_write_error_get_type(bson_t *reply) {
    bson_error_t error;
    ...
    switch (error.code) {
    case 64: /* WriteConcernFailed */ return MONGOC_WRITE_ERR_WRITE_CONCERN;
    default: return MONGOC_WRITE_ERR_OTHER;
    }
}

/* Returns true and modifies reply and cmd_err. */
bool _mongoc_write_error_update_if_unsupported_storage_engine(bool cmd_ret, bson_error_t *cmd_err, bson_t *reply) {
