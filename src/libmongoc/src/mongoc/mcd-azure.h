 ...
 */
bool mcd_azure_access_token_try_init_from_json_str(mcd_azure_access_token *out,
                                                   const char *json,
                                                   int len,
 ...
 */
void mcd_azure_access_token_destroy(mcd_azure_access_token *token);
 ...
 */
void mcd_azure_imds_request_init(mcd_azure_imds_request *req,
 ...
 * @param req
 */
void mcd_azure_imds_request_destroy(mcd_azure_imds_request *req);
 ...
 * @note Currently only supports the vault.azure.net resource
 */
bool mcd_azure_access_token_from_imds(mcd_azure_access_token *const out,
                                      const char *const opt_imds_host,
                                      int opt_port,
