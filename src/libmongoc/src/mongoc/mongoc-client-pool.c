...
void _mongoc_client_pool_set_internal_tls_opts(mongoc_client_pool_t *pool, _mongoc_internal_tls_opts_t *internal) {
    bson_mutex_lock(&pool->mutex);
...
mongoc_client_pool_t *mongoc_client_pool_new_with_error(const mongoc_uri_t *uri, bson_error_t *error) {
    mongoc_topology_t *topology;
    mongoc_client_pool_t *pool;
    const bson_t *b;
    bson_iter_t iter;
 ...
 */
static void _start_scanner_if_needed(mongoc_client_pool_t *pool) {
    if (!pool->topology->single_threaded) {
        _mongoc_topology_background_monitoring_start(pool->topology);
    }
}

static void _initialize_new_client(mongoc_client_pool_t *pool, mongoc_client_t *client) {
    /* for tests */
...
/* for tests */
void _mongoc_client_pool_set_stream_initiator(mongoc_client_pool_t *pool, mongoc_stream_initiator_t si, void *context) {
...
mongoc_topology_t *_mongoc_client_pool_get_topology(mongoc_client_pool_t *pool) {
...
bool mongoc_client_pool_enable_auto_encryption(mongoc_client_pool_t *pool,
                                               mongoc_auto_encryption_opts_t *opts,
                                               bson_error_t *error) {
    return _mongoc_cse_client_pool_enable_auto_encryption(pool->topology, opts, error);
}

bool mongoc_client_pool_set_server_api(mongoc_client_pool_t *pool,
