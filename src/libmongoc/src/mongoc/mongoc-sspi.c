...
static SEC_CHAR *_mongoc_sspi_base64_encode(const SEC_CHAR *value, DWORD vlen) {
    SEC_CHAR *out = NULL;
    DWORD len;
...
static SEC_CHAR *_mongoc_sspi_base64_decode(const SEC_CHAR *value, DWORD *rlen) {
    SEC_CHAR *out = NULL;
    /* Get the correct size for the out buffer. */
...
static CHAR *_mongoc_sspi_wide_to_utf8(WCHAR *value) {
    CHAR *out;
