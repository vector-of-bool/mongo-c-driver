...
static int mongoc_set_id_cmp(const void *a_, const void *b_) {
...
static bool _mongoc_set_for_each_helper(uint32_t id, void *item, void *ctx) {
...
static mongoc_set_item_t *_mongoc_set_find(const mongoc_set_t *set, mongoc_set_for_each_const_cb_t cb, void *ctx) {
    size_t i;
    size_t items_len;
