 ...
 * description.
 */
static BSON_INLINE mongoc_set_t *mc_tpld_servers(mongoc_topology_description_t *tpld) {
    BSON_ASSERT_PARAM(tpld);
    return tpld->_servers_;
}

static BSON_INLINE const mongoc_set_t *mc_tpld_servers_const(const mongoc_topology_description_t *tpld) {
    BSON_ASSERT_PARAM(tpld);
    return tpld->_servers_;
}

void _mongoc_topology_description_copy_to(const mongoc_topology_description_t *src, mongoc_topology_description_t *dst);
...
const mongoc_server_description_t *mongoc_topology_description_select(const mongoc_topology_description_t *description,
...
void mongoc_topology_description_invalidate_server(mongoc_topology_description_t *topology,
                                                   uint32_t id,
                                                   const bson_error_t *error /* IN */);
