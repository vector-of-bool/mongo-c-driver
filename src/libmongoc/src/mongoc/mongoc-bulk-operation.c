...
mongoc_bulk_operation_t *_mongoc_bulk_operation_new(mongoc_client_t *client,                     /* IN */
...
void mongoc_bulk_operation_destroy(mongoc_bulk_operation_t *bulk) /* IN */
{
...
static bool _mongoc_bulk_operation_remove_with_opts(mongoc_bulk_operation_t *bulk,
...
void mongoc_bulk_operation_remove(mongoc_bulk_operation_t *bulk, /* IN */
...
void mongoc_bulk_operation_remove_one(mongoc_bulk_operation_t *bulk, /* IN */
                                      const bson_t *selector)        /* IN */
{
    bson_error_t *error = &bulk->result.error;
...
bool mongoc_bulk_operation_insert_with_opts(mongoc_bulk_operation_t *bulk,
...
static void _mongoc_bulk_operation_update_append(mongoc_bulk_operation_t *bulk,
                                                 const bson_t *selector,
                                                 const bson_t *document,
...
static bool _mongoc_bulk_operation_update_with_opts(mongoc_bulk_operation_t *bulk,
                                                    const bson_t *selector,
                                                    const bson_t *document,
                                                    const mongoc_bulk_update_opts_t *update_opts,
                                                    const bson_t *array_filters,
...
uint32_t mongoc_bulk_operation_execute(mongoc_bulk_operation_t *bulk, /* IN */
                                       bson_t *reply,                 /* OUT */
                                       bson_error_t *error)           /* OUT */
{
...
void mongoc_bulk_operation_set_client_session(mongoc_bulk_operation_t *bulk,
...
void mongoc_bulk_operation_set_comment(mongoc_bulk_operation_t *bulk, const bson_value_t *comment) {
    BSON_ASSERT_PARAM(bulk);
...
void mongoc_bulk_operation_set_let(mongoc_bulk_operation_t *bulk, const bson_t *let) {
    BSON_ASSERT_PARAM(bulk);
