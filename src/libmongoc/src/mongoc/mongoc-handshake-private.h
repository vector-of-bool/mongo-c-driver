...
bool _mongoc_handshake_build_doc_with_application(bson_t *doc, const char *application);
...
void _mongoc_handshake_append_sasl_supported_mechs(const mongoc_uri_t *uri, bson_t *hello);
