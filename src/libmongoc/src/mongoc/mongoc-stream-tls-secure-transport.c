...
static void _mongoc_stream_tls_secure_transport_destroy(mongoc_stream_t *stream) {
...
static void _mongoc_stream_tls_secure_transport_failed(mongoc_stream_t *stream) {
    ENTRY;
    _mongoc_stream_tls_secure_transport_destroy(stream);
    EXIT;
}

static int _mongoc_stream_tls_secure_transport_close(mongoc_stream_t *stream) {
    int ret = 0;
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_secure_transport_t *secure_transport = (mongoc_stream_tls_secure_transport_t *)tls->ctx;
...
static int _mongoc_stream_tls_secure_transport_flush(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_secure_transport_t *secure_transport = (mongoc_stream_tls_secure_transport_t *)tls->ctx;
...
static ssize_t _mongoc_stream_tls_secure_transport_write(mongoc_stream_t *stream, char *buf, size_t buf_len) {
    OSStatus status;
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_secure_transport_t *secure_transport = (mongoc_stream_tls_secure_transport_t *)tls->ctx;
    ssize_t write_ret;
    ...
    case errSSLClosedAbort: errno = ECONNRESET;
...
static ssize_t _mongoc_stream_tls_secure_transport_writev(mongoc_stream_t *stream,
                                                          mongoc_iovec_t *iov,
                                                          size_t iovcnt,
...
static ssize_t _mongoc_stream_tls_secure_transport_readv(mongoc_stream_t *stream,
                                                         mongoc_iovec_t *iov,
                                                         size_t iovcnt,
                                                         size_t min_bytes,
                                                         int32_t timeout_msec) {
...
static int _mongoc_stream_tls_secure_transport_setsockopt(mongoc_stream_t *stream,
                                                          int level,
                                                          int optname,
                                                          void *optval,
...
static mongoc_stream_t *_mongoc_stream_tls_secure_transport_get_base_stream(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_secure_transport_t *secure_transport = (mongoc_stream_tls_secure_transport_t *)tls->ctx;
...
static bool _mongoc_stream_tls_secure_transport_check_closed(mongoc_stream_t *stream) /* IN */
{
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_secure_transport_t *secure_transport = (mongoc_stream_tls_secure_transport_t *)tls->ctx;
...
static void _set_error_from_osstatus(OSStatus status, const char *prefix, bson_error_t *error) {
    CFStringRef err;
    char *err_str;
...
static char *explain_trust_result(SecTrustRef trust, SecTrustResultType trust_result) {
    ...
    switch (trust_result) {
    case kSecTrustResultDeny: bson_string_append(reason, "Certificate trust denied"); break;
    case kSecTrustResultRecoverableTrustFailure: bson_string_append(reason, "Certificate trust failure"); break;
    case kSecTrustResultFatalTrustFailure: bson_string_append(reason, "Certificate trust fatal failure"); break;
    case kSecTrustResultInvalid: bson_string_append(reason, "Certificate trust evaluation failure"); break;
    default: bson_string_append_printf(reason, "Certificate trust failure #%d", (int)trust_result); break;
    }
 ...
 * set.
 */
static bool _verify_peer(mongoc_stream_t *stream, bson_error_t *error) {
...
bool mongoc_stream_tls_secure_transport_handshake(mongoc_stream_t *stream,
                                                  const char *host,
                                                  int *events,
                                                  bson_error_t *error) {
    OSStatus ret = 0;
...
static bool _mongoc_stream_tls_secure_channel_timed_out(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
...
static bool _mongoc_stream_tls_secure_channel_should_retry(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
...
mongoc_stream_t *mongoc_stream_tls_secure_transport_new(mongoc_stream_t *base_stream,
                                                        const char *host,
