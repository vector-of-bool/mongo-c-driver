...
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_initiate(mongoc_async_cmd_t *cmd);
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_setup(mongoc_async_cmd_t *cmd);
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_send(mongoc_async_cmd_t *cmd);
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_recv_len(mongoc_async_cmd_t *cmd);
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_recv_rpc(mongoc_async_cmd_t *cmd);
...
#ifdef MONGOC_ENABLE_SSL
int mongoc_async_cmd_tls_setup(mongoc_stream_t *stream,
                               int *events,
                               void *ctx,
...
bool mongoc_async_cmd_run(mongoc_async_cmd_t *acmd) {
...
void _mongoc_async_cmd_init_send(const mongoc_opcode_t cmd_opcode, mongoc_async_cmd_t *acmd, const char *dbname) {
...
void _mongoc_async_cmd_state_start(mongoc_async_cmd_t *acmd, bool is_setup_done) {
    if (!acmd->stream) {
...
mongoc_async_cmd_t *mongoc_async_cmd_new(mongoc_async_t *async,
...
void mongoc_async_cmd_destroy(mongoc_async_cmd_t *acmd) {
    BSON_ASSERT(acmd);
...
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_initiate(mongoc_async_cmd_t *acmd) {
...
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_setup(mongoc_async_cmd_t *acmd) {
    int retval;
    ...
    switch (retval) {
    case -1: return MONGOC_ASYNC_CMD_ERROR;
    case 0: break;
    case 1:
        acmd->state = MONGOC_ASYNC_CMD_SEND;
        acmd->events = POLLOUT;
...
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_send(mongoc_async_cmd_t *acmd) {
...
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_recv_len(mongoc_async_cmd_t *acmd) {
...
mongoc_async_cmd_result_t _mongoc_async_cmd_phase_recv_rpc(mongoc_async_cmd_t *acmd) {
    ssize_t bytes = _mongoc_buffer_try_append_from_stream(&acmd->buffer, acmd->stream, acmd->bytes_to_read, 0);
