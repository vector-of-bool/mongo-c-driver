...
void mongoc_auto_encryption_opts_set_keyvault_client_pool(mongoc_auto_encryption_opts_t *opts,
...
void mongoc_auto_encryption_opts_set_keyvault_namespace(mongoc_auto_encryption_opts_t *opts,
                                                        const char *db,
                                                        const char *coll) {
    if (!opts) {
        return;
...
static bson_t *_bson_copy_or_null(const bson_t *bson) {
    if (bson) {
...
void mongoc_auto_encryption_opts_set_tls_opts(mongoc_auto_encryption_opts_t *opts, const bson_t *tls_opts) {
    if (!opts) {
        return;
    }
    bson_destroy(opts->tls_opts);
...
void mongoc_auto_encryption_opts_set_encrypted_fields_map(mongoc_auto_encryption_opts_t *opts,
...
void mongoc_auto_encryption_opts_set_bypass_auto_encryption(mongoc_auto_encryption_opts_t *opts,
                                                            bool bypass_auto_encryption) {
    if (!opts) {
        return;
    }
...
void mongoc_auto_encryption_opts_set_bypass_query_analysis(mongoc_auto_encryption_opts_t *opts,
                                                           bool bypass_query_analysis) {
    if (!opts) {
        return;
    }
...
void mongoc_auto_encryption_opts_set_kms_credential_provider_callback(mongoc_auto_encryption_opts_t *opts,
...
void mongoc_client_encryption_opts_set_keyvault_client(mongoc_client_encryption_opts_t *opts,
                                                       mongoc_client_t *keyvault_client) {
    if (!opts) {
        return;
    }
...
void mongoc_client_encryption_opts_set_keyvault_namespace(mongoc_client_encryption_opts_t *opts,
                                                          const char *db,
                                                          const char *coll) {
    if (!opts) {
        return;
...
void mongoc_client_encryption_opts_set_kms_providers(mongoc_client_encryption_opts_t *opts,
...
void mongoc_client_encryption_opts_set_kms_credential_provider_callback(mongoc_client_encryption_opts_t *opts,
                                                                        mongoc_kms_credentials_provider_callback_fn fn,
                                                                        void *userdata) {
...
mongoc_client_encryption_datakey_opts_t *mongoc_client_encryption_datakey_opts_new(void) {
    return bson_malloc0(sizeof(mongoc_client_encryption_datakey_opts_t));
}

static void _clear_datakey_keyaltnames(mongoc_client_encryption_datakey_opts_t *opts) {
    if (opts->keyaltnames) {
...
void mongoc_client_encryption_datakey_opts_set_masterkey(mongoc_client_encryption_datakey_opts_t *opts,
...
void mongoc_client_encryption_datakey_opts_set_keyaltnames(mongoc_client_encryption_datakey_opts_t *opts,
                                                           char **keyaltnames,
                                                           uint32_t keyaltnames_count) {
    if (!opts) {
        return;
...
void mongoc_client_encryption_datakey_opts_set_keymaterial(mongoc_client_encryption_datakey_opts_t *opts,
                                                           const uint8_t *data,
                                                           uint32_t len) {
    if (!opts) {
        return;
...
mongoc_client_encryption_encrypt_opts_t *mongoc_client_encryption_encrypt_opts_new(void) {
    return bson_malloc0(sizeof(mongoc_client_encryption_encrypt_opts_t));
}

void mongoc_client_encryption_encrypt_range_opts_destroy(mongoc_client_encryption_encrypt_range_opts_t *range_opts) {
    if (!range_opts) {
        return;
    }
...
void mongoc_client_encryption_encrypt_opts_set_keyid(mongoc_client_encryption_encrypt_opts_t *opts,
...
void mongoc_client_encryption_encrypt_opts_set_keyaltname(mongoc_client_encryption_encrypt_opts_t *opts,
...
void mongoc_client_encryption_encrypt_opts_set_algorithm(mongoc_client_encryption_encrypt_opts_t *opts,
...
void mongoc_client_encryption_encrypt_opts_set_contention_factor(mongoc_client_encryption_encrypt_opts_t *opts,
...
void mongoc_client_encryption_encrypt_opts_set_query_type(mongoc_client_encryption_encrypt_opts_t *opts,
...
void mongoc_client_encryption_encrypt_range_opts_set_sparsity(mongoc_client_encryption_encrypt_range_opts_t *range_opts,
                                                              int64_t sparsity) {
    BSON_ASSERT_PARAM(range_opts);
    range_opts->sparsity = sparsity;
}

void mongoc_client_encryption_encrypt_range_opts_set_min(mongoc_client_encryption_encrypt_range_opts_t *range_opts,
...
void mongoc_client_encryption_encrypt_range_opts_set_max(mongoc_client_encryption_encrypt_range_opts_t *range_opts,
...
void mongoc_client_encryption_encrypt_range_opts_set_precision(
    mongoc_client_encryption_encrypt_range_opts_t *range_opts,
    int32_t precision) {
    BSON_ASSERT_PARAM(range_opts);
...
void mongoc_client_encryption_encrypt_opts_set_range_opts(
...
mongoc_client_encryption_rewrap_many_datakey_result_t *mongoc_client_encryption_rewrap_many_datakey_result_new(void) {
...
static bool _disabled_error(bson_error_t *error) {
...
bool mongoc_client_encryption_create_datakey(mongoc_client_encryption_t *client_encryption,
...
bool mongoc_client_encryption_rewrap_many_datakey(mongoc_client_encryption_t *client_encryption,
                                                  const bson_t *filter,
                                                  const char *provider,
...
bool mongoc_client_encryption_delete_key(mongoc_client_encryption_t *client_encryption,
                                         const bson_value_t *keyid,
                                         bson_t *reply,
                                         bson_error_t *error) {
    BSON_UNUSED(client_encryption);
...
bool mongoc_client_encryption_get_key(mongoc_client_encryption_t *client_encryption,
                                      const bson_value_t *keyid,
                                      bson_t *key_doc,
                                      bson_error_t *error) {
    BSON_UNUSED(client_encryption);
...
mongoc_cursor_t *mongoc_client_encryption_get_keys(mongoc_client_encryption_t *client_encryption, bson_error_t *error) {
    BSON_UNUSED(client_encryption);
...
bool mongoc_client_encryption_add_key_alt_name(mongoc_client_encryption_t *client_encryption,
                                               const bson_value_t *keyid,
                                               const char *keyaltname,
                                               bson_t *key_doc,
                                               bson_error_t *error) {
...
bool mongoc_client_encryption_remove_key_alt_name(mongoc_client_encryption_t *client_encryption,
                                                  const bson_value_t *keyid,
                                                  const char *keyaltname,
                                                  bson_t *key_doc,
                                                  bson_error_t *error) {
...
bool mongoc_client_encryption_get_key_by_alt_name(mongoc_client_encryption_t *client_encryption,
                                                  const char *keyaltname,
                                                  bson_t *key_doc,
                                                  bson_error_t *error) {
    BSON_UNUSED(client_encryption);
...
bool mongoc_client_encryption_encrypt(mongoc_client_encryption_t *client_encryption,
...
bool mongoc_client_encryption_encrypt_expression(mongoc_client_encryption_t *client_encryption,
                                                 const bson_t *expr,
                                                 mongoc_client_encryption_encrypt_opts_t *opts,
...
mongoc_collection_t *mongoc_client_encryption_create_encrypted_collection(mongoc_client_encryption_t *enc,
 ...
 * libmongocrypt.
 */
static void append_bson_range_opts(bson_t *bson_range_opts, const mongoc_client_encryption_encrypt_opts_t *opts) {
 ...
 * --------------------------------------------------------------------------
 */
static void _prep_for_auto_encryption(const mongoc_cmd_t *cmd, bson_t *out) {
 ...
 *--------------------------------------------------------------------------
 */
bool _mongoc_cse_auto_encrypt(mongoc_client_t *client_encrypted,
                              const mongoc_cmd_t *cmd,
                              mongoc_cmd_t *encrypted_cmd,
                              bson_t *encrypted,
                              bson_error_t *error) {
 ...
 *--------------------------------------------------------------------------
 */
bool _mongoc_cse_auto_decrypt(mongoc_client_t *client_encrypted,
                              const char *db_name,
                              const bson_t *reply,
                              bson_t *decrypted,
                              bson_error_t *error) {
...
static void _uri_construction_error(bson_error_t *error) {
    bson_set_error(error,
                   MONGOC_ERROR_CLIENT,
                   MONGOC_ERROR_CLIENT_INVALID_ENCRYPTION_STATE,
...
#ifdef _WIN32
static bool _do_spawn(const char *path, char **args, bson_error_t *error) {
...
static bool _parse_extra(const bson_t *extra, mongoc_topology_t *topology, mongoc_uri_t **uri, bson_error_t *error) {
    bson_iter_t iter;
    bool ret = false;
...
bool _mongoc_cse_client_pool_enable_auto_encryption(mongoc_topology_t *topology,
    ...
    prev_cse_state = bson_atomic_int_compare_exchange_strong((int *)&topology->cse_state,
                                                             MONGOC_CSE_DISABLED,
                                                             MONGOC_CSE_STARTING,
...
static bool _coll_has_write_concern_majority(const mongoc_collection_t *coll) {
...
static bool _coll_has_read_concern_majority(const mongoc_collection_t *coll) {
...
bool mongoc_client_encryption_add_key_alt_name(mongoc_client_encryption_t *client_encryption,
    ...
    ret = mongoc_collection_find_and_modify_with_opts(client_encryption->keyvault_coll,
                                                      &query,
                                                      opts,
                                                      &local_reply,
                                                      error);
...
static bool _auto_datakey(struct auto_datakey_context *ctx) {
    ...
    bsonVisitEach(in_encryptedFields,
                  case (
                      ...
                      // Automaticall fill in the "keyId" no each field:
                               ...
                               // automatically:
                               if (!_mongoc_encryptedFields_fill_auto_datakeys(&new_fields,
                                                                               &fields_ref,
                                                                               _auto_datakey,
                                                                               &ctx,
                                                                               error)) {
...
static void _init_1_encryptedField(bson_t *out_field,
...
static void _init_encryptedFields(bson_t *out_fields,
...
const char *mongoc_client_encryption_get_crypt_shared_version(const mongoc_client_encryption_t *enc) {
...
const char *mongoc_client_get_crypt_shared_version(const mongoc_client_t *client) {
#ifdef MONGOC_ENABLE_CLIENT_SIDE_ENCRYPTION
    if (!client->topology->crypt) {
        return NULL;
    }
