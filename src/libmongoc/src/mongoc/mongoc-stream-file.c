...
static int _mongoc_stream_file_close(mongoc_stream_t *stream) {
...
static void _mongoc_stream_file_destroy(mongoc_stream_t *stream) {
    mongoc_stream_file_t *file = (mongoc_stream_file_t *)stream;
...
static void _mongoc_stream_file_failed(mongoc_stream_t *stream) {
    ENTRY;
...
static int _mongoc_stream_file_flush(mongoc_stream_t *stream) /* IN */
{
    mongoc_stream_file_t *file = (mongoc_stream_file_t *)stream;
...
static ssize_t _mongoc_stream_file_readv(mongoc_stream_t *stream, /* IN */
...
static ssize_t _mongoc_stream_file_writev(mongoc_stream_t *stream, /* IN */
                                          mongoc_iovec_t *iov,     /* IN */
                                          size_t iovcnt,           /* IN */
                                          int32_t timeout_msec)    /* IN */
{
...
static bool _mongoc_stream_file_check_closed(mongoc_stream_t *stream) /* IN */
{
    BSON_UNUSED(stream);
...
mongoc_stream_t *mongoc_stream_file_new(int fd) /* IN */
{
...
mongoc_stream_t *mongoc_stream_file_new_for_path(const char *path, /* IN */
                                                 int flags,        /* IN */
                                                 int mode)         /* IN */
{
    int fd = -1;
