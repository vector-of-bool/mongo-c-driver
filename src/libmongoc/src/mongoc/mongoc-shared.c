...
static void _release_aux(_mongoc_shared_ptr_aux *aux) {
...
void mongoc_shared_ptr_reset(mongoc_shared_ptr *ptr, void *pointee, void (*deleter)(void *)) {
...
void mongoc_shared_ptr_assign(mongoc_shared_ptr *dest, mongoc_shared_ptr from) {
...
mongoc_shared_ptr mongoc_shared_ptr_create(void *pointee, void (*deleter)(void *)) {
    mongoc_shared_ptr ret = MONGOC_SHARED_PTR_NULL;
    mongoc_shared_ptr_reset(&ret, pointee, deleter);
    return ret;
}

void mongoc_atomic_shared_ptr_store(mongoc_shared_ptr *dest, mongoc_shared_ptr from) {
...
mongoc_shared_ptr mongoc_atomic_shared_ptr_load(const mongoc_shared_ptr *ptr) {
    mongoc_shared_ptr r;
    BSON_ASSERT_PARAM(ptr);
...
mongoc_shared_ptr mongoc_shared_ptr_copy(mongoc_shared_ptr ptr) {
...
void mongoc_shared_ptr_reset_null(mongoc_shared_ptr *ptr) {
    int prevcount = 0;
    BSON_ASSERT_PARAM(ptr);
    if (mongoc_shared_ptr_is_null(*ptr)) {
        /* Already null. Okay. */
...
int mongoc_shared_ptr_use_count(mongoc_shared_ptr ptr) {
