...
static void _mongoc_socket_capture_errno(mongoc_socket_t *sock) /* IN */
{
#ifdef _WIN32
...
static bool _mongoc_socket_wait(mongoc_socket_t *sock, /* IN */
                                int events,            /* IN */
...
ssize_t mongoc_socket_poll(mongoc_socket_poll_t *sds, /* IN */
                           size_t nsds,               /* IN */
                           int32_t timeout)           /* IN */
{
#ifdef _WIN32
...
#ifdef _WIN32
static void _mongoc_socket_setkeepalive_windows(SOCKET sd) {
...
static const char *_mongoc_socket_sockopt_value_to_name(int value) {
    switch (value) {
#ifdef TCP_KEEPIDLE
...
#endif
    default: MONGOC_WARNING("Don't know what socketopt %d is", value); return "Unknown option name";
    }
}

static void _mongoc_socket_set_sockopt_if_less(int sd, int name, int value) {
    int optval = 1;
...
static void _mongoc_socket_setkeepalive_nix(int sd) {
...
int mongoc_socket_errno(mongoc_socket_t *sock) /* IN */
{
    BSON_ASSERT(sock);
...
static bool _mongoc_socket_errno_is_again(mongoc_socket_t *sock) /* IN */
{
...
mongoc_socket_t *mongoc_socket_accept(mongoc_socket_t *sock, /* IN */
                                      int64_t expire_at)     /* IN */
{
...
mongoc_socket_t *mongoc_socket_accept_ex(mongoc_socket_t *sock, /* IN */
                                         int64_t expire_at,     /* IN */
                                         uint16_t *port)        /* OUT */
{
...
int mongoc_socket_bind(mongoc_socket_t *sock,       /* IN */
...
int mongoc_socket_close(mongoc_socket_t *sock) /* IN */
{
    bool owned;
...
int mongoc_socket_connect(mongoc_socket_t *sock,       /* IN */
                          const struct sockaddr *addr, /* IN */
                          mongoc_socklen_t addrlen,    /* IN */
                          int64_t expire_at)           /* IN */
{
...
void mongoc_socket_destroy(mongoc_socket_t *sock) /* IN */
{
    if (sock) {
...
int mongoc_socket_listen(mongoc_socket_t *sock, /* IN */
...
mongoc_socket_t *mongoc_socket_new(int domain,   /* IN */
                                   int type,     /* IN */
                                   int protocol) /* IN */
{
...
ssize_t mongoc_socket_recv(mongoc_socket_t *sock, /* IN */
                           void *buf,             /* OUT */
                           size_t buflen,         /* IN */
                           int flags,             /* IN */
                           int64_t expire_at)     /* IN */
...
int mongoc_socket_setsockopt(mongoc_socket_t *sock,   /* IN */
                             int level,               /* IN */
                             int optname,             /* IN */
...
ssize_t mongoc_socket_send(mongoc_socket_t *sock, /* IN */
                           const void *buf,       /* IN */
                           size_t buflen,         /* IN */
                           int64_t expire_at)     /* IN */
{
...
static ssize_t _mongoc_socket_try_sendv_slow(mongoc_socket_t *sock, /* IN */
...
static ssize_t _mongoc_socket_try_sendv(mongoc_socket_t *sock, /* IN */
                                        mongoc_iovec_t *iov,   /* IN */
                                        size_t iovcnt)         /* IN */
{
#ifdef _WIN32
...
ssize_t mongoc_socket_sendv(mongoc_socket_t *sock,  /* IN */
...
int mongoc_socket_getsockname(mongoc_socket_t *sock,     /* IN */
...
char *mongoc_socket_getnameinfo(mongoc_socket_t *sock) /* IN */
{
...
bool mongoc_socket_check_closed(mongoc_socket_t *sock) /* IN */
{
    bool closed = false;
    char buf[1];
    ssize_t r;
                             ...
                             size_t buflen)       /* IN */
{
    ...
    case AF_INET6:
        ...
        break;
    default: bson_snprintf(buf, buflen, "unknown ip %d", rp->ai_family); break;
    }
}
