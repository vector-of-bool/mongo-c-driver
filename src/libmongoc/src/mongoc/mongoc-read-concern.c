...
static void _mongoc_read_concern_freeze(mongoc_read_concern_t *read_concern);
 ...
 *
 */
bool mongoc_read_concern_append(mongoc_read_concern_t *read_concern, bson_t *command) {
    BSON_ASSERT(read_concern);
 ...
 */
bool mongoc_read_concern_is_default(const mongoc_read_concern_t *read_concern) {
