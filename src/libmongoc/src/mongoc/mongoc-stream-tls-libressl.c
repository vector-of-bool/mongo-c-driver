...
static void _mongoc_stream_tls_libressl_destroy(mongoc_stream_t *stream) {
...
static void _mongoc_stream_tls_libressl_failed(mongoc_stream_t *stream) {
    ENTRY;
    _mongoc_stream_tls_libressl_destroy(stream);
    EXIT;
}

static int _mongoc_stream_tls_libressl_close(mongoc_stream_t *stream) {
    int ret = 0;
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_libressl_t *libressl = (mongoc_stream_tls_libressl_t *)tls->ctx;
...
static int _mongoc_stream_tls_libressl_flush(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_libressl_t *libressl = (mongoc_stream_tls_libressl_t *)tls->ctx;
...
static ssize_t _mongoc_stream_tls_libressl_write(mongoc_stream_t *stream, char *buf, size_t buf_len) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_libressl_t *libressl = (mongoc_stream_tls_libressl_t *)tls->ctx;
...
static ssize_t _mongoc_stream_tls_libressl_readv(mongoc_stream_t *stream,
                                                 mongoc_iovec_t *iov,
                                                 size_t iovcnt,
                                                 size_t min_bytes,
...
static int _mongoc_stream_tls_libressl_setsockopt(mongoc_stream_t *stream,
                                                  int level,
                                                  int optname,
                                                  void *optval,
...
static mongoc_stream_t *_mongoc_stream_tls_libressl_get_base_stream(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_libressl_t *libressl = (mongoc_stream_tls_libressl_t *)tls->ctx;
...
static bool _mongoc_stream_tls_libressl_check_closed(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_libressl_t *libressl = (mongoc_stream_tls_libressl_t *)tls->ctx;
...
bool mongoc_stream_tls_libressl_handshake(mongoc_stream_t *stream, const char *host, int *events, bson_error_t *error) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
    mongoc_stream_tls_libressl_t *libressl = (mongoc_stream_tls_libressl_t *)tls->ctx;
    int ret;
...
static bool _mongoc_stream_tls_libressl_timed_out(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
...
static bool _mongoc_stream_tls_libressl_should_retry(mongoc_stream_t *stream) {
    mongoc_stream_tls_t *tls = (mongoc_stream_tls_t *)stream;
