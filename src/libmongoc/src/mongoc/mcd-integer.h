...
static BSON_INLINE bool _mcd_i64_mul_would_overflow(int64_t left, int64_t right) {
    if (right == -1) {
...
/// Return 'true' iff (left + right) would overflow with int64
static BSON_INLINE bool _mcd_i64_add_would_overflow(int64_t left, int64_t right) {
    /**
     * Context:
     *
...
/// Return 'true' iff (left - right) would overflow with int64
static BSON_INLINE bool _mcd_i64_sub_would_overflow(int64_t left, int64_t right) {
