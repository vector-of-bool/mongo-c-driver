...
static gm_node_t *gm_node_new(void) {
...
mongoc_generation_map_t *mongoc_generation_map_new(void) {
...
mongoc_generation_map_t *mongoc_generation_map_copy(const mongoc_generation_map_t *gm) {
...
uint32_t mongoc_generation_map_get(const mongoc_generation_map_t *gm, const bson_oid_t *key) {
    gm_node_t *iter = NULL;
...
void mongoc_generation_map_increment(mongoc_generation_map_t *gm, const bson_oid_t *key) {
    gm_node_t *match;
    gm_node_t *iter = NULL;
...
void mongoc_generation_map_destroy(mongoc_generation_map_t *gm) {
    gm_node_t *iter = NULL;
    gm_node_t *tmp = NULL;
