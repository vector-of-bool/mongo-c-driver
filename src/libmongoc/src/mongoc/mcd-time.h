 ...
 */
static BSON_INLINE mcd_time_point mcd_now(void) {
 ...
 * magnitude.
 */
static BSON_INLINE mcd_duration mcd_microseconds(int64_t s) {
 ...
 * magnitude.
 */
static BSON_INLINE mcd_duration mcd_milliseconds(int64_t s) {
 ...
 * magnitude.
 */
static BSON_INLINE mcd_duration mcd_seconds(int64_t s) {
 ...
 * magnitude.
 */
static BSON_INLINE mcd_duration mcd_minutes(int64_t m) {
 ...
 */
static BSON_INLINE int64_t mcd_get_milliseconds(mcd_duration d) {
    return d._rep / 1000;
}
 ...
 */
static BSON_INLINE mcd_time_point mcd_later(mcd_time_point from, mcd_duration delta) {
 ...
 */
static BSON_INLINE mcd_duration mcd_time_difference(mcd_time_point then, mcd_time_point from) {
 ...
 */
static BSON_INLINE int mcd_time_compare(mcd_time_point left, mcd_time_point right) {
 ...
 * @retval  0 If left and right are equivalent
 */
static BSON_INLINE int mcd_duration_compare(mcd_duration left, mcd_duration right) {
 ...
 */
static BSON_INLINE mcd_duration mcd_duration_clamp(mcd_duration dur, mcd_duration min, mcd_duration max) {
...
static BSON_INLINE mcd_timer mcd_timer_expire_at(mcd_time_point time) {
 ...
 * have expired
 */
static BSON_INLINE mcd_timer mcd_timer_expire_after(mcd_duration after) {
 ...
 */
static BSON_INLINE mcd_duration mcd_timer_remaining(mcd_timer timer) {
