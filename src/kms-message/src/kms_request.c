...
static kms_kv_list_t *parse_query_params(kms_request_str_t *q) {
...
kms_request_t *kms_request_new(const char *method, const char *path_and_query, const kms_request_opt_t *opt) {
...
void kms_request_destroy(kms_request_t *request) {
...
const char *kms_request_get_error(kms_request_t *request) {
    return request->failed ? request->error : NULL;
}

#define AMZ_DT_FORMAT "YYYYmmDDTHHMMSSZ"

bool kms_request_set_date(kms_request_t *request, const struct tm *tm) {
...
bool kms_request_set_region(kms_request_t *request, const char *region) {
    kms_request_str_set_chars(request->region, region, -1);
    return true;
}

bool kms_request_set_service(kms_request_t *request, const char *service) {
    kms_request_str_set_chars(request->service, service, -1);
    return true;
}

bool kms_request_set_access_key_id(kms_request_t *request, const char *akid) {
    kms_request_str_set_chars(request->access_key_id, akid, -1);
    return true;
}

bool kms_request_set_secret_key(kms_request_t *request, const char *key) {
    kms_request_str_set_chars(request->secret_key, key, -1);
    return true;
}

bool kms_request_add_header_field(kms_request_t *request, const char *field_name, const char *value) {
    kms_request_str_t *k, *v;
...
bool kms_request_append_header_field_value(kms_request_t *request, const char *value, size_t len) {
    kms_request_str_t *v;
...
bool kms_request_append_payload(kms_request_t *request, const char *payload, size_t len) {
    CHECK_FAILED;
 ...
 */
static int cmp_query_params(const void *a, const void *b) {
...
static void append_canonical_query(kms_request_t *request, kms_request_str_t *str) {
    size_t i;
    kms_kv_list_t *lst;
...
static void append_canonical_headers(kms_kv_list_t *lst, kms_request_str_t *str) {
    size_t i;
    kms_kv_t *kv;
...
static void append_signed_headers(kms_kv_list_t *lst, kms_request_str_t *str) {
    size_t i;
...
static bool finalize(kms_request_t *request) {
    kms_kv_list_t *lst;
    kms_request_str_t *k;
    kms_request_str_t *v;
 ...
 * values."
 */
static int cmp_header_field_names(const void *a, const void *b) {
    return kms_strcasecmp(((kms_kv_t *)a)->key->str, ((kms_kv_t *)b)->key->str);
}

static kms_kv_list_t *canonical_headers(const kms_request_t *request) {
    kms_kv_list_t *lst;
...
char *kms_request_get_canonical(kms_request_t *request) {
...
const char *kms_request_get_canonical_header(kms_request_t *request, const char *header) {
...
char *kms_request_get_string_to_sign(kms_request_t *request) {
    bool success = false;
...
bool kms_request_get_signing_key(kms_request_t *request, unsigned char *key) {
    bool success = false;
...
char *kms_request_get_signature(kms_request_t *request) {
    bool success = false;
...
void kms_request_validate(kms_request_t *request) {
...
char *kms_request_get_signed(kms_request_t *request) {
    bool success = false;
    kms_kv_list_t *lst = NULL;
    char *signature = NULL;
...
void kms_request_free_string(char *ptr) {
    free(ptr);
}
