 ...
 */
static JSONSL_INLINE struct jsonsl_state_st *jsonsl_last_state(const jsonsl_t jsn,
 ...
 */
static JSONSL_INLINE struct jsonsl_state_st *jsonsl_last_child(const jsonsl_t jsn,
