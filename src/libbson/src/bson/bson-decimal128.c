 ...
 *------------------------------------------------------------------------------
 */
bool bson_decimal128_from_string_w_len(const char *string,     /* IN */
                                       int len,                /* IN */
                                       bson_decimal128_t *dec) /* OUT */
{
...
#undef SSCANF
    ...
    /* Overflow prevention */
    if (bson_cmp_less_equal_su(exponent, radix_position) && bson_cmp_greater_us(radix_position, exponent + (1 << 14))) {
