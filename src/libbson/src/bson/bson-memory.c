...
static void *_aligned_alloc_impl(size_t alignment, size_t num_bytes)
...
void *bson_aligned_alloc(size_t alignment /* IN */, size_t num_bytes /* IN */) {
    void *mem = NULL;
...
void *bson_aligned_alloc0(size_t alignment /* IN */, size_t num_bytes /* IN */) {
    void *mem = NULL;
...
static void *_aligned_alloc_as_malloc(size_t alignment, size_t num_bytes) {
    BSON_UNUSED(alignment);
