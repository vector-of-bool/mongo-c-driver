...
int64_t _bson_emul_atomic_int64_fetch_add(volatile int64_t *p, int64_t n, enum bson_memory_order _unused) {
    int64_t ret;
...
int64_t _bson_emul_atomic_int64_exchange(volatile int64_t *p, int64_t n, enum bson_memory_order _unused) {
    int64_t ret;
...
int64_t _bson_emul_atomic_int64_compare_exchange_strong(volatile int64_t *p,
...
int64_t _bson_emul_atomic_int64_compare_exchange_weak(volatile int64_t *p,
                                                      int64_t expect_value,
                                                      int64_t new_value,
...
int32_t _bson_emul_atomic_int32_fetch_add(volatile int32_t *p, int32_t n, enum bson_memory_order _unused) {
    int32_t ret;
...
int32_t _bson_emul_atomic_int32_exchange(volatile int32_t *p, int32_t n, enum bson_memory_order _unused) {
    int32_t ret;
...
int32_t _bson_emul_atomic_int32_compare_exchange_strong(volatile int32_t *p,
...
int32_t _bson_emul_atomic_int32_compare_exchange_weak(volatile int32_t *p,
                                                      int32_t expect_value,
                                                      int32_t new_value,
                                                      enum bson_memory_order order) {
    /* We're emulating. We can't do a weak version. */
...
int _bson_emul_atomic_int_fetch_add(volatile int *p, int n, enum bson_memory_order _unused) {
    int ret;
...
int _bson_emul_atomic_int_exchange(volatile int *p, int n, enum bson_memory_order _unused) {
    int ret;
...
int _bson_emul_atomic_int_compare_exchange_strong(volatile int *p,
                                                  int expect_value,
                                                  int new_value,
                                                  enum bson_memory_order _unused) {
    int ret;
...
int _bson_emul_atomic_int_compare_exchange_weak(volatile int *p,
                                                int expect_value,
                                                int new_value,
                                                enum bson_memory_order order) {
    /* We're emulating. We can't do a weak version. */
...
void *_bson_emul_atomic_ptr_exchange(void *volatile *p, void *n, enum bson_memory_order _unused) {
    void *ret;
