...
static void *test_bson_writer_custom_realloc_helper(void *mem, size_t num_bytes, void *ctx) {
    int *x = (int *)ctx;
...
static void test_bson_writer_custom_realloc(void) {
...
static void test_bson_writer_shared_buffer(void) {
    bson_writer_t *writer;
...
static void test_bson_writer_empty_sequence(void) {
...
static void test_bson_writer_null_realloc(void) {
...
static void test_bson_writer_null_realloc_2(void) {
    const uint8_t testdata[] = {5, 0, 0, 0, 0, 5, 0, 0, 0, 0, 5, 0, 0, 0, 0, 5,
                                0, 0, 0, 0, 5, 0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0};
    bson_writer_t *writer;
    uint8_t *buf = bson_malloc0(32);
