...
static void _test_encode_helper(char *input, size_t input_len, char *expected_output, int expected_output_len) {
    char *output;
    size_t target_size;
    int ret;
...
static void test_bson_b64_encode(void) {
    char output[32];
    int ret;
...
static void test_bson_b64_decode(void) {
    uint8_t output[32];
    int ret;
...
void test_b64_install(TestSuite *suite) {
