...
static void test_bson_utf8_validate(void) {
...
static void test_bson_utf8_escape_for_json(void) {
    char *str;
    char *unescaped = "\x0e";
...
static void test_bson_utf8_invalid(void) {
...
static void test_bson_utf8_nil(void) {
...
static void test_bson_utf8_get_char(void) {
...
static void test_bson_utf8_from_unichar(void) {
...
static void test_bson_utf8_non_shortest(void) {
...
void test_utf8_install(TestSuite *suite) {
