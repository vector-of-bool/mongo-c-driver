...
static void test_date(const char *str, int64_t millis) {
    int64_t v;
    bson_error_t error;
...
static void test_date_io(const char *str_in, const char *str_out, int64_t millis) {
...
static void test_date_rt(const char *str, int64_t millis) {
    test_date_io(str, str, millis);
}

static void test_date_should_fail(const char *str) {
    int64_t v;
    bson_error_t error;
...
static void test_bson_iso8601_utc(void) {
    /* Allowed date format:
...
static void test_bson_iso8601_local(void) {
    /* Allowed date format:
...
static void test_bson_iso8601_invalid(void) {
    /* Invalid decimal */
...
static void test_bson_iso8601_leap_year(void) {
...
void test_iso8601_install(TestSuite *suite) {
