...
static void test_decimal128(void) {
...
static void test_dbpointer(void) {
...
static void test_codewscope(void) {
    const char *code;
    bson_t oscope;
...
static void test_bson_document(void) {
    bson_t ochild;
...
static void test_bson_array(void) {
    bson_t ochild;
...
static void test_inline_doc(void) {
    int32_t a, b;
...
static void test_extract_ctx_helper(bson_t *bson, ...) {
    va_list ap;
...
static void test_extract_ctx(void) {
    int32_t a, b, c;
...
void test_bcon_extract_install(TestSuite *suite) {
