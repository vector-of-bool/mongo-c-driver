...
static void test_bson_string_new(void) {
    bson_string_t *str;
    char *s;
...
static void test_bson_string_append(void) {
    bson_string_t *str;
    char *s;
...
static void test_bson_string_append_c(void) {
    bson_string_t *str;
    char *s;
...
static void test_bson_string_append_printf(void) {
    bson_string_t *str;
...
static void test_bson_string_append_unichar(void) {
...
static void test_bson_strdup_printf(void) {
    char *s;
...
static void test_bson_strdup(void) {
    char *s;
...
static void test_bson_strndup(void) {
    char *s;
...
static void test_bson_strnlen(void) {
    char *s = "test";
...
static void test_bson_ascii_strtoll(void) {
#ifdef END
#undef END
#endif
#define END ""
...
static void test_bson_strncpy(void) {
    char buf[5];
...
static void test_bson_snprintf(void) {
    char buf[] = "ab";
