...
static void test_bson_oid_init_from_string(void) {
...
static void test_bson_oid_hash(void) {
    bson_oid_t oid;
...
static void test_bson_oid_compare(void) {
    bson_oid_t oid;
    bson_oid_t oid2;
...
static void test_bson_oid_copy(void) {
    bson_oid_t oid;
    bson_oid_t oid2;
...
static void test_bson_oid_init(void) {
    bson_context_t *context;
    bson_oid_t oid;
    bson_oid_t oid2;
    int i;
...
static void test_bson_oid_init_sequence(void) {
    bson_context_t *context;
    bson_oid_t oid;
    bson_oid_t oid2;
    int i;
...
static char *get_time_as_string(const bson_oid_t *oid) {
...
static void test_bson_oid_get_time_t(void) {
    bson_context_t *context;
    bson_oid_t oid;
...
static void test_bson_oid_counter_overflow(void) {
    bson_oid_t oid;
    char str[25];
...
static void _parse_oid(bson_oid_t *oid, _parsed_oid_t *out) {
 ...
 * code. */
static void test_bson_oid_after_fork(void) {
    bson_context_t *ctx;
