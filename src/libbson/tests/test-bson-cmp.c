...
static void test_bson_cmp_equal(void) {
...
static void test_bson_cmp_not_equal(void) {
...
static void test_bson_cmp_less(void) {
...
static void test_bson_cmp_greater(void) {
...
static void test_bson_cmp_less_equal(void) {
...
static void test_bson_cmp_greater_equal(void) {
...
static void test_bson_in_range(void) {
...
void test_bson_cmp_install(TestSuite *suite) {
