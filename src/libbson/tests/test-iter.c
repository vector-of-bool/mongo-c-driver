...
static void test_bson_iter_utf8(void) {
    uint32_t len = 0;
    bson_iter_t iter;
    bson_t *b;
    char *s;
...
static void test_bson_iter_mixed(void) {
    bson_iter_t iter;
...
static void test_bson_iter_overflow(void) {
    bson_iter_t iter;
    bson_t *b;
...
static void test_bson_iter_binary_deprecated(void) {
...
static void test_bson_iter_timeval(void) {
    bson_iter_t iter;
    bson_t *b;
    struct timeval tv;
...
static void test_bson_iter_trailing_null(void) {
    bson_iter_t iter;
    bson_t *b;
...
static void test_bson_iter_fuzz(void) {
    uint8_t *data;
    uint32_t len = 512;
    uint32_t len_le;
    uint32_t r;
    ...
    for (pass = 0; pass < FUZZ_N_PASSES; pass++) {
        ...
        while (bson_iter_next(&iter)) {
            ...
            case BSON_TYPE_UNDEFINED: break;
            case BSON_TYPE_OID: BSON_ASSERT(iter.off + 12 < iter.len); break;
            case BSON_TYPE_BOOL:
...
static void test_bson_iter_regex(void) {
    bson_iter_t iter;
    bson_t *b;
...
static void test_bson_iter_next_after_finish(void) {
    bson_iter_t iter;
    bson_t *b;
    int i;
...
static void test_bson_iter_find_case(void) {
    bson_t b;
    bson_iter_t iter;
...
static void test_bson_iter_find_w_len(void) {
    bson_t b;
    bson_iter_t iter;
...
static void test_bson_iter_init_find_w_len(void) {
    bson_t b;
    bson_iter_t iter;
...
static void test_bson_iter_empty_key(void) {
...
static void test_bson_iter_as_double(void) {
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_overwrite_int32(void) {
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_overwrite_int64(void) {
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_overwrite_decimal128(void) {
    bson_iter_t iter;
    bson_t b;
    bson_decimal128_t value;
...
static void test_bson_iter_overwrite_double(void) {
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_overwrite_bool(void) {
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_overwrite_oid(void) {
    bson_oid_t oid;
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_overwrite_timestamp(void) {
    bson_iter_t iter;
    bson_t b;
    uint32_t t, i;
...
static void test_bson_iter_overwrite_date_time(void) {
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_recurse(void) {
    bson_iter_t iter;
    bson_iter_t child;
    bson_t b;
    bson_t cb;
...
static void test_bson_iter_init_find_case(void) {
    bson_t b;
    bson_iter_t iter;
...
static void test_bson_iter_find_descendant(void) {
    bson_iter_t iter;
    bson_iter_t desc;
    bson_t *b;
...
static void test_bson_iter_as_bool(void) {
    bson_iter_t iter;
    bson_t b;
...
static void test_bson_iter_from_data(void) {
...
void test_iter_install(TestSuite *suite) {
