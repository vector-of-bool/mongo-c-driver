...
static bson_t *get_bson(const char *filename) {
    ssize_t len;
    uint8_t buf[4096];
    bson_t *b;
...
static void test_bson_new(void) {
    bson_t *b;
...
static void test_bson_alloc(void) {
...
static void BSON_ASSERT_BSON_EQUAL(const bson_t *a, const bson_t *b) {
...
static void BSON_ASSERT_BSON_EQUAL_FILE(const bson_t *b, const char *filename) {
    bson_t *b2 = get_bson(filename);
    BSON_ASSERT_BSON_EQUAL(b, b2);
    bson_destroy(b2);
}

static void test_bson_append_utf8(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_symbol(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_null(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_bool(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_double(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_document(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_oid(void) {
    bson_oid_t oid;
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_array(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_binary(void) {
...
static void test_bson_append_binary_deprecated(void) {
    static const uint8_t binary[] = {'1', '2', '3', '4'};
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_time_t(void) {
    bson_t *b;
    bson_t *b2;
    time_t t;
...
static void test_bson_append_timeval(void) {
    struct timeval tv = {0};
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_undefined(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_regex(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_regex_w_len(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_code(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_code_with_scope(void) {
...
static void test_bson_append_dbpointer(void) {
    bson_oid_t oid;
    bson_t *b;
    bson_t *b2;
    uint8_t malformed_data[] = {
...
static void test_bson_append_int32(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_int64(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_decimal128(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_iter(void) {
    bson_iter_t iter;
    bool r;
    bson_t b;
    bson_t c;
...
static void test_bson_append_timestamp(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_maxkey(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_minkey(void) {
    bson_t *b;
    bson_t *b2;
...
static void test_bson_append_general(void) {
...
static void test_bson_append_deep(void) {
    bson_t *a;
    bson_t *tmp;
    int i;
...
static void test_bson_validate_dbref(void) {
    size_t offset;
...
static void test_bson_validate_bool(void) {
...
static void test_bson_validate_dbpointer(void) {
...
static void test_bson_validate(void) {
    char filename[64];
    size_t offset;
    bson_t *b;
    int i;
...
#define VALIDATE_TEST(_filename, _flags, _offset, _flag, _msg)                                                         \
    ...
    b = BCON_NEW("my_dbref", "{", "$ref", BCON_UTF8("collection"), "extra", BCON_INT32(2), "$id", BCON_INT32(1), "}");
    BSON_ASSERT(bson_validate_with_error(b, BSON_VALIDATE_NONE, &error));
    BSON_ASSERT(!bson_validate_with_error(b, BSON_VALIDATE_DOLLAR_KEYS, &error));
    ASSERT_ERROR_CONTAINS(error,
                          BSON_ERROR_INVALID,
...
static void test_bson_init(void) {
    bson_t b;
    char key[12];
    int i;
...
static void test_bson_init_static(void) {
...
static void test_bson_new_from_buffer(void) {
    bson_t *b;
...
static void test_bson_utf8_key(void) {
...
static void test_bson_new_1mm(void) {
    bson_t *b;
    int i;
...
static void test_bson_init_1mm(void) {
    bson_t b;
    int i;
...
static void test_bson_build_child(void) {
    bson_t b;
    bson_t child;
    bson_t *b2;
    bson_t *child2;
...
static void test_bson_build_child_array(void) {
    bson_t b;
    bson_t child;
    bson_t *b2;
    bson_t *child2;
...
static void test_bson_build_child_deep_1(bson_t *b, int *count) {
    bson_t child;
...
static void test_bson_build_child_deep(void) {
    union {
        bson_t b;
        bson_impl_alloc_t a;
    } u;
...
static void test_bson_build_child_deep_no_begin_end_1(bson_t *b, int *count) {
    bson_t child;
...
static void test_bson_build_child_deep_no_begin_end(void) {
    union {
        bson_t b;
        bson_impl_alloc_t a;
    } u;
...
static void test_bson_count_keys(void) {
    bson_t b;
...
static void test_bson_copy(void) {
    bson_t b;
    bson_t *c;
...
static void test_bson_copy_to_excluding_noinit(void) {
    bson_iter_t iter;
    bool r;
    bson_t b;
    bson_t c;
...
static void test_bson_append_overflow(void) {
    const char *key = "a";
    uint32_t len;
    bson_t b;
...
static void test_bson_initializer(void) {
...
static void test_bson_concat(void) {
...
static void test_bson_reinit(void) {
    bson_t b = BSON_INITIALIZER;
    int i;
...
static void test_bson_macros(void) {
...
static void test_bson_clear(void) {
    bson_t *doc = NULL;
...
static void test_bson_steal(void) {
...
static void BSON_ASSERT_KEY_AND_VALUE(const bson_t *bson) {
    bson_iter_t iter;
...
static void test_bson_reserve_buffer(void) {
...
static void test_bson_reserve_buffer_errors(void) {
...
static void test_bson_destroy_with_steal(void) {
    bson_t *b1;
    bson_t b2;
    uint32_t len = 0;
    uint8_t *data;
...
static void test_bson_has_field(void) {
    bson_t *b;
    bool r;
...
static void test_bson_visit_invalid_field(void) {
...
static void test_bson_visit_unsupported_type(void) {
...
static void test_bson_visit_unsupported_type_bad_key(void) {
...
static void test_bson_visit_unsupported_type_empty_key(void) {
...
static void test_bson_subtype_2(void) {
    bson_t b;
...
void test_bson_regex_lengths(void) {
...
void test_bson_empty_binary(void) {
    uint8_t data = 0xAB;
    bson_t test;
...
void test_bson_iter_key_len(void) {
...
void test_bson_iter_init_from_data_at_offset(void) {
    bson_t *bson = bson_with_all_types();
...
static void _check_null_binary(bson_t *bson, bool is_legacy) {
...
static void _binary_null_handling(bool is_legacy) {
    bson_value_t val;
    bson_t *bson;
    bson_error_t error;
...
static void test_bson_binary_null_handling(void) {
    _binary_null_handling(false /* is legacy */);
    _binary_null_handling(true /* is legacy */);
}

static void test_bson_append_null_from_utf8_or_symbol(void) {
    bson_t bson;
    bson_iter_t iter;
 ...
 */
static void test_bson_dsl_parse(void) {
    // Do nothing:
...
static void test_bson_dsl_visit(void) {
    // Count elements
    int count = 0;
...
static void test_bson_dsl_predicate(void) {
...
static void do_assert_bson_equal(const bson_t *actual, const bson_t *expected, const char *file, int line) {
...
static void test_bson_dsl_build(void) {
...
void test_bson_install(TestSuite *suite) {
