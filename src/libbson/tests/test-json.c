...
static ssize_t test_bson_json_read_cb_helper(void *string, uint8_t *buf, size_t len) {
...
static void test_bson_json_allow_multiple(void) {
    int32_t one;
    bson_error_t error;
...
static void test_bson_as_json_x1000(void) {
    bson_oid_t oid;
...
static void test_bson_as_json_multi(void) {
    bson_t *b;
    char *str;
    size_t len;
...
static void test_bson_as_json_string(void) {
    size_t len;
    bson_t *b;
    char *str;
...
static void test_bson_as_json_int32(void) {
    size_t len;
    bson_t *b;
    char *str;
...
static void test_bson_as_json_int64(void) {
    size_t len;
    bson_t *b;
    char *str;
...
static void test_bson_as_json_double(void) {
    size_t len;
    bson_t *b;
    char *str;
    char *expected;
...
static void test_bson_as_json_double_nonfinite(void) {
    size_t len;
    bson_t *b;
    char *str;
    char *expected;
...
static void test_bson_as_json_decimal128(void) {
    size_t len;
    bson_t *b;
    char *str;
    bson_decimal128_t decimal128;
...
static void test_bson_as_json_code(void) {
...
static void test_bson_as_json_date_time(void) {
    bson_t *b;
    char *str;
    size_t len;
...
static void test_bson_as_json_regex(void) {
    bson_t *b;
    char *str;
    size_t len;
...
static void test_bson_as_json_symbol(void) {
    bson_t *b;
    char *str;
    size_t len;
...
static void test_bson_as_json_utf8(void) {
...
static void test_bson_as_json_dbpointer(void) {
    bson_oid_t oid;
    bson_t *b;
    char *str;
    size_t len;
...
static void test_bson_as_canonical_extended_json_dbpointer(void) {
    bson_oid_t oid;
    bson_t *b;
    size_t len;
    char *str;
...
static void test_bson_as_json_stack_overflow(void) {
    uint8_t *buf;
    bson_t b;
...
static void test_bson_corrupt(void) {
    uint8_t *buf;
    bson_t b;
    size_t buflen = 1024;
    char *str;
...
static void test_bson_corrupt_utf8(void) {
    uint8_t *buf;
    bson_t b;
    size_t buflen = 1024;
    char *str;
...
static void test_bson_corrupt_binary(void) {
    uint8_t *buf;
    bson_t b;
    size_t buflen = 1024;
    char *str;
...
static char *rand_str(size_t maxlen, unsigned int *seed /* IN / OUT */, char *buf /* IN / OUT */) {
...
static void test_bson_json_read_buffering(void) {
    bson_t **bsons;
    char *json_tmp;
    bson_string_t *json;
    bson_error_t error;
...
static void _test_bson_json_read_compare(const char *json, int size, ...) {
...
static void test_bson_json_read(void) {
...
static void test_bson_json_read_invalid_base64(void) {
...
static void test_bson_json_read_raw_utf8(void) {
    bson_t *bson;
    bson_iter_t iter;
...
static void test_bson_json_read_corrupt_utf8(void) {
...
static void test_bson_json_read_corrupt_document(void) {
...
static void test_bson_json_read_decimal128(void) {
...
static void test_bson_json_read_dbpointer(void) {
    bson_t b;
    bson_error_t error;
    bool r;
...
static void test_bson_json_read_legacy_regex(void) {
    bson_t b;
    bson_error_t error;
    bool r;
    const char *pattern;
...
static void test_bson_json_read_regex_options_order(void) {
    bson_t b;
    bson_error_t error;
    bool r;
    const char *pattern;
...
static void test_bson_json_read_binary(void) {
    bson_error_t error;
    bson_t b;
    bool r;
...
static void test_bson_json_read_legacy_binary(void) {
...
static void test_json_reader_new_from_file(void) {
...
static void test_json_reader_new_from_bad_path(void) {
...
static void test_bson_json_error(const char *json, int domain, bson_json_error_code_t code) {
    bson_error_t error;
    bson_t *bson;
...
static void test_bson_json_read_empty(void) {
    bson_error_t error;
    bson_t *bson_ptr;
    bson_t bson;
...
static void test_bson_json_read_missing_complex(void) {
    const char *json = "{ \n\
      \"foo\" : { \n\
         \"$options\" : \"ism\"\n\
      }\n\
...
static void test_bson_json_read_invalid_binary(void) {
    bson_error_t error;
    const char *json = "{ "
...
static void test_bson_json_read_invalid_json(void) {
    const char *json = "{ \n\
      \"foo\" : { \n\
   }";
    bson_t *b;
...
static ssize_t test_bson_json_read_bad_cb_helper(void *_ctx, uint8_t *buf, size_t len) {
    BSON_UNUSED(_ctx);
    BSON_UNUSED(buf);
    BSON_UNUSED(len);
...
static void test_bson_json_read_bad_cb(void) {
    bson_error_t error;
    bson_json_reader_t *reader;
    int r;
    bson_t bson = BSON_INITIALIZER;
...
static ssize_t test_bson_json_read_invalid_helper(void *ctx, uint8_t *buf, size_t len) {
    BSON_UNUSED(ctx);
    BSON_ASSERT(len);
...
static void test_bson_json_read_invalid(void) {
    bson_error_t error;
    bson_json_reader_t *reader;
    int r;
    bson_t bson = BSON_INITIALIZER;
...
static void test_bson_json_number_long(void) {
    bson_error_t error;
    bson_iter_t iter;
    bson_t b;
    bool r;
...
static void test_bson_json_number_long_zero(void) {
    bson_error_t error;
    bson_iter_t iter;
...
static void test_bson_json_code(void) {
...
static void test_bson_json_code_errors(void) {
    bson_error_t error;
    bson_t b;
    bool r;
    size_t i;
...
static const bson_oid_t *oid_zero(void) {
...
static void test_bson_json_dbref(void) {
    bson_error_t error;
...
static void test_bson_json_uescape(void) {
    bson_error_t error;
    bson_t b;
    bool r;
...
static void test_bson_json_uescape_key(void) {
    bson_error_t error;
    bson_t b;
    bool r;
...
static void test_bson_json_uescape_bad(void) {
    bson_error_t error;
    bson_t b;
    bool r;
...
static void test_bson_json_int32(void) {
    bson_t b;
    bson_iter_t iter;
    bson_error_t error;
...
static void test_bson_json_int64(void) {
    bson_t b;
    bson_iter_t iter;
    bson_error_t error;
...
static void test_bson_json_double(void) {
    bson_t b;
    bson_error_t error;
    bson_iter_t iter;
...
static void test_bson_json_double_overflow(void) {
...
static void test_bson_json_nan(void) {
    bson_error_t error;
    bson_t b;
    double d;
...
static void test_bson_json_infinity(void) {
    bson_error_t error;
    bson_t b;
    double d;
...
static void test_bson_json_null(void) {
    bson_error_t error;
    bson_t b;
...
static void test_bson_json_empty_final_object(void) {
    const char *json = "{\"a\": {\"b\": {}}}";
...
static void test_bson_json_number_decimal(void) {
    bson_error_t error;
    bson_iter_t iter;
    bson_decimal128_t decimal128;
...
static void test_bson_json_inc(void) {
...
static void test_bson_json_array(void) {
    bson_error_t error;
...
static void test_bson_json_array_single(void) {
    bson_error_t error;
    const char *json = "[ 0 ]";
    bson_t b, compare;
    bool r;
...
static void test_bson_json_array_int64(void) {
    bson_error_t error;
...
static void test_bson_json_array_subdoc(void) {
    bson_error_t error;
...
static void test_bson_json_date_check(const char *json, int64_t value) {
    bson_error_t error = {0};
    bson_t b, compare;
    bool r;
...
static void test_bson_json_date_error(const char *json, const char *msg) {
    bson_error_t error = {0};
    bson_t b;
    bool r;
    r = bson_init_from_json(&b, json, -1, &error);
...
static void test_bson_json_date(void) {
...
static void test_bson_json_date_legacy(void) {
...
static void test_bson_json_date_numberlong(void) {
...
static void test_bson_json_timestamp(void) {
    bson_error_t error = {0};
    bson_t b, compare;
    bool r;
...
static void test_bson_array_as_json(void) {
...
static void test_bson_as_json_spacing(void) {
    bson_t d = BSON_INITIALIZER;
    size_t len;
    char *str;
...
static void test_bson_json_errors(void) {
...
static void test_bson_integer_width(void) {
...
static void test_bson_json_null_in_str(void) {
...
static char *_single_to_double(const char *json) {
    char *copy;
...
static void _test_json_produces_multiple(const char *json_in, int err_expected, ...) {
...
static void test_bson_as_json_multi_object(void) {
...
static void test_bson_as_json_with_opts(bson_t *bson, bson_json_mode_t mode, int max_len, const char *expected) {
...
char *truncate_string(const char *str, size_t len) {
    char *truncated;
...
static void run_bson_as_json_with_opts_tests(bson_t *bson, bson_json_mode_t mode, const char *expected) {
...
static void test_bson_as_json_with_opts_double(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_utf8(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_document(void) {
    bson_t *b;
    bson_t nested;
...
static void test_bson_as_json_with_opts_array(void) {
    bson_t *b;
    bson_t nested;
...
static void test_bson_as_json_with_opts_binary(void) {
...
static void test_bson_as_json_with_opts_undefined(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_oid(void) {
    bson_oid_t oid;
    bson_t *b;
...
static void test_bson_as_json_with_opts_bool(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_date_time(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_null(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_regex(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_dbpointer(void) {
    bson_oid_t oid;
    bson_t *b;
...
static void test_bson_as_json_with_opts_code(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_symbol(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_codewscope(void) {
    bson_t *b;
    bson_t *scope;
...
static void test_bson_as_json_with_opts_int32(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_int64(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_timestamp(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_minkey(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_maxkey(void) {
    bson_t *b;
...
static void test_bson_as_json_with_opts_decimal128(void) {
    bson_t *b;
    bson_decimal128_t dec;
...
static void test_bson_as_json_with_opts_all_types(void) {
    char *full_canonical;
    char *full_relaxed;
    bson_oid_t oid;
    bson_decimal128_t decimal128;
...
void test_json_install(TestSuite *suite) {
