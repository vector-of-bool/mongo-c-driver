...
bool _check_depth_document(const bson_iter_t *iter, const char *key, const bson_t *v_document, void *data);
...
void check_depth(const bson_t *bson, uint32_t max_depth) {
    bson_iter_t iter;
